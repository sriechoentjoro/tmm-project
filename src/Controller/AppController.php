...
class AppController extends Controller
{
     ...
     * - Fields with 'image', 'photo', 'gambar', 'foto' → webroot/img/uploads/
     * - Other file fields → webroot/files/uploads/
     * 
    ...
    public function uploadImage($model, $field, $folder, $reqFilename = '')
    {
            ...
            if (move_uploaded_file($tmpPath, $absolutePath)) {
                ...
                try {
                    ...
                    if (file_exists($imageLogo)) {
                        ...
                        error_log("✅ Watermark added");
                    } else {
                        error_log("⚠️ Logo file not found: " . $imageLogo);
                    }
                } catch (\Exception $e) {
                    error_log("⚠️ Image processing failed: " . $e->getMessage());
        ...
        error_log("❌ File format not recognized");
        return false;
    }
