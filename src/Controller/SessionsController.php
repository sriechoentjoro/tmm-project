...
class SessionsController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            foreach ($imageFields as $fieldName) {
                $imagePath = $this->uploadImage('Sessions', $fieldName, 'sessions');
                if ($imagePath) {
            ...
            foreach ($fileFields as $fieldName) {
                $this->uploadFile('Sessions', $fieldName, 'sessions');
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            ...
            // Upload files (documents, etc)
            foreach ($fileFields as $fieldName) {
                $success = $this->uploadFile('Sessions', $fieldName, 'sessions');
                if ($success) {
                    $data = $this->request->getData(); // Get updated data after upload
                } else {
    ...
    public function exportCsv()
    {
        ...
        return $this->doExportCsv($query, 'Sessions', $headers, $fields);
    }
    /**
     * Export to Excel
     *
    ...
    public function exportExcel()
    {
        ...
        return $this->doExportExcel($query, 'Sessions', $headers, $fields);
    }
    /**
     * Print Report
     *
