 ...
 * @var \App\Model\Entity\App\Model\Entity\SpecialSkillSupportInstitution|null $specialSkillSupportInstitution */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Special Skill Support Institutions'), ['action' => 'index'], ['escape' => false]) ?></li>
    </ul>
</nav>

<!-- Main Content -->
<div class="specialSkillSupportInstitutions form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Special Skill Support Institution') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($specialSkillSupportInstitution, ['data-confirm' => 'true', 'id' => 'specialSkillSupportInstitutionForm']) ?>
            <?php if (!empty($specialSkillSupportInstitution->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Special Skill Support Institution Information') ?></legend>
                <div class="row">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Special Skill Support Institution'), [
