            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Special Skill Support Institution') ?>: <?= h($specialSkillSupportInstitution->id) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $specialSkillSupportInstitution->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($specialSkillSupportInstitution->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Company Name') ?></th>
                            <td class="github-detail-value"><?= h($specialSkillSupportInstitution->company_name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Address') ?></th>
                            <td class="github-detail-value"><?= h($specialSkillSupportInstitution->address) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Contact Person') ?></th>
                            <td class="github-detail-value"><?= h($specialSkillSupportInstitution->contact_person) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
