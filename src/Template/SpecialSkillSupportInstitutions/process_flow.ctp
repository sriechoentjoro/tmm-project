 ...
 *
 * The content lives in config/page_guides/SpecialSkillSupportInstitutions.php; Element/page_guide.ctp
 ...
 */
echo $this->element('page_guide', ['module' => 'SpecialSkillSupportInstitutions']);
