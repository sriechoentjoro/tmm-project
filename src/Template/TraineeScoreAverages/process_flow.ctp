<?php
/**
 * Process Flow Documentation - Trainee Score Averages
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Trainee Score Averages</strong> adalah modul untuk mengelola data terkait Trainee Score Averages dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Trainee Score Averages</strong> is a module for managing Trainee Score Averages data in the TMM system.
        <?php else: ?>
            <strong>Trainee Score Averages</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Trainee Score Averages ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">traineescoreaverages</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Trainee Score Averages
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Trainee Score Averages data form
                    <?php else: ?>
                        Trainee Score Averages ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Trainee Score Averages -->
