            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Candidate Record Interview') ?>: <?= h($candidateRecordInterview->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $candidateRecordInterview->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($candidateRecordInterview->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Applicant Id') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($candidateRecordInterview->applicant_id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Candidate Interview Type Id') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($candidateRecordInterview->master_candidate_interview_type_id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($candidateRecordInterview->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Candidate Interview Result Id') ?></th>
                            <td class="github-detail-value">
                                <?= $candidateRecordInterview->has('master_candidate_interview_result') ? $this->Html->link($candidateRecordInterview->master_candidate_interview_result->title, ['controller' => 'MasterCandidateInterviewResults', 'action' => 'view', $candidateRecordInterview->master_candidate_interview_result->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Comments') ?></th>
                            <td class="github-detail-value"><?= h($candidateRecordInterview->comments) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Date Interview') ?></th>
                            <td class="github-detail-value"><?= h($candidateRecordInterview->date_interview) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Date Interview Result') ?></th>
                            <td class="github-detail-value"><?= h($candidateRecordInterview->date_interview_result) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
