<?php
/**
 * Process Flow Documentation - Trainee Installments
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Trainee Installments</strong> adalah modul untuk mengelola data terkait Trainee Installments dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Trainee Installments</strong> is a module for managing Trainee Installments data in the TMM system.
        <?php else: ?>
            <strong>Trainee Installments</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Trainee Installments ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">traineeinstallments</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Trainee Installments
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Trainee Installments data form
                    <?php else: ?>
                        Trainee Installments ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Trainee Installments -->
