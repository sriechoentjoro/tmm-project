...
<div class="index-header" style="margin-bottom: 20px;">
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <h2 style="margin: 0;"><?= __('Apprentice Stories') ?></h2>
        ...
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid #e9ecef;">
                    ...
                    <td style="padding: 10px 12px;"><?= h($row['problem_classification']) ?></td>
                    <td style="padding: 10px 12px;"><?= h($row['problem_solution']) ?></td>
                    <td style="padding: 10px 12px;"><?= h($row['problem_inference']) ?></td>
                    <td style="padding: 10px 12px;"><?= h($row['image_path']) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
