            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Master Family Connection') ?>: <?= h($masterFamilyConnection->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $masterFamilyConnection->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($masterFamilyConnection->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Family Category') ?></th>
                            <td class="github-detail-value"><?= h($masterFamilyConnection->family_category) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title Eng') ?></th>
                            <td class="github-detail-value"><?= h($masterFamilyConnection->title_eng) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($masterFamilyConnection->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title Kanji') ?></th>
                            <td class="github-detail-value"><?= h($masterFamilyConnection->title_kanji) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
