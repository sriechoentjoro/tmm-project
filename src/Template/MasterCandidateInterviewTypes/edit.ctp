 ...
 * @var \App\Model\Entity\App\Model\Entity\MasterCandidateInterviewType|null $masterCandidateInterviewType */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Master Candidate Interview Types'), ['action' => 'index'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="masterCandidateInterviewTypes form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Master Candidate Interview Type') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($masterCandidateInterviewType, ['data-confirm' => 'true', 'id' => 'masterCandidateInterviewTypeForm']) ?>
            <?php if (!empty($masterCandidateInterviewType->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Master Candidate Interview Type Information') ?></legend>
                <div class="row">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Master Candidate Interview Type'), [
