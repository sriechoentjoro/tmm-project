            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <?= $this->Html->link(
                            '<i class="fas fa-list"></i> ' . __('List Master Candidate Interview Types'),
                            ['action' => 'index'],
                            ['class' => 'dropdown-item', 'escape' => false]
                        ) ?>
                        <?= $this->Html->link(
                            '<i class="fas fa-plus"></i> ' . __('New Master Candidate Interview Type'),
                            ['action' => 'add'],
                            ['class' => 'dropdown-item', 'escape' => false]
                        ) ?>
                    </div>
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Master Candidate Interview Type') ?>: <?= h($masterCandidateInterviewType->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Html->link(
                        ...
                        ['action' => 'edit', $masterCandidateInterviewType->id],
                        ['class' => 'btn-export-light', 'escape' => false]
                    ) ?>
                    <?= $this->Form->postLink(
                        '<i class="fas fa-trash"></i> ' . __('Delete'),
                        ['action' => 'delete', $masterCandidateInterviewType->id],
                        [
                            'class' => 'btn-export-light',
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $masterCandidateInterviewType->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
        ...
        <ul class="view-tabs-nav" role="tablist">
            ...
            <li class="view-tab-item">
                <a href="#tab-candidate_record_interviews" class="view-tab-link" data-tab="tab-candidate_record_interviews">
                    ...
                    <?php if (!empty($masterCandidateInterviewType->candidate_record_interviews)): ?>
                    <span class="tab-badge"><?= count($masterCandidateInterviewType->candidate_record_interviews) ?></span>
                    <?php endif; ?>
                </a>
            </li>
        </ul>
        ...
        <div class="view-tabs-content">
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($masterCandidateInterviewType->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($masterCandidateInterviewType->title) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div id="tab-candidate_record_interviews" class="view-tab-pane">
                    ...
                    <div class="github-related-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover github-related-table" data-ajax-filter="true">
                                ...
                                <tbody>
                                    <?php foreach ($masterCandidateInterviewType->candidate_record_interviews as $candidateRecordInterviews): ?>
                ...
                <div class="github-empty-state">
                    ...
                    <p><?= __('There are no related CandidateRecordInterviews for this Master Candidate Interview Type.') ?></p>
                    <?= $this->Html->link(
