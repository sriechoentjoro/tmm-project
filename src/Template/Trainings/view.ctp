                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($training->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Max Participants') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($training->max_participants) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($training->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Description') ?></th>
                            <td class="github-detail-value"><?= h($training->description) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Location') ?></th>
                            <td class="github-detail-value"><?= h($training->location) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Instructor') ?></th>
                            <td class="github-detail-value"><?= h($training->instructor) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Status') ?></th>
                            <td class="github-detail-value"><?= h($training->status) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Start Date') ?></th>
                            <td class="github-detail-value"><?= h($training->start_date) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('End Date') ?></th>
                            <td class="github-detail-value"><?= h($training->end_date) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
