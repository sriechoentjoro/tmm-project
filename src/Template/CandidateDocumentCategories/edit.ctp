 ...
 * @var \App\Model\Entity\App\Model\Entity\CandidateDocumentCategory|null $candidateDocumentCategory */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Candidate Document Categories'), ['action' => 'index'], ['escape' => false]) ?></li>
    </ul>
</nav>

<!-- Main Content -->
<div class="candidateDocumentCategories form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Candidate Document Category') ?>
            </h3>
        </div>
        ...
        <div class="card-body">
            ...
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Candidate Document Category Information') ?></legend>
                <div class="row">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Candidate Document Category'), [
