<?php
/**
 * Process Flow Documentation - Candidate Document Categories
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Candidate Document Categories</strong> adalah modul untuk mengelola data terkait Candidate Document Categories dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Candidate Document Categories</strong> is a module for managing Candidate Document Categories data in the TMM system.
        <?php else: ?>
            <strong>Candidate Document Categories</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Candidate Document Categories ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">candidatedocumentcategories</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Candidate Document Categories
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Candidate Document Categories data form
                    <?php else: ?>
                        Candidate Document Categories ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Candidate Document Categories -->
