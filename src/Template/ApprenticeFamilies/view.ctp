            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <div class="dropdown-divider"></div>
                        <?= $this->Html->link(
                            '<i class="fas fa-list"></i> ' . __('List MasterFamilyConnections'),
                            ['controller' => 'MasterFamilyConnections', 'action' => 'index'],
                            ['class' => 'dropdown-item', 'escape' => false]
                        ) ?>
                        <?= $this->Html->link(
                            '<i class="fas fa-plus"></i> ' . __('New MasterFamilyConnection'),
                            ['controller' => 'MasterFamilyConnections', 'action' => 'add'],
                            ['class' => 'dropdown-item', 'escape' => false]
                        ) ?>
                        <div class="dropdown-divider"></div>
                        <?= $this->Html->link(
                            '<i class="fas fa-list"></i> ' . __('List MasterOccupations'),
                            ['controller' => 'MasterOccupations', 'action' => 'index'],
                            ['class' => 'dropdown-item', 'escape' => false]
                        ) ?>
                        <?= $this->Html->link(
                            '<i class="fas fa-plus"></i> ' . __('New MasterOccupation'),
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Apprentice Family') ?>: <?= h($apprenticeFamily->name) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $apprenticeFamily->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($apprenticeFamily->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Age') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($apprenticeFamily->age) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Apprentice Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprenticeFamily->has('apprentice') ? $this->Html->link($apprenticeFamily->apprentice->name, ['controller' => 'Apprentices', 'action' => 'view', $apprenticeFamily->apprentice->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Family Connection Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprenticeFamily->has('master_family_connection') ? $this->Html->link($apprenticeFamily->master_family_connection->title, ['controller' => 'MasterFamilyConnections', 'action' => 'view', $apprenticeFamily->master_family_connection->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Name') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeFamily->name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Occupation Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprenticeFamily->has('master_occupation') ? $this->Html->link($apprenticeFamily->master_occupation->title, ['controller' => 'MasterOccupations', 'action' => 'view', $apprenticeFamily->master_occupation->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Detail') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeFamily->detail) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
