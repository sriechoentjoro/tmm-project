 ...
 * @var \App\Model\Entity\App\Model\Entity\ApprenticeFamily|null $apprenticeFamily */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Apprentice Families'), ['action' => 'index'], ['escape' => false]) ?></li>
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List MasterFamilyConnections'), ['controller' => 'MasterFamilyConnections', 'action' => 'index'], ['escape' => false]) ?></li>
        <li><?= $this->Html->link('<i class="fas fa-plus"></i> ' . __('New MasterFamilyConnection'), ['controller' => 'MasterFamilyConnections', 'action' => 'add'], ['escape' => false]) ?></li>
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List MasterOccupations'), ['controller' => 'MasterOccupations', 'action' => 'index'], ['escape' => false]) ?></li>
        <li><?= $this->Html->link('<i class="fas fa-plus"></i> ' . __('New MasterOccupation'), ['controller' => 'MasterOccupations', 'action' => 'add'], ['escape' => false]) ?></li>
    </ul>
</nav>

<!-- Main Content -->
<div class="apprenticeFamilies form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Apprentice Family') ?>
            </h3>
        </div>
        ...
        <div class="card-body">
            ...
            <fieldset>
                <legend><?= __('Enter Apprentice Family Information') ?></legend>
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Master Family Connection Id') ?></label>
                        <?= $this->Form->control('master_family_connection_id', [
                            'options' => $masterFamilyConnections,
                            'class' => 'form-control',
                            'label' => false,
                            'empty' => __('-- Select Master Family Connection Id --')
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                    ...
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Master Occupation Id') ?></label>
                        <?= $this->Form->control('master_occupation_id', [
                            'options' => $masterOccupations,
                            'class' => 'form-control',
                            'label' => false,
                            'empty' => __('-- Select Master Occupation Id --')
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Apprentice Family'), [
