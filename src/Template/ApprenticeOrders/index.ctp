 ...
 * @var \App\Model\Entity\ApprenticeOrder[]|\Cake\Collection\CollectionInterface $apprenticeOrders
 */
?>
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <?= $this->Html->link(
                    '<i class="fas fa-plus"></i> ' . __('New Cooperative Association'),
                ...
                <div class="dropdown-divider"></div>
                <?= $this->Html->link(
                    '<i class="fas fa-list"></i> ' . __('List Master Job Categories'),
                    ['controller' => 'MasterJobCategories', 'action' => 'index'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <?= $this->Html->link(
                    '<i class="fas fa-plus"></i> ' . __('New Master Job Category'),
                    ['controller' => 'MasterJobCategories', 'action' => 'add'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
            </div>
            
            <h2 style="margin: 0; display: inline-block;"><?= __('Apprentice Orders') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="apprenticeOrders index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <thead style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.15) 0%, rgba(118, 75, 162, 0.15) 100%); position: sticky; top: 0; z-index: 10;">
                <tr>
                    ...
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('reference_file') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('cooperative_association_id') ?></th>
                    ...
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('other_requirements') ?></th>
                </tr>
            ...
            <tr class="filter-row" style="background-color: #f8f9fa;">
                ...
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="reference_file" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                    ...
                    <input type="text" class="filter-input form-control form-control-sm" placeholder="Filter..." data-column="reference_file" style="font-size: 0.85rem; padding: 4px;">
                </td>
                <td style="padding: 5px;">
                    <select class="filter-input form-control form-control-sm" data-column="cooperative_association_id" data-type="select" style="font-size: 0.85rem; padding: 4px;">
                        <option value="">All Cooperative_associations</option>
                        <?php foreach ($cooperative_associations as $id => $name): ?>
                ...
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="male_trainee_number" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="=">=</option>
                        <option value="!=">!=</option>
                        <option value="<">&lt;</option>
                        <option value=">">&gt;</option>
                    ...
                    <input type="number" class="filter-input form-control form-control-sm" placeholder="Filter..." data-column="male_trainee_number" style="font-size: 0.85rem; padding: 4px;">
                    <input type="number" class="filter-input-range form-control form-control-sm" placeholder="To..." data-column="male_trainee_number" style="display:none; margin-top: 2px; font-size: 0.85rem;">
                </td>
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="female_trainee_number" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="=">=</option>
                        <option value="!=">!=</option>
                        <option value="<">&lt;</option>
                        <option value=">">&gt;</option>
                    ...
                    <input type="number" class="filter-input form-control form-control-sm" placeholder="Filter..." data-column="female_trainee_number" style="font-size: 0.85rem; padding: 4px;">
                ...
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="departure_year" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="like">LIKE</option>
                        <option value="not_like">NOT LIKE</option>
                        <option value="=">=</option>
                        <option value="!=">!=</option>
                    ...
                    <input type="text" class="filter-input form-control form-control-sm" placeholder="Filter..." data-column="departure_year" style="font-size: 0.85rem; padding: 4px;">
                </td>
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="departure_month" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="like">LIKE</option>
                        <option value="not_like">NOT LIKE</option>
                        <option value="=">=</option>
                        <option value="!=">!=</option>
                    ...
                    <input type="text" class="filter-input form-control form-control-sm" placeholder="Filter..." data-column="departure_month" style="font-size: 0.85rem; padding: 4px;">
                </td>
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="is_practical_test_required" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="like">LIKE</option>
                        <option value="not_like">NOT LIKE</option>
                        <option value="=">=</option>
                        <option value="!=">!=</option>
                    ...
                    <input type="text" class="filter-input form-control form-control-sm" placeholder="Filter..." data-column="is_practical_test_required" style="font-size: 0.85rem; padding: 4px;">
                </td>
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="other_requirements" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="like">LIKE</option>
                        <option value="not_like">NOT LIKE</option>
                        <option value="=">=</option>
                        <option value="!=">!=</option>
                    ...
                    <input type="text" class="filter-input form-control form-control-sm" placeholder="Filter..." data-column="other_requirements" style="font-size: 0.85rem; padding: 4px;">
                </td>
            </tr>
            </thead>
            
            <tbody>
                <?php foreach ($apprenticeOrders as $apprenticeOrder): ?>
                <tr>
                    ...
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeOrder->reference_file) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprenticeOrder->has('cooperative_association') ? $this->Html->link($apprenticeOrder->cooperative_association->name, ['controller' => 'CooperativeAssociations', 'action' => 'view', $apprenticeOrder->cooperative_association->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprenticeOrder->has('acceptance_organization') ? $this->Html->link($apprenticeOrder->acceptance_organization->title, ['controller' => 'AcceptanceOrganizations', 'action' => 'view', $apprenticeOrder->acceptance_organization->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeOrder->title) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprenticeOrder->male_trainee_number) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprenticeOrder->female_trainee_number) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprenticeOrder->has('master_job_category') ? $this->Html->link($apprenticeOrder->master_job_category->title, ['controller' => 'MasterJobCategories', 'action' => 'view', $apprenticeOrder->master_job_category->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeOrder->departure_year) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeOrder->departure_month) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeOrder->is_practical_test_required) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeOrder->other_requirements) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
