<?php
/**
 * Process Flow Documentation - Master Training Test Score Grades
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Master Training Test Score Grades</strong> adalah modul untuk mengelola data terkait Master Training Test Score Grades dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Master Training Test Score Grades</strong> is a module for managing Master Training Test Score Grades data in the TMM system.
        <?php else: ?>
            <strong>Master Training Test Score Grades</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Master Training Test Score Grades ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">mastertrainingtestscoregrades</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Master Training Test Score Grades
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Master Training Test Score Grades data form
                    <?php else: ?>
                        Master Training Test Score Grades ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Master Training Test Score Grades -->
