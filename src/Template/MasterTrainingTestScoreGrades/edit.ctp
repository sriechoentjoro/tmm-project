...
<div class="index-header" style="margin-bottom: 20px;">
    <div style="display: flex; align-items: center; justify-content: space-between;">
        <h2 style="margin: 0;"><?= __('Edit Master Training Test Score Grade') ?></h2>
...
<div class="content" style="max-width: 760px;">
    <?= $this->Form->create($masterTrainingTestScoreGrade) ?>
    <fieldset>
        <?php
        echo $this->Form->control('title');
        echo $this->Form->control('min_score');
        echo $this->Form->control('max_score');
