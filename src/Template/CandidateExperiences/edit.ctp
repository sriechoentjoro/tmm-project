 ...
 * @var \App\Model\Entity\App\Model\Entity\CandidateExperience|null $candidateExperience */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Candidate Experiences'), ['action' => 'index'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="candidateExperiences form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Candidate Experience') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($candidateExperience, ['data-confirm' => 'true', 'id' => 'candidateExperienceForm']) ?>
            <?php if (!empty($candidateExperience->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Candidate Experience Information') ?></legend>
                <div class="row">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Candidate Experience'), [
