            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Candidate Experience') ?>: <?= h($candidateExperience->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $candidateExperience->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($candidateExperience->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Last Salary Amount') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($candidateExperience->last_salary_amount) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Candidate Id') ?></th>
                            <td class="github-detail-value">
                                <?= $candidateExperience->has('candidate') ? $this->Html->link($candidateExperience->candidate->name, ['controller' => 'Candidates', 'action' => 'view', $candidateExperience->candidate->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Employment Start Year') ?></th>
                            <td class="github-detail-value"><?= h($candidateExperience->employment_start_year) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Employment End Year') ?></th>
                            <td class="github-detail-value"><?= h($candidateExperience->employment_end_year) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Company Name') ?></th>
                            <td class="github-detail-value"><?= h($candidateExperience->company_name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($candidateExperience->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Employee Status Id') ?></th>
                            <td class="github-detail-value">
                                <?= $candidateExperience->has('master_employee_status') ? $this->Html->link($candidateExperience->master_employee_status->title, ['controller' => 'MasterEmployeeStatuses', 'action' => 'view', $candidateExperience->master_employee_status->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Employment Awards') ?></th>
                            <td class="github-detail-value"><?= h($candidateExperience->employment_awards) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Job Detail') ?></th>
                            <td class="github-detail-value"><?= h($candidateExperience->job_detail) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Termination Reasons') ?></th>
                            <td class="github-detail-value"><?= h($candidateExperience->termination_reasons) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
