            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Candidate Documents Master List') ?>: <?= h($candidateDocumentsMasterList->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $candidateDocumentsMasterList->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($candidateDocumentsMasterList->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Category Id') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($candidateDocumentsMasterList->category_id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($candidateDocumentsMasterList->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Notes') ?></th>
                            <td class="github-detail-value"><?= h($candidateDocumentsMasterList->notes) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Is Required') ?></th>
                            <td class="github-detail-value">
                                <span class="github-badge <?= $candidateDocumentsMasterList->is_required ? 'badge-success' : 'badge-secondary' ?>">
                                    <?= $candidateDocumentsMasterList->is_required ? __('Yes') : __('No'); ?>
                                </span>
                            </td>
                        </tr>
                    </tbody>
