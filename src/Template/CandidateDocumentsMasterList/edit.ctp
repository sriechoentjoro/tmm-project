 ...
 * @var \App\Model\Entity\App\Model\Entity\CandidateDocumentsMasterList|null $candidateDocumentsMasterList */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Candidate Documents Master List'), ['action' => 'index'], ['escape' => false]) ?></li>
    </ul>
</nav>

<!-- Main Content -->
<div class="candidateDocumentsMasterList form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Candidate Documents Master List') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($candidateDocumentsMasterList, ['data-confirm' => 'true', 'id' => 'candidateDocumentsMasterListForm']) ?>
            <?php if (!empty($candidateDocumentsMasterList->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Candidate Documents Master List Information') ?></legend>
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Category Id') ?></label>
                        <?= $this->Form->control('category_id', [
                            'class' => 'form-control',
                            'placeholder' => __('Enter Category Id'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Candidate Documents Master List'), [
