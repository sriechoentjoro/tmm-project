 ...
 * @var \App\Model\Entity\App\Model\Entity\MasterOccupation|null $masterOccupation */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Master Occupations'), ['action' => 'index'], ['escape' => false]) ?></li>
    </ul>
</nav>

<!-- Main Content -->
<div class="masterOccupations form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Master Occupation') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($masterOccupation, ['data-confirm' => 'true', 'id' => 'masterOccupationForm']) ?>
            <?php if (!empty($masterOccupation->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Master Occupation Information') ?></legend>
                <div class="row">
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Occupation Category Id') ?></label>
                        <?= $this->Form->control('occupation_category_id', [
                            'class' => 'form-control',
                            'placeholder' => __('Enter Occupation Category Id'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Master Occupation'), [
