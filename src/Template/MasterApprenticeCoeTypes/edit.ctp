 ...
 * @var \App\Model\Entity\App\Model\Entity\MasterApprenticeCoeType|null $masterApprenticeCoeType */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Master Apprentice Coe Types'), ['action' => 'index'], ['escape' => false]) ?></li>
    </ul>
</nav>

<!-- Main Content -->
<div class="masterApprenticeCoeTypes form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Master Apprentice Coe Type') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($masterApprenticeCoeType, ['data-confirm' => 'true', 'id' => 'masterApprenticeCoeTypeForm']) ?>
            <?php if (!empty($masterApprenticeCoeType->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Master Apprentice Coe Type Information') ?></legend>
                <div class="row">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Master Apprentice Coe Type'), [
