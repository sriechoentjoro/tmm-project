 ...
 * @var \App\Model\Entity\App\Model\Entity\MasterApprenticeSubmissionDocument|null $masterApprenticeSubmissionDocument */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Master Apprentice Submission Documents'), ['action' => 'index'], ['escape' => false]) ?></li>
    </ul>
</nav>

<!-- Main Content -->
<div class="masterApprenticeSubmissionDocuments form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Master Apprentice Submission Document') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($masterApprenticeSubmissionDocument, ['data-confirm' => 'true', 'id' => 'masterApprenticeSubmissionDocumentForm']) ?>
            <?php if (!empty($masterApprenticeSubmissionDocument->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Master Apprentice Submission Document Information') ?></legend>
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Title Jp') ?></label>
                        <?= $this->Form->control('title_jp', [
                            'class' => 'form-control',
                            'placeholder' => __('Enter Title Jp'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                    ...
                    <div class="col-12 mb-3">
                        <div class="form-check">
                            <?= $this->Form->control('is_translation_required', [
                                'type' => 'checkbox',
                                'class' => 'form-check-input',
                                'label' => ['text' => __('Is Translation Required'), 'class' => 'form-check-label']
                            ]) ?>
                        </div>
                    </div>
                    <div class="col-12 mb-3">
                        <div class="form-check">
                            <?= $this->Form->control('is_required', [
                                'type' => 'checkbox',
                                'class' => 'form-check-input',
                                'label' => ['text' => __('Is Required'), 'class' => 'form-check-label']
                            ]) ?>
                        </div>
                    </div>
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Master Apprenticeship Submission Document Category Id') ?></label>
                        <?= $this->Form->control('master_apprenticeship_submission_document_category_id', [
                            'class' => 'form-control',
                            'placeholder' => __('Enter Master Apprenticeship Submission Document Category Id'),
                            'label' => false
                        ]) ?>
                    </div>
                </div>
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Master Apprentice Submission Document'), [
