 ...
 * @var \App\Model\Entity\App\Model\Entity\CandidateFamily|null $candidateFamily */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Candidate Families'), ['action' => 'index'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="candidateFamilies form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Candidate Family') ?>
            </h3>
        </div>
        ...
        <div class="card-body">
            ...
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Candidate Family Information') ?></legend>
                <div class="row">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Candidate Family'), [
