 ...
 * @var \App\Model\Entity\App\Model\Entity\TraineeEducation|null $traineeEducation */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Trainee Educations'), ['action' => 'index'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="traineeEducations form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Trainee Education') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($traineeEducation, ['data-confirm' => 'true', 'id' => 'traineeEducationForm']) ?>
            <?php if (!empty($traineeEducation->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Trainee Education Information') ?></legend>
                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <?= $this->Form->control('kabupaten_id', [
                                            ...
                                            'class' => 'form-control address-select',
                                            'id' => 'TraineeEducationKabupatenId',
                                            'label' => false,
                                    ...
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <?= $this->Form->control('kecamatan_id', [
                                            ...
                                            'class' => 'form-control address-select',
                                            'id' => 'TraineeEducationKecamatanId',
                                            'label' => false,
                                    ...
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <?= $this->Form->control('kelurahan_id', [
                                            ...
                                            'class' => 'form-control address-select',
                                            'id' => 'TraineeEducationKelurahanId',
                                            'label' => false,
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Trainee Education'), [
