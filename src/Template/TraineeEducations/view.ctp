            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Trainee Education') ?>: <?= h($traineeEducation->id) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $traineeEducation->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($traineeEducation->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Trainee Id') ?></th>
                            <td class="github-detail-value">
                                <?= $traineeEducation->has('trainee') ? $this->Html->link($traineeEducation->trainee->name, ['controller' => 'Trainees', 'action' => 'view', $traineeEducation->trainee->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Strata Id') ?></th>
                            <td class="github-detail-value">
                                <?= $traineeEducation->has('master_strata') ? $this->Html->link($traineeEducation->master_strata->title, ['controller' => 'MasterStratas', 'action' => 'view', $traineeEducation->master_strata->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Propinsi Id') ?></th>
                            <td class="github-detail-value">
                                <?= $traineeEducation->has('master_propinsi') ? $this->Html->link($traineeEducation->master_propinsi->title, ['controller' => 'MasterPropinsis', 'action' => 'view', $traineeEducation->master_propinsi->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Kabupaten Id') ?></th>
                            <td class="github-detail-value">
                                <?= $traineeEducation->has('master_kabupaten') ? $this->Html->link($traineeEducation->master_kabupaten->title, ['controller' => 'MasterKabupatens', 'action' => 'view', $traineeEducation->master_kabupaten->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('College Name') ?></th>
                            <td class="github-detail-value"><?= h($traineeEducation->college_name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('College Major') ?></th>
                            <td class="github-detail-value"><?= h($traineeEducation->college_major) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('College Entry Date') ?></th>
                            <td class="github-detail-value"><?= h($traineeEducation->college_entry_date) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('College Graduate Date') ?></th>
                            <td class="github-detail-value"><?= h($traineeEducation->college_graduate_date) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
