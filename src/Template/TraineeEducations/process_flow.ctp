<?php
/**
 * Process Flow Documentation - Trainee Educations
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Trainee Educations</strong> adalah modul untuk mengelola data terkait Trainee Educations dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Trainee Educations</strong> is a module for managing Trainee Educations data in the TMM system.
        <?php else: ?>
            <strong>Trainee Educations</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Trainee Educations ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">traineeeducations</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Trainee Educations
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Trainee Educations data form
                    <?php else: ?>
                        Trainee Educations ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Trainee Educations -->
