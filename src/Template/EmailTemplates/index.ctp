...
<div class="index-header" style="margin-bottom: 20px;">
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <h2 style="margin: 0;"><?= __('Email Templates') ?></h2>
        ...
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            <thead style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.15) 0%, rgba(118, 75, 162, 0.15) 100%);">
                <tr>
                    ...
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('subject') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('template_key') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('description') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('is_active') ?></th>
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid #e9ecef;">
                    ...
                    <td style="padding: 10px 12px;"><?= h($row['subject']) ?></td>
                    <td style="padding: 10px 12px;"><?= h($row['template_key']) ?></td>
                    <td style="padding: 10px 12px;"><?= h($row['description']) ?></td>
                    <td style="padding: 10px 12px;"><?= h($row['is_active']) ?></td>
