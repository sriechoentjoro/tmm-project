            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Master Kabupaten') ?>: <?= h($masterKabupaten->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $masterKabupaten->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($masterKabupaten->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Propinsi Id') ?></th>
                            <td class="github-detail-value">
                                <?= $masterKabupaten->has('master_propinsi') ? $this->Html->link($masterKabupaten->master_propinsi->title, ['controller' => 'MasterPropinsis', 'action' => 'view', $masterKabupaten->master_propinsi->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Kode Propinsi') ?></th>
                            <td class="github-detail-value"><?= h($masterKabupaten->kode_propinsi) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Kode Kabupaten') ?></th>
                            <td class="github-detail-value"><?= h($masterKabupaten->kode_kabupaten) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($masterKabupaten->title) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
