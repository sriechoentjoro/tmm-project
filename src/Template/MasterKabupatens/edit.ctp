 ...
 * @var \App\Model\Entity\App\Model\Entity\MasterKabupaten|null $masterKabupaten */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Master Kabupatens'), ['action' => 'index'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="masterKabupatens form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Master Kabupaten') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($masterKabupaten, ['data-confirm' => 'true', 'id' => 'masterKabupatenForm']) ?>
            <?php if (!empty($masterKabupaten->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Master Kabupaten Information') ?></legend>
                <div class="row">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Master Kabupaten'), [
