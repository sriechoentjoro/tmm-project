<?php
/**
 * Process Flow Documentation - Master Kabupatens
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Master Kabupatens</strong> adalah modul untuk mengelola data terkait Master Kabupatens dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Master Kabupatens</strong> is a module for managing Master Kabupatens data in the TMM system.
        <?php else: ?>
            <strong>Master Kabupatens</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Master Kabupatens ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">masterkabupatens</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Master Kabupatens
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Master Kabupatens data form
                    <?php else: ?>
                        Master Kabupatens ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Master Kabupatens -->
