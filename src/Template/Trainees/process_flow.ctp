<?php
/**
 * Process Flow Documentation - Trainees
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Trainees</strong> adalah modul untuk mengelola data terkait Trainees dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Trainees</strong> is a module for managing Trainees data in the TMM system.
        <?php else: ?>
            <strong>Trainees</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Trainees ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">trainees</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Trainees
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Trainees data form
                    <?php else: ?>
                        Trainees ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Trainees -->
