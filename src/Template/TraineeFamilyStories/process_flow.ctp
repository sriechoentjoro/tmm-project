<?php
/**
 * Process Flow Documentation - Trainee Family Stories
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Trainee Family Stories</strong> adalah modul untuk mengelola data terkait Trainee Family Stories dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Trainee Family Stories</strong> is a module for managing Trainee Family Stories data in the TMM system.
        <?php else: ?>
            <strong>Trainee Family Stories</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Trainee Family Stories ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">traineefamilystories</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Trainee Family Stories
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Trainee Family Stories data form
                    <?php else: ?>
                        Trainee Family Stories ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Trainee Family Stories -->
