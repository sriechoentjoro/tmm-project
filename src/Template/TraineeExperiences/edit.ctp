 ...
 * @var \App\Model\Entity\App\Model\Entity\TraineeExperience|null $traineeExperience */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Trainee Experiences'), ['action' => 'index'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="traineeExperiences form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Trainee Experience') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($traineeExperience, ['data-confirm' => 'true', 'id' => 'traineeExperienceForm']) ?>
            <?php if (!empty($traineeExperience->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Trainee Experience Information') ?></legend>
                <div class="row">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Trainee Experience'), [
