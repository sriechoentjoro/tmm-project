<?php
/**
 * Process Flow Documentation - Trainee Training Test Scores
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Trainee Training Test Scores</strong> adalah modul untuk mengelola data terkait Trainee Training Test Scores dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Trainee Training Test Scores</strong> is a module for managing Trainee Training Test Scores data in the TMM system.
        <?php else: ?>
            <strong>Trainee Training Test Scores</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Trainee Training Test Scores ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">traineetrainingtestscores</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Trainee Training Test Scores
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Trainee Training Test Scores data form
                    <?php else: ?>
                        Trainee Training Test Scores ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Trainee Training Test Scores -->
