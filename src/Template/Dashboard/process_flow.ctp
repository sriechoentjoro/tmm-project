<?php
/**
 * Process Flow Documentation - Dashboard
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Dashboard</strong> adalah modul untuk mengelola data terkait Dashboard dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Dashboard</strong> is a module for managing Dashboard data in the TMM system.
        <?php else: ?>
            <strong>Dashboard</strong>は、TMMシステムでDashboard データを管理するモジュールです。
        <?php endif; ?>
    </div>
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php else: ?>
                        ステップ1：データ入力
                    <?php endif; ?>
                    <span class="database-indicator">dashboard</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Dashboard
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Dashboard data form
                    <?php else: ?>
                        Dashboard データフォームに記入する
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Dashboard -->
