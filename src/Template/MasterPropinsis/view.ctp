            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Master Propinsi') ?>: <?= h($masterPropinsi->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $masterPropinsi->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($masterPropinsi->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Kode Propinsi') ?></th>
                            <td class="github-detail-value"><?= h($masterPropinsi->kode_propinsi) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($masterPropinsi->title) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
