<?php
/**
 * Process Flow Documentation - Candidate Documents
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Candidate Documents</strong> adalah modul untuk mengelola data terkait Candidate Documents dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Candidate Documents</strong> is a module for managing Candidate Documents data in the TMM system.
        <?php else: ?>
            <strong>Candidate Documents</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Candidate Documents ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">candidatedocuments</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Candidate Documents
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Candidate Documents data form
                    <?php else: ?>
                        Candidate Documents ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Candidate Documents -->
