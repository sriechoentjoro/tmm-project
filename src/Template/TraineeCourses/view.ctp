            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Trainee Course') ?>: <?= h($traineeCourse->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $traineeCourse->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($traineeCourse->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Course Major Id') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($traineeCourse->course_major_id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Course Year') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($traineeCourse->course_year) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Trainee Id') ?></th>
                            <td class="github-detail-value">
                                <?= $traineeCourse->has('trainee') ? $this->Html->link($traineeCourse->trainee->name, ['controller' => 'Trainees', 'action' => 'view', $traineeCourse->trainee->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Vocational Training Institution Id') ?></th>
                            <td class="github-detail-value">
                                <?= $traineeCourse->has('vocational_training_institution') ? $this->Html->link($traineeCourse->vocational_training_institution->name, ['controller' => 'VocationalTrainingInstitutions', 'action' => 'view', $traineeCourse->vocational_training_institution->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($traineeCourse->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Detail') ?></th>
                            <td class="github-detail-value"><?= h($traineeCourse->detail) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
