            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Master Marriage Status') ?>: <?= h($masterMarriageStatus->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $masterMarriageStatus->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($masterMarriageStatus->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Slug') ?></th>
                            <td class="github-detail-value"><?= h($masterMarriageStatus->slug) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($masterMarriageStatus->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title Jpg') ?></th>
                            <td class="github-detail-value"><?= h($masterMarriageStatus->title_jpg) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
