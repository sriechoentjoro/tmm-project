 ...
 * @var \App\Model\Entity\App\Model\Entity\MasterMarriageStatus|null $masterMarriageStatus */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Master Marriage Statuses'), ['action' => 'index'], ['escape' => false]) ?></li>
    </ul>
</nav>

<!-- Main Content -->
<div class="masterMarriageStatuses form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Master Marriage Status') ?>
            </h3>
        </div>
        ...
        <div class="card-body">
            ...
            <fieldset>
                <legend><?= __('Enter Master Marriage Status Information') ?></legend>
                <div class="row">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Master Marriage Status'), [
