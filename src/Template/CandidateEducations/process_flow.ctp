<?php
/**
 * Process Flow Documentation - Candidate Educations
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Candidate Educations</strong> adalah modul untuk mengelola data terkait Candidate Educations dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Candidate Educations</strong> is a module for managing Candidate Educations data in the TMM system.
        <?php else: ?>
            <strong>Candidate Educations</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Candidate Educations ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">candidateeducations</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Candidate Educations
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Candidate Educations data form
                    <?php else: ?>
                        Candidate Educations ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Candidate Educations -->
