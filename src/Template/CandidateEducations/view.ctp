            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Candidate Education') ?>: <?= h($candidateEducation->id) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $candidateEducation->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($candidateEducation->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Candidate Id') ?></th>
                            <td class="github-detail-value">
                                <?= $candidateEducation->has('candidate') ? $this->Html->link($candidateEducation->candidate->name, ['controller' => 'Candidates', 'action' => 'view', $candidateEducation->candidate->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Strata Id') ?></th>
                            <td class="github-detail-value">
                                <?= $candidateEducation->has('master_strata') ? $this->Html->link($candidateEducation->master_strata->title, ['controller' => 'MasterStratas', 'action' => 'view', $candidateEducation->master_strata->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Propinsi Id') ?></th>
                            <td class="github-detail-value">
                                <?= $candidateEducation->has('master_propinsi') ? $this->Html->link($candidateEducation->master_propinsi->title, ['controller' => 'MasterPropinsis', 'action' => 'view', $candidateEducation->master_propinsi->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Kabupaten Id') ?></th>
                            <td class="github-detail-value">
                                <?= $candidateEducation->has('master_kabupaten') ? $this->Html->link($candidateEducation->master_kabupaten->title, ['controller' => 'MasterKabupatens', 'action' => 'view', $candidateEducation->master_kabupaten->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('College Name') ?></th>
                            <td class="github-detail-value"><?= h($candidateEducation->college_name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('College Major') ?></th>
                            <td class="github-detail-value"><?= h($candidateEducation->college_major) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('College Entry Date') ?></th>
                            <td class="github-detail-value"><?= h($candidateEducation->college_entry_date) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('College Graduate Date') ?></th>
                            <td class="github-detail-value"><?= h($candidateEducation->college_graduate_date) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
