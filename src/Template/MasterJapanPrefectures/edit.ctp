 ...
 * @var \App\Model\Entity\App\Model\Entity\MasterJapanPrefecture|null $masterJapanPrefecture */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Master Japan Prefectures'), ['action' => 'index'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="masterJapanPrefectures form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Master Japan Prefecture') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($masterJapanPrefecture, ['data-confirm' => 'true', 'id' => 'masterJapanPrefectureForm']) ?>
            <?php if (!empty($masterJapanPrefecture->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Master Japan Prefecture Information') ?></legend>
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Prefecture Jpg') ?></label>
                        <?= $this->Form->control('prefecture_jpg', [
                            'class' => 'form-control',
                            'placeholder' => __('Enter Prefecture Jpg'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Master Japan Prefecture'), [
