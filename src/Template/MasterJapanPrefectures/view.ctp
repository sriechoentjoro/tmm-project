            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <?= $this->Html->link(
                            '<i class="fas fa-list"></i> ' . __('List Master Japan Prefectures'),
                            ['action' => 'index'],
                            ['class' => 'dropdown-item', 'escape' => false]
                        ) ?>
                        <?= $this->Html->link(
                            '<i class="fas fa-plus"></i> ' . __('New Master Japan Prefecture'),
                            ['action' => 'add'],
                            ['class' => 'dropdown-item', 'escape' => false]
                        ) ?>
                    </div>
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Master Japan Prefecture') ?>: <?= h($masterJapanPrefecture->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Html->link(
                        ...
                        ['action' => 'edit', $masterJapanPrefecture->id],
                        ['class' => 'btn-export-light', 'escape' => false]
                    ) ?>
                    <?= $this->Form->postLink(
                        '<i class="fas fa-trash"></i> ' . __('Delete'),
                        ['action' => 'delete', $masterJapanPrefecture->id],
                        [
                            'class' => 'btn-export-light',
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $masterJapanPrefecture->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
        ...
        <ul class="view-tabs-nav" role="tablist">
            ...
            <li class="view-tab-item">
                <a href="#tab-acceptance_organizations" class="view-tab-link" data-tab="tab-acceptance_organizations">
                    ...
                    <?php if (!empty($masterJapanPrefecture->acceptance_organizations)): ?>
                    <span class="tab-badge"><?= count($masterJapanPrefecture->acceptance_organizations) ?></span>
                    <?php endif; ?>
                </a>
            </li>
        </ul>
        ...
        <div class="view-tabs-content">
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($masterJapanPrefecture->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Area') ?></th>
                            <td class="github-detail-value"><?= h($masterJapanPrefecture->area) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($masterJapanPrefecture->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Prefecture Jpg') ?></th>
                            <td class="github-detail-value"><?= h($masterJapanPrefecture->prefecture_jpg) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Capital') ?></th>
                            <td class="github-detail-value"><?= h($masterJapanPrefecture->capital) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div id="tab-acceptance_organizations" class="view-tab-pane">
                ...
                <div class="github-related-card">
                    <div class="github-related-header">
                        <h3 class="github-related-title">
                            ...
                            <?= __('Related AcceptanceOrganizations') ?>
                            <?= $this->Html->link(
                            ...
                            <table class="table table-striped table-hover github-related-table" data-ajax-filter="true">
                                <thead style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.15) 0%, rgba(118, 75, 162, 0.15) 100%);">
                                    <tr>
                                        ...
                                        <th><?= __('Id') ?></th>
                                        <th><?= __('Title') ?></th>
                                        <th><?= __('Master Japan Prefecture Id') ?></th>
                                        <th><?= __('Post Code') ?></th>
                                        <th><?= __('Address') ?></th>
                                    </tr>
                                    <!-- Filter Row -->
                                    <tr class="filter-row" style="background-color: #f8f9fa;">
                                        ...
                                        <th style="padding: 4px;">
                                            <div style="display: flex; gap: 3px;">
                                                <select class="form-control form-control-sm filter-operator" 
                                                        data-column="master_japan_prefecture_id" 
                                                        style="width: 70px; padding: 2px 4px; font-size: 11px;">
                                                    <option value="contains"><?= __('Contains') ?></option>
                                                    <option value="equals"><?= __('Equals') ?></option>
                                                    <option value="starts"><?= __('Starts') ?></option>
                                                ...
                                                <input type="text" 
                                                       class="form-control form-control-sm filter-input" 
                                                       placeholder="<?= __('Filter Master Japan Prefecture Id') ?>" 
                                                       data-column="master_japan_prefecture_id"
                                                   style="font-size: 12px; height: 28px; border: 1px solid #ddd;">
                                        </th>
                                        <th style="padding: 4px;">
                                            <div style="display: flex; gap: 3px;">
                                                ...
                                                <input type="text" 
                                                       class="form-control form-control-sm filter-input" 
                                                       placeholder="<?= __('Filter Post Code') ?>" 
                                                       data-column="post_code"
                                                   style="font-size: 12px; height: 28px; border: 1px solid #ddd;">
                                        </th>
                                        <th style="padding: 4px;">
                                ...
                                <tbody>
                                    <?php foreach ($masterJapanPrefecture->acceptance_organizations as $acceptanceOrganizations): ?>
                                    <tr class="table-row-with-actions">
                                        <td class="actions actions-column" style="padding: 5px; vertical-align: middle; white-space: nowrap; background: inherit; border: none; position: sticky; left: 0; z-index: 5; min-width: 90px;">
                                            <div class="action-buttons-hover">
                                                <?= $this->Html->link(
                                                    ...
                                                    ['controller' => 'AcceptanceOrganizations', 'action' => 'edit', $acceptanceOrganizations->id],
                                                    ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => __('Edit')]
                                                ) ?>
                                                <?= $this->Html->link(
                                                    '<i class="fas fa-eye"></i>',
                                                    ['controller' => 'AcceptanceOrganizations', 'action' => 'view', $acceptanceOrganizations->id],
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $acceptanceOrganizations->has('master_japan_prefecture') ? $this->Html->link($acceptanceOrganizations->master_japan_prefecture->title, ['controller' => 'MasterJapanPrefectures', 'action' => 'view', $acceptanceOrganizations->master_japan_prefecture->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                        <td><?= h($acceptanceOrganizations->post_code) ?></td>
                                        <td><?= h($acceptanceOrganizations->address) ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                ...
                <div class="github-empty-state">
                    ...
                    <h3><?= __('No Related AcceptanceOrganizations') ?></h3>
                    <p><?= __('There are no related AcceptanceOrganizations for this Master Japan Prefecture.') ?></p>
                    <?= $this->Html->link(
                        __('Add First AcceptanceOrganization'),
                        ['controller' => 'AcceptanceOrganizations', 'action' => 'add'],
                        ['class' => 'btn-export-light']
                    ) ?>
                </div>
    ...
    <div class="related-section mt-4">
        ...
        <ul class="nav nav-tabs" id="relatedTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="acceptanceorganizations-tab" data-bs-toggle="tab" 
                        data-bs-target="#acceptanceorganizations-pane" type="button" role="tab" 
                        aria-controls="acceptanceorganizations-pane" aria-selected="true">
                    <?= __('AcceptanceOrganizations') ?>
                </button>
            </li>
        </ul>
