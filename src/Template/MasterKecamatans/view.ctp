            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Master Kecamatan') ?>: <?= h($masterKecamatan->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $masterKecamatan->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($masterKecamatan->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Propinsi Id') ?></th>
                            <td class="github-detail-value">
                                <?= $masterKecamatan->has('master_propinsi') ? $this->Html->link($masterKecamatan->master_propinsi->title, ['controller' => 'MasterPropinsis', 'action' => 'view', $masterKecamatan->master_propinsi->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Kabupaten Id') ?></th>
                            <td class="github-detail-value">
                                <?= $masterKecamatan->has('master_kabupaten') ? $this->Html->link($masterKecamatan->master_kabupaten->title, ['controller' => 'MasterKabupatens', 'action' => 'view', $masterKecamatan->master_kabupaten->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Kode Propinsi') ?></th>
                            <td class="github-detail-value"><?= h($masterKecamatan->kode_propinsi) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Kode Kabupaten') ?></th>
                            <td class="github-detail-value"><?= h($masterKecamatan->kode_kabupaten) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Kode Kecamatan') ?></th>
                            <td class="github-detail-value"><?= h($masterKecamatan->kode_kecamatan) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($masterKecamatan->title) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
