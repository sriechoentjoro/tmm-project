 ...
 * @var \App\Model\Entity\App\Model\Entity\MasterKecamatan|null $masterKecamatan */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Master Kecamatans'), ['action' => 'index'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="masterKecamatans form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Master Kecamatan') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($masterKecamatan, ['data-confirm' => 'true', 'id' => 'masterKecamatanForm']) ?>
            <?php if (!empty($masterKecamatan->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Master Kecamatan Information') ?></legend>
                <div class="row">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Master Kecamatan'), [
