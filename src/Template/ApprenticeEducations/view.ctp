            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <div class="dropdown-divider"></div>
                        <?= $this->Html->link(
                            '<i class="fas fa-list"></i> ' . __('List MasterStratas'),
                            ['controller' => 'MasterStratas', 'action' => 'index'],
                            ['class' => 'dropdown-item', 'escape' => false]
                        ) ?>
                        <?= $this->Html->link(
                            '<i class="fas fa-plus"></i> ' . __('New MasterStrata'),
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Apprentice Education') ?>: <?= h($apprenticeEducation->id) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $apprenticeEducation->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($apprenticeEducation->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Apprentice Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprenticeEducation->has('apprentice') ? $this->Html->link($apprenticeEducation->apprentice->name, ['controller' => 'Apprentices', 'action' => 'view', $apprenticeEducation->apprentice->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Strata Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprenticeEducation->has('master_strata') ? $this->Html->link($apprenticeEducation->master_strata->title, ['controller' => 'MasterStratas', 'action' => 'view', $apprenticeEducation->master_strata->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Propinsi Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprenticeEducation->has('master_propinsi') ? $this->Html->link($apprenticeEducation->master_propinsi->title, ['controller' => 'MasterPropinsis', 'action' => 'view', $apprenticeEducation->master_propinsi->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Kabupaten Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprenticeEducation->has('master_kabupaten') ? $this->Html->link($apprenticeEducation->master_kabupaten->title, ['controller' => 'MasterKabupatens', 'action' => 'view', $apprenticeEducation->master_kabupaten->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('College Name') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeEducation->college_name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('College Major') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeEducation->college_major) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('College Entry Date') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeEducation->college_entry_date) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('College Graduate Date') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeEducation->college_graduate_date) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
