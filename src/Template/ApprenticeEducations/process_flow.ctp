<?php
/**
 * Process Flow Documentation - Apprentice Educations
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Apprentice Educations</strong> adalah modul untuk mengelola data terkait Apprentice Educations dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Apprentice Educations</strong> is a module for managing Apprentice Educations data in the TMM system.
        <?php else: ?>
            <strong>Apprentice Educations</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Apprentice Educations ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">apprenticeeducations</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Apprentice Educations
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Apprentice Educations data form
                    <?php else: ?>
                        Apprentice Educations ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Apprentice Educations -->
