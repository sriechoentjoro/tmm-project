 ...
 * @var \App\Model\Entity\App\Model\Entity\ApprenticeEducation|null $apprenticeEducation */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Apprentice Educations'), ['action' => 'index'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="apprenticeEducations form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Apprentice Education') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($apprenticeEducation, ['data-confirm' => 'true', 'id' => 'apprenticeEducationForm']) ?>
            <?php if (!empty($apprenticeEducation->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Apprentice Education Information') ?></legend>
                <div class="row">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Apprentice Education'), [
