<?php
/**
 * Process Flow Documentation - Master Document Submission Statuses
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Master Document Submission Statuses</strong> adalah modul untuk mengelola data terkait Master Document Submission Statuses dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Master Document Submission Statuses</strong> is a module for managing Master Document Submission Statuses data in the TMM system.
        <?php else: ?>
            <strong>Master Document Submission Statuses</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Master Document Submission Statuses ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">masterdocumentsubmissionstatuses</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Master Document Submission Statuses
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Master Document Submission Statuses data form
                    <?php else: ?>
                        Master Document Submission Statuses ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Master Document Submission Statuses -->
