            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Master Interview Result') ?>: <?= h($masterInterviewResult->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $masterInterviewResult->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($masterInterviewResult->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($masterInterviewResult->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title Jpg') ?></th>
                            <td class="github-detail-value"><?= h($masterInterviewResult->title_jpg) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Details') ?></th>
                            <td class="github-detail-value"><?= h($masterInterviewResult->details) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
