 ...
 * @var \App\Model\Entity\App\Model\Entity\MasterMedicalCheckUpResult|null $masterMedicalCheckUpResult */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Master Medical Check Up Results'), ['action' => 'index'], ['escape' => false]) ?></li>
    </ul>
</nav>

<!-- Main Content -->
<div class="masterMedicalCheckUpResults form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Master Medical Check Up Result') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($masterMedicalCheckUpResult, ['data-confirm' => 'true', 'id' => 'masterMedicalCheckUpResultForm']) ?>
            <?php if (!empty($masterMedicalCheckUpResult->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Master Medical Check Up Result Information') ?></legend>
                <div class="row">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Master Medical Check Up Result'), [
