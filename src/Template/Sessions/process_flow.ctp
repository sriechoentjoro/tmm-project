<?php
/**
 * Process Flow Documentation - Sessions
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php else: ?>
            <strong>Sessions</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Sessions ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">sessions</span>
                </div>
                <div class="step-description">
                    ...
                    <?php else: ?>
                        Sessions ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Sessions -->
