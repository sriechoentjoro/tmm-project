            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Acceptance Organization') ?>: <?= h($acceptanceOrganization->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $acceptanceOrganization->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
        ...
        <ul class="view-tabs-nav" role="tablist">
            ...
            <li class="view-tab-item">
                <a href="#tab-stories" class="view-tab-link" data-tab="tab-stories">
                    <svg class="tab-icon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                        <path d="M1.75 0A1.75 1.75 0 000 1.75v12.5C0 15.216.784 16 1.75 16h12.5A1.75 1.75 0 0016 14.25V1.75A1.75 1.75 0 0014.25 0H1.75zM1.5 1.75a.25.25 0 01.25-.25h12.5a.25.25 0 01.25.25v12.5a.25.25 0 01-.25.25H1.75a.25.25 0 01-.25-.25V1.75zM3.75 6a.75.75 0 000 1.5h8.5a.75.75 0 000-1.5h-8.5zM3 9.75A.75.75 0 013.75 9h5a.75.75 0 010 1.5h-5A.75.75 0 013 9.75z"></path>
                    </svg>
                    <?= __('Stories') ?>
                </a>
            </li>
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($acceptanceOrganization->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Japan Prefecture Id') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($acceptanceOrganization->master_japan_prefecture_id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Post Code') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($acceptanceOrganization->post_code) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($acceptanceOrganization->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Address') ?></th>
                            <td class="github-detail-value"><?= h($acceptanceOrganization->address) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Director') ?></th>
                            <td class="github-detail-value"><?= h($acceptanceOrganization->director) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Director Hiragana') ?></th>
                            <td class="github-detail-value"><?= h($acceptanceOrganization->director_hiragana) ?></td>
                        </tr>
                        <tr>
