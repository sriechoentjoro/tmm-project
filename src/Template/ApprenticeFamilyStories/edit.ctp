 ...
 * @var \App\Model\Entity\App\Model\Entity\ApprenticeFamilyStory|null $apprenticeFamilyStory */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Apprentice Family Stories'), ['action' => 'index'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="apprenticeFamilyStories form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Apprentice Family Story') ?>
            </h3>
        </div>
        ...
        <div class="card-body">
            ...
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Apprentice Family Story Information') ?></legend>
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <?php if (!empty($apprenticeFamilyStory->image_path)): ?>
                            <div class="mt-2">
                                <img src="<?= $this->Url->build('/' . $apprenticeFamilyStory->image_path, ['fullBase' => true]) ?>" 
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Apprentice Family Story'), [
