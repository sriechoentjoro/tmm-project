 ...
 * @var \App\Model\Entity\App\Model\Entity\CooperativeAssociationStory|null $cooperativeAssociationStory */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Cooperative Association Stories'), ['action' => 'index'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="cooperativeAssociationStories form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Cooperative Association Story') ?>
            </h3>
        </div>
        ...
        <div class="card-body">
            ...
            <fieldset>
                <legend><?= __('Enter Cooperative Association Story Information') ?></legend>
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <?php if (!empty($cooperativeAssociationStory->image_path)): ?>
                            <div class="mt-2">
                                <img src="<?= $this->Url->build('/' . $cooperativeAssociationStory->image_path, ['fullBase' => true]) ?>" 
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Cooperative Association Story'), [
