 ...
 * @var \App\Model\Entity\App\Model\Entity\MasterBloodType|null $masterBloodType */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Master Blood Types'), ['action' => 'index'], ['escape' => false]) ?></li>
    </ul>
</nav>

<!-- Main Content -->
<div class="masterBloodTypes form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Master Blood Type') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($masterBloodType, ['data-confirm' => 'true', 'id' => 'masterBloodTypeForm']) ?>
            <?php if (!empty($masterBloodType->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Master Blood Type Information') ?></legend>
                <div class="row">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Master Blood Type'), [
