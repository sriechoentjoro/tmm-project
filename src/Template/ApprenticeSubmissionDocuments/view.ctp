            ...
            <div id="tab-home" class="view-tab-pane active">
                ...
                <div class="file-preview-container" style="margin-bottom: 20px; background: #f6f8fa; padding: 20px; border-radius: 8px; border: 1px solid #d0d7de;">
                    ...
                    <?= $this->element('file_viewer', [
                        'filePath' => $apprenticeSubmissionDocument->apprenticeship_submission_document_id,
                        'editUrl' => $this->Url->build(['action' => 'edit', $apprenticeSubmissionDocument->id]),
                        'showModal' => true
                    ]) ?>
                </div>
                <?php endif; ?>
                        ...
                        <tr>
                            ...
                            <td class="github-detail-value">
                                <?= $this->element('file_viewer_modal', [
                                    'filePath' => $apprenticeSubmissionDocument->file_path,
                                    'fieldName' => 'file_path'
                                ]) ?>
                            </td>
                        </tr>
