<?php
/**
 * Process Flow Documentation - Apprentice Submission Documents
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Apprentice Submission Documents</strong> adalah modul untuk mengelola data terkait Apprentice Submission Documents dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Apprentice Submission Documents</strong> is a module for managing Apprentice Submission Documents data in the TMM system.
        <?php else: ?>
            <strong>Apprentice Submission Documents</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Apprentice Submission Documents ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">apprenticesubmissiondocuments</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Apprentice Submission Documents
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Apprentice Submission Documents data form
                    <?php else: ?>
                        Apprentice Submission Documents ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Apprentice Submission Documents -->
