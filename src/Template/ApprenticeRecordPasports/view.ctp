            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Apprentice Record Pasport') ?>: <?= h($apprenticeRecordPasport->id) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $apprenticeRecordPasport->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($apprenticeRecordPasport->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Apprentice Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprenticeRecordPasport->has('apprentice') ? $this->Html->link($apprenticeRecordPasport->apprentice->name, ['controller' => 'Apprentices', 'action' => 'view', $apprenticeRecordPasport->apprentice->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Place Issue') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeRecordPasport->place_issue) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Date Issue') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeRecordPasport->date_issue) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Date Received') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeRecordPasport->date_received) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Date Paid') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeRecordPasport->date_paid) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
