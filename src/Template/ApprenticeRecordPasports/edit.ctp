 ...
 * @var \App\Model\Entity\App\Model\Entity\ApprenticeRecordPasport|null $apprenticeRecordPasport */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Apprentice Record Pasports'), ['action' => 'index'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="apprenticeRecordPasports form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Apprentice Record Pasport') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($apprenticeRecordPasport, ['data-confirm' => 'true', 'id' => 'apprenticeRecordPasportForm']) ?>
            <?php if (!empty($apprenticeRecordPasport->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Apprentice Record Pasport Information') ?></legend>
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Date Issue') ?></label>
                        <?= $this->Form->control('date_issue', [
                            'type' => 'text',
                            'class' => 'form-control datepicker',
                            'placeholder' => __('Select Date Issue'),
                            'label' => false,
                            'autocomplete' => 'off'
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Place Issue') ?></label>
                        <?= $this->Form->control('place_issue', [
                            'class' => 'form-control',
                            'placeholder' => __('Enter Place Issue'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                        ...
                        <?= $this->Form->control('date_received', [
                            'type' => 'text',
                            'class' => 'form-control datepicker',
                            'placeholder' => __('Select Date Received'),
                            'label' => false,
                            'autocomplete' => 'off'
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                        ...
                        <?= $this->Form->control('date_paid', [
                            'type' => 'text',
                            'class' => 'form-control datepicker',
                            'placeholder' => __('Select Date Paid'),
                            'label' => false,
                            'autocomplete' => 'off'
                        ]) ?>
                    </div>
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Apprentice Record Pasport'), [
