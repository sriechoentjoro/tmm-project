<?php
/**
 * Process Flow Documentation - Apprentice Record Pasports
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Apprentice Record Pasports</strong> adalah modul untuk mengelola data terkait Apprentice Record Pasports dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Apprentice Record Pasports</strong> is a module for managing Apprentice Record Pasports data in the TMM system.
        <?php else: ?>
            <strong>Apprentice Record Pasports</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Apprentice Record Pasports ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">apprenticerecordpasports</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Apprentice Record Pasports
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Apprentice Record Pasports data form
                    <?php else: ?>
                        Apprentice Record Pasports ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Apprentice Record Pasports -->
