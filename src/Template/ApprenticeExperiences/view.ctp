            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <div class="dropdown-divider"></div>
                        <?= $this->Html->link(
                            '<i class="fas fa-list"></i> ' . __('List MasterEmployeeStatuses'),
                            ['controller' => 'MasterEmployeeStatuses', 'action' => 'index'],
                            ['class' => 'dropdown-item', 'escape' => false]
                        ) ?>
                        <?= $this->Html->link(
                            '<i class="fas fa-plus"></i> ' . __('New MasterEmployeeStatus'),
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Apprentice Experience') ?>: <?= h($apprenticeExperience->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $apprenticeExperience->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($apprenticeExperience->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Last Salary Amount') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($apprenticeExperience->last_salary_amount) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Apprentice Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprenticeExperience->has('apprentice') ? $this->Html->link($apprenticeExperience->apprentice->name, ['controller' => 'Apprentices', 'action' => 'view', $apprenticeExperience->apprentice->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Employment Start Year') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeExperience->employment_start_year) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Employment End Year') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeExperience->employment_end_year) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Company Name') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeExperience->company_name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeExperience->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Employee Status Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprenticeExperience->has('master_employee_status') ? $this->Html->link($apprenticeExperience->master_employee_status->title, ['controller' => 'MasterEmployeeStatuses', 'action' => 'view', $apprenticeExperience->master_employee_status->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Employment Awards') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeExperience->employment_awards) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Job Detail') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeExperience->job_detail) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Termination Reasons') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeExperience->termination_reasons) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
