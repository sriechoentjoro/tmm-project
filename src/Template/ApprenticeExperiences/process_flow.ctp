<?php
/**
 * Process Flow Documentation - Apprentice Experiences
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Apprentice Experiences</strong> adalah modul untuk mengelola data terkait Apprentice Experiences dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Apprentice Experiences</strong> is a module for managing Apprentice Experiences data in the TMM system.
        <?php else: ?>
            <strong>Apprentice Experiences</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Apprentice Experiences ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">apprenticeexperiences</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Apprentice Experiences
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Apprentice Experiences data form
                    <?php else: ?>
                        Apprentice Experiences ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Apprentice Experiences -->
