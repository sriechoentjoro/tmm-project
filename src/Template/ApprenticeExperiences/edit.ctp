 ...
 * @var \App\Model\Entity\App\Model\Entity\ApprenticeExperience|null $apprenticeExperience */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Apprentice Experiences'), ['action' => 'index'], ['escape' => false]) ?></li>
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List MasterEmployeeStatuses'), ['controller' => 'MasterEmployeeStatuses', 'action' => 'index'], ['escape' => false]) ?></li>
        <li><?= $this->Html->link('<i class="fas fa-plus"></i> ' . __('New MasterEmployeeStatus'), ['controller' => 'MasterEmployeeStatuses', 'action' => 'add'], ['escape' => false]) ?></li>
    </ul>
</nav>

<!-- Main Content -->
<div class="apprenticeExperiences form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Apprentice Experience') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($apprenticeExperience, ['data-confirm' => 'true', 'id' => 'apprenticeExperienceForm']) ?>
            <?php if (!empty($apprenticeExperience->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Apprentice Experience Information') ?></legend>
                <div class="row">
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Apprentice Id') ?></label>
                        <?= $this->Form->control('apprentice_id', [
                            'options' => $apprentices,
                            'class' => 'form-control',
                            'label' => false,
                            'empty' => __('-- Select Apprentice Id --')
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Employment Start Year') ?></label>
                        <?= $this->Form->control('employment_start_year', [
                            'class' => 'form-control',
                            'placeholder' => __('Enter Employment Start Year'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Employment End Year') ?></label>
                        <?= $this->Form->control('employment_end_year', [
                            'class' => 'form-control',
                            'placeholder' => __('Enter Employment End Year'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                    ...
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Master Employee Status Id') ?></label>
                        <?= $this->Form->control('master_employee_status_id', [
                            'options' => $masterEmployeeStatuses,
                            'class' => 'form-control',
                            'label' => false,
                            'empty' => __('-- Select Master Employee Status Id --')
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Employment Awards') ?></label>
                        <?= $this->Form->control('employment_awards', [
                            'type' => 'textarea',
                            'class' => 'form-control',
                            'rows' => 3,
                            'placeholder' => __('Enter Employment Awards'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                    ...
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Job Detail') ?></label>
                        <?= $this->Form->control('job_detail', [
                            'type' => 'textarea',
                            'class' => 'form-control',
                            'rows' => 3,
                            'placeholder' => __('Enter Job Detail'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Termination Reasons') ?></label>
                        <?= $this->Form->control('termination_reasons', [
                            'type' => 'textarea',
                            'class' => 'form-control',
                            'rows' => 3,
                            'placeholder' => __('Enter Termination Reasons'),
                            'label' => false
                        ]) ?>
                    </div>
                </div>
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Apprentice Experience'), [
