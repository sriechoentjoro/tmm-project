            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Vocational Training Institution') ?>: <?= h($vocationalTrainingInstitution->name) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Html->link(
                        ...
                        ['action' => 'edit', $vocationalTrainingInstitution->id],
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $vocationalTrainingInstitution->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
            ...
            <div id="tab-home" class="view-tab-pane active">
                ...
                <div class="file-preview-container" style="margin-bottom: 20px; background: #f6f8fa; padding: 20px; border-radius: 8px; border: 1px solid #d0d7de;">
                    ...
                    <?= $this->element('file_viewer', [
                        'filePath' => $vocationalTrainingInstitution->mou_file,
                        'editUrl' => $this->Url->build(['action' => 'edit', $vocationalTrainingInstitution->id]),
                        'showModal' => true
                    ]) ?>
                </div>
                <?php endif; ?>
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($vocationalTrainingInstitution->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Is Special Skill Support Institution') ?></th>
                            <td class="github-detail-value">
                                <span class="github-badge <?= $vocationalTrainingInstitution->is_special_skill_support_institution ? 'badge-success' : 'badge-secondary' ?>">
                                    <?= $vocationalTrainingInstitution->is_special_skill_support_institution ? __('Yes') : __('No'); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Abbreviation') ?></th>
                            <td class="github-detail-value"><?= h($vocationalTrainingInstitution->abbreviation) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Name') ?></th>
                            <td class="github-detail-value"><?= h($vocationalTrainingInstitution->name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Propinsi Id') ?></th>
                            <td class="github-detail-value">
                                <?= $vocationalTrainingInstitution->has('master_propinsi') ? $this->Html->link($vocationalTrainingInstitution->master_propinsi->title, ['controller' => 'MasterPropinsis', 'action' => 'view', $vocationalTrainingInstitution->master_propinsi->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Kabupaten Id') ?></th>
                            <td class="github-detail-value">
                                <?= $vocationalTrainingInstitution->has('master_kabupaten') ? $this->Html->link($vocationalTrainingInstitution->master_kabupaten->title, ['controller' => 'MasterKabupatens', 'action' => 'view', $vocationalTrainingInstitution->master_kabupaten->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Kecamatan Id') ?></th>
                            <td class="github-detail-value">
                                <?= $vocationalTrainingInstitution->has('master_kecamatan') ? $this->Html->link($vocationalTrainingInstitution->master_kecamatan->title, ['controller' => 'MasterKecamatans', 'action' => 'view', $vocationalTrainingInstitution->master_kecamatan->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Kelurahan Id') ?></th>
                            <td class="github-detail-value">
                                <?= $vocationalTrainingInstitution->has('master_kelurahan') ? $this->Html->link($vocationalTrainingInstitution->master_kelurahan->title, ['controller' => 'MasterKelurahans', 'action' => 'view', $vocationalTrainingInstitution->master_kelurahan->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Address') ?></th>
                            <td class="github-detail-value"><?= h($vocationalTrainingInstitution->address) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Post Code') ?></th>
                            <td class="github-detail-value"><?= h($vocationalTrainingInstitution->post_code) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Director') ?></th>
                            <td class="github-detail-value"><?= h($vocationalTrainingInstitution->director) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Director Katakana') ?></th>
                            <td class="github-detail-value"><?= h($vocationalTrainingInstitution->director_katakana) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Mou File') ?></th>
                            <td class="github-detail-value">
...
if (typeof window.initializeTabSwitching === 'undefined') {
    window.initializeTabSwitching = function(container) {
        ...
        if (tabLinks.length === 0 || tabPanes.length === 0) {
            console.error('ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚ÂÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ No tabs found! TabLinks:', tabLinks.length, 'TabPanes:', tabPanes.length);
        ...
        console.log('ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¦ SUCCESS: Initializing', tabLinks.length, 'tab links and', tabPanes.length, 'tab panes');
        console.log('ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â°ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¸ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã¢â‚¬Å“ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â Container:', isDocument ? 'document (full page)' : 'element (modal/container)');
        ...
        freshTabLinks.forEach(link => {
            link.addEventListener('click', function(e) {
                ...
                console.log('ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â°ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¸ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â±ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¸ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â  Tab clicked:', this.getAttribute('data-tab'));
                
                // Get target tab
                const targetTab = this.getAttribute('data-tab');
                
                if (!targetTab) {
                    console.error('ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚ÂÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ No data-tab attribute found on clicked element');
                    return;
                ...
                if (targetPane) {
                    ...
                    console.log('ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¦ Activated pane:', targetTab);
                } else {
                    console.error('ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚ÂÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ Target pane not found:', targetTab);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (dropdownButton && dropdownMenu) {
        ...
        console.log('ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¦ Dropdown menu initialized on view page');
});
</script>
    ...
    <div class="related-section mt-4">
        ...
        <ul class="nav nav-tabs" id="relatedTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="vocationaltraininginstitutionstories-tab" data-bs-toggle="tab" 
                        data-bs-target="#vocationaltraininginstitutionstories-pane" type="button" role="tab" 
                        aria-controls="vocationaltraininginstitutionstories-pane" aria-selected="true">
                    <?= __('VocationalTrainingInstitutionStories') ?>
                </button>
            </li>
        </ul>
