 ...
 *
 * The content lives in config/page_guides/VocationalTrainingInstitutions.php; Element/page_guide.ctp
 ...
 */
echo $this->element('page_guide', ['module' => 'VocationalTrainingInstitutions']);
