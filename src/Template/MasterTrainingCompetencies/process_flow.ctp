<?php
/**
 * Process Flow Documentation - Master Training Competencies
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Master Training Competencies</strong> adalah modul untuk mengelola data terkait Master Training Competencies dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Master Training Competencies</strong> is a module for managing Master Training Competencies data in the TMM system.
        <?php else: ?>
            <strong>Master Training Competencies</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Master Training Competencies ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">mastertrainingcompetencies</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Master Training Competencies
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Master Training Competencies data form
                    <?php else: ?>
                        Master Training Competencies ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Master Training Competencies -->
