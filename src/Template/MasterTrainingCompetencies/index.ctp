 ...
 * @var \App\Model\Entity\MasterTrainingCompetency[]|\Cake\Collection\CollectionInterface $masterTrainingCompetencies
 */
?>
<div class="index-header" style="margin-bottom: 20px;">
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <h2 style="margin: 0;"><?= __('Master Training Competencies') ?></h2>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; -webkit-overflow-scrolling: touch;">
    <div class="masterTrainingCompetencies index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                <?php foreach ($masterTrainingCompetencies as $row): ?>
