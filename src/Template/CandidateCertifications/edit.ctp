 ...
 * @var \App\Model\Entity\App\Model\Entity\CandidateCertification|null $candidateCertification */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Candidate Certifications'), ['action' => 'index'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="candidateCertifications form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Candidate Certification') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($candidateCertification, ['data-confirm' => 'true', 'id' => 'candidateCertificationForm']) ?>
            <?php if (!empty($candidateCertification->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Candidate Certification Information') ?></legend>
                <div class="row">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Candidate Certification'), [
