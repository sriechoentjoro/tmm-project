            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Candidate Certification') ?>: <?= h($candidateCertification->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $candidateCertification->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($candidateCertification->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Candidate Id') ?></th>
                            <td class="github-detail-value">
                                <?= $candidateCertification->has('candidate') ? $this->Html->link($candidateCertification->candidate->name, ['controller' => 'Candidates', 'action' => 'view', $candidateCertification->candidate->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($candidateCertification->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Institution Name') ?></th>
                            <td class="github-detail-value"><?= h($candidateCertification->institution_name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Detail') ?></th>
                            <td class="github-detail-value"><?= h($candidateCertification->detail) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Certification Date') ?></th>
                            <td class="github-detail-value"><?= h($candidateCertification->certification_date) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
