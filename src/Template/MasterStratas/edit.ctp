 ...
 * @var \App\Model\Entity\App\Model\Entity\MasterStrata|null $masterStrata */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Master Stratas'), ['action' => 'index'], ['escape' => false]) ?></li>
    </ul>
</nav>

<!-- Main Content -->
<div class="masterStratas form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Master Strata') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($masterStrata, ['data-confirm' => 'true', 'id' => 'masterStrataForm']) ?>
            <?php if (!empty($masterStrata->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Master Strata Information') ?></legend>
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Title Hiragana') ?></label>
                        <?= $this->Form->control('title_hiragana', [
                            'class' => 'form-control hiragana-input',
                            'placeholder' => __('Enter Title Hiragana (Hiragana)'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Master Strata'), [
