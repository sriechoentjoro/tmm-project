            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Master Strata') ?>: <?= h($masterStrata->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $masterStrata->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($masterStrata->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Slug') ?></th>
                            <td class="github-detail-value"><?= h($masterStrata->slug) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($masterStrata->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title Hiragana') ?></th>
                            <td class="github-detail-value"><?= h($masterStrata->title_hiragana) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
