 ...
 * @var \App\Model\Entity\App\Model\Entity\CandidateRecordMedicalCheckUp|null $candidateRecordMedicalCheckUp */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Candidate Record Medical Check Ups'), ['action' => 'index'], ['escape' => false]) ?></li>
    </ul>
</nav>

<!-- Main Content -->
<div class="candidateRecordMedicalCheckUps form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Candidate Record Medical Check Up') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($candidateRecordMedicalCheckUp, ['type' => 'file', 'data-confirm' => 'true', 'id' => 'candidateRecordMedicalCheckUpForm']) ?>
            <?php if (!empty($candidateRecordMedicalCheckUp->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Candidate Record Medical Check Up Information') ?></legend>
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Medical Check Up Result Id') ?></label>
                        <?= $this->Form->control('medical_check_up_result_id', [
                            'class' => 'form-control',
                            'placeholder' => __('Enter Medical Check Up Result Id'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <?php if (!empty($candidateRecordMedicalCheckUp->mcu_files)): ?>
                            <div class="mt-2">
                                <a href="<?= $this->Url->build('/' . $candidateRecordMedicalCheckUp->mcu_files, ['fullBase' => true]) ?>" 
                                   target="_blank" 
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Candidate Record Medical Check Up'), [
