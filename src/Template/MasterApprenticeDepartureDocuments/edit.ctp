 ...
 * @var \App\Model\Entity\App\Model\Entity\MasterApprenticeDepartureDocument|null $masterApprenticeDepartureDocument */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Master Apprentice Departure Documents'), ['action' => 'index'], ['escape' => false]) ?></li>
    </ul>
</nav>

<!-- Main Content -->
<div class="masterApprenticeDepartureDocuments form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Master Apprentice Departure Document') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($masterApprenticeDepartureDocument, ['data-confirm' => 'true', 'id' => 'masterApprenticeDepartureDocumentForm']) ?>
            <?php if (!empty($masterApprenticeDepartureDocument->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Master Apprentice Departure Document Information') ?></legend>
                <div class="row">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Master Apprentice Departure Document'), [
