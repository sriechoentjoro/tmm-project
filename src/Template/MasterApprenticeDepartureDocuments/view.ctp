            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Master Apprentice Departure Document') ?>: <?= h($masterApprenticeDepartureDocument->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $masterApprenticeDepartureDocument->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($masterApprenticeDepartureDocument->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($masterApprenticeDepartureDocument->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Format') ?></th>
                            <td class="github-detail-value"><?= h($masterApprenticeDepartureDocument->format) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Is Required') ?></th>
                            <td class="github-detail-value">
                                <span class="github-badge <?= $masterApprenticeDepartureDocument->is_required ? 'badge-success' : 'badge-secondary' ?>">
                                    <?= $masterApprenticeDepartureDocument->is_required ? __('Yes') : __('No'); ?>
                                </span>
                            </td>
                        </tr>
                    </tbody>
