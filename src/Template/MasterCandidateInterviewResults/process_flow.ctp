<?php
/**
 * Process Flow Documentation - Master Candidate Interview Results
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Master Candidate Interview Results</strong> adalah modul untuk mengelola data terkait Master Candidate Interview Results dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Master Candidate Interview Results</strong> is a module for managing Master Candidate Interview Results data in the TMM system.
        <?php else: ?>
            <strong>Master Candidate Interview Results</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Master Candidate Interview Results ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">mastercandidateinterviewresults</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Master Candidate Interview Results
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Master Candidate Interview Results data form
                    <?php else: ?>
                        Master Candidate Interview Results ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Master Candidate Interview Results -->
