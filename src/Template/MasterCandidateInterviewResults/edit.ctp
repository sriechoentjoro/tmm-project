 ...
 * @var \App\Model\Entity\App\Model\Entity\MasterCandidateInterviewResult|null $masterCandidateInterviewResult */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Master Candidate Interview Results'), ['action' => 'index'], ['escape' => false]) ?></li>
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List CandidateRecordInterviews'), ['controller' => 'CandidateRecordInterviews', 'action' => 'index'], ['escape' => false]) ?></li>
        <li><?= $this->Html->link('<i class="fas fa-plus"></i> ' . __('New CandidateRecordInterview'), ['controller' => 'CandidateRecordInterviews', 'action' => 'add'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="masterCandidateInterviewResults form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Master Candidate Interview Result') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($masterCandidateInterviewResult, ['data-confirm' => 'true', 'id' => 'masterCandidateInterviewResultForm']) ?>
            <?php if (!empty($masterCandidateInterviewResult->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Master Candidate Interview Result Information') ?></legend>
                <div class="row">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Master Candidate Interview Result'), [
