                            ...
                            <table class="table table-striped table-hover github-related-table" data-ajax-filter="true">
                                <thead style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.15) 0%, rgba(118, 75, 162, 0.15) 100%);">
                                    ...
                                    <tr class="filter-row" style="background-color: #f8f9fa;">
                                        ...
                                        <th style="padding: 4px;">
                                            <div style="display: flex; gap: 3px;">
                                                <select class="form-control form-control-sm filter-operator" 
                                                        data-column="apprentice_order_id" 
                                                        style="width: 70px; padding: 2px 4px; font-size: 11px;">
                                                    <option value="contains"><?= __('Contains') ?></option>
                                                    <option value="equals"><?= __('Equals') ?></option>
                                                    <option value="starts"><?= __('Starts') ?></option>
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row-with-actions">
                                        ...
                                        <td>
                                            <?php if ($candidates->has('apprentice_order')): ?>
                                                <?php
                                            ...
                                            <?php else: ?>
                                                <?= h($candidates->apprentice_order_id) ?>
                                            <?php endif; ?>
                                        </td>
    ...
    <div class="related-section mt-4">
        ...
        <ul class="nav nav-tabs" id="relatedTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="candidaterecordinterviews-tab" data-bs-toggle="tab" 
                        data-bs-target="#candidaterecordinterviews-pane" type="button" role="tab" 
                        aria-controls="candidaterecordinterviews-pane" aria-selected="true">
                    <?= __('CandidateRecordInterviews') ?>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link " id="candidates-tab" data-bs-toggle="tab" 
                        data-bs-target="#candidates-pane" type="button" role="tab" 
                        aria-controls="candidates-pane" aria-selected="false">
                    <?= __('Candidates') ?>
                </button>
            </li>
        </ul>
