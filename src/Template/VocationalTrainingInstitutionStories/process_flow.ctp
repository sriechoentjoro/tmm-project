<?php
/**
 * Process Flow Documentation - Vocational Training Institution Stories
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Vocational Training Institution Stories</strong> adalah modul untuk mengelola data terkait Vocational Training Institution Stories dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Vocational Training Institution Stories</strong> is a module for managing Vocational Training Institution Stories data in the TMM system.
        <?php else: ?>
            <strong>Vocational Training Institution Stories</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Vocational Training Institution Stories ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">vocationaltraininginstitutionstories</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Vocational Training Institution Stories
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Vocational Training Institution Stories data form
                    <?php else: ?>
                        Vocational Training Institution Stories ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Vocational Training Institution Stories -->
