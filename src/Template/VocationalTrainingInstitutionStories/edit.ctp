 ...
 * @var \App\Model\Entity\App\Model\Entity\VocationalTrainingInstitutionStory|null $vocationalTrainingInstitutionStory */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Vocational Training Institution Stories'), ['action' => 'index'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="vocationalTrainingInstitutionStories form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Vocational Training Institution Story') ?>
            </h3>
        </div>
        ...
        <div class="card-body">
            ...
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Vocational Training Institution Story Information') ?></legend>
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Date Occurrence') ?></label>
                        <?= $this->Form->control('date_occurrence', [
                            'type' => 'text',
                            'class' => 'form-control datepicker',
                            'placeholder' => __('Select Date Occurrence'),
                            'label' => false,
                            'autocomplete' => 'off'
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Problem Contents') ?></label>
                        <?= $this->Form->control('problem_contents', [
                            'type' => 'textarea',
                            'class' => 'form-control',
                            'rows' => 3,
                            'placeholder' => __('Enter Problem Contents'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Problem Classification') ?></label>
                        <?= $this->Form->control('problem_classification', [
                            'class' => 'form-control',
                            'placeholder' => __('Enter Problem Classification'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Problem Solution') ?></label>
                        <?= $this->Form->control('problem_solution', [
                            'class' => 'form-control',
                            'placeholder' => __('Enter Problem Solution'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Problem Inference') ?></label>
                        <?= $this->Form->control('problem_inference', [
                            'class' => 'form-control',
                            'placeholder' => __('Enter Problem Inference'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                        ...
                        <?php if (!empty($vocationalTrainingInstitutionStory->image_path)): ?>
                            <div class="mt-2">
                                <img src="<?= $this->Url->build('/' . $vocationalTrainingInstitutionStory->image_path, ['fullBase' => true]) ?>" 
                                     alt="Current Image Path" 
                                     class="img-thumbnail" 
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Vocational Training Institution Story'), [
