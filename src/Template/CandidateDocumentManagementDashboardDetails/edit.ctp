 ...
 * @var \App\Model\Entity\App\Model\Entity\CandidateDocumentManagementDashboardDetail|null $candidateDocumentManagementDashboardDetail */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Candidate Document Management Dashboard Details'), ['action' => 'index'], ['escape' => false]) ?></li>
    </ul>
</nav>

<!-- Main Content -->
<div class="candidateDocumentManagementDashboardDetails form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Candidate Document Management Dashboard Detail') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($candidateDocumentManagementDashboardDetail, ['data-confirm' => 'true', 'id' => 'candidateDocumentManagementDashboardDetailForm']) ?>
            <?php if (!empty($candidateDocumentManagementDashboardDetail->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Candidate Document Management Dashboard Detail Information') ?></legend>
                <div class="row">
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Dashboard Id') ?></label>
                        <?= $this->Form->control('dashboard_id', [
                            'class' => 'form-control',
                            'placeholder' => __('Enter Dashboard Id'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <?= $this->Form->control('updated_at', [
                            ...
                            'placeholder' => __('Select Updated At'),
                            'label' => false,
                            'autocomplete' => 'off'
                        ]) ?>
                    </div>
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Candidate Document Management Dashboard Detail'), [
