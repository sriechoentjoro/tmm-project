            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Trainee Training Batch') ?>: <?= h($traineeTrainingBatch->id) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $traineeTrainingBatch->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($traineeTrainingBatch->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Training Term Of Months') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($traineeTrainingBatch->training_term_of_months) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Batch Name') ?></th>
                            <td class="github-detail-value"><?= h($traineeTrainingBatch->batch_name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Origin Training Location') ?></th>
                            <td class="github-detail-value"><?= h($traineeTrainingBatch->origin_training_location) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Moved Training Location') ?></th>
                            <td class="github-detail-value"><?= h($traineeTrainingBatch->moved_training_location) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Departure Plan Date') ?></th>
                            <td class="github-detail-value"><?= h($traineeTrainingBatch->departure_plan_date) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Origin Start Plan Date') ?></th>
                            <td class="github-detail-value"><?= h($traineeTrainingBatch->origin_start_plan_date) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Origin Finish Plan Date') ?></th>
                            <td class="github-detail-value"><?= h($traineeTrainingBatch->origin_finish_plan_date) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Moved Start Plan Date') ?></th>
                            <td class="github-detail-value"><?= h($traineeTrainingBatch->moved_start_plan_date) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Moved Finished Plan Date') ?></th>
                            <td class="github-detail-value"><?= h($traineeTrainingBatch->moved_finished_plan_date) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Is Training Location Moved') ?></th>
                            <td class="github-detail-value">
                                <span class="github-badge <?= $traineeTrainingBatch->is_training_location_moved ? 'badge-success' : 'badge-secondary' ?>">
                                    <?= $traineeTrainingBatch->is_training_location_moved ? __('Yes') : __('No'); ?>
                                </span>
                            </td>
                        </tr>
                    </tbody>
