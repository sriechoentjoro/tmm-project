<?php
/**
 * Process Flow Documentation - Master Transaction Categories
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Master Transaction Categories</strong> adalah modul untuk mengelola data terkait Master Transaction Categories dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Master Transaction Categories</strong> is a module for managing Master Transaction Categories data in the TMM system.
        <?php else: ?>
            <strong>Master Transaction Categories</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Master Transaction Categories ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">mastertransactioncategories</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Master Transaction Categories
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Master Transaction Categories data form
                    <?php else: ?>
                        Master Transaction Categories ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Master Transaction Categories -->
