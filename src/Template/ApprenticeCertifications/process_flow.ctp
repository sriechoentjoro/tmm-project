<?php
/**
 * Process Flow Documentation - Apprentice Certifications
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Apprentice Certifications</strong> adalah modul untuk mengelola data terkait Apprentice Certifications dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Apprentice Certifications</strong> is a module for managing Apprentice Certifications data in the TMM system.
        <?php else: ?>
            <strong>Apprentice Certifications</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Apprentice Certifications ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">apprenticecertifications</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Apprentice Certifications
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Apprentice Certifications data form
                    <?php else: ?>
                        Apprentice Certifications ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Apprentice Certifications -->
