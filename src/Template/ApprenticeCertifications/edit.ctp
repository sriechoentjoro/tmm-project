 ...
 * @var \App\Model\Entity\App\Model\Entity\ApprenticeCertification|null $apprenticeCertification */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Apprentice Certifications'), ['action' => 'index'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="apprenticeCertifications form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Apprentice Certification') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($apprenticeCertification, ['data-confirm' => 'true', 'id' => 'apprenticeCertificationForm']) ?>
            <?php if (!empty($apprenticeCertification->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Apprentice Certification Information') ?></legend>
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Institution Name') ?></label>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <?= $this->Form->control('certification_date', [
                            'type' => 'text',
                            'class' => 'form-control datepicker',
                            'placeholder' => __('Select Certification Date'),
                            'label' => false,
                            'autocomplete' => 'off'
                        ]) ?>
                    </div>
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Apprentice Certification'), [
