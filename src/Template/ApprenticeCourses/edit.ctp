 ...
 * @var \App\Model\Entity\App\Model\Entity\ApprenticeCourse|null $apprenticeCourse */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Apprentice Courses'), ['action' => 'index'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="apprenticeCourses form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Apprentice Course') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($apprenticeCourse, ['data-confirm' => 'true', 'id' => 'apprenticeCourseForm']) ?>
            <?php if (!empty($apprenticeCourse->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Apprentice Course Information') ?></legend>
                <div class="row">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Apprentice Course'), [
