            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Cooperative Association') ?>: <?= h($cooperativeAssociation->name) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $cooperativeAssociation->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
    ...
    <div class="view-tabs-container">
        ...
        <div class="view-tabs-content">
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($cooperativeAssociation->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Name') ?></th>
                            <td class="github-detail-value"><?= h($cooperativeAssociation->name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Address') ?></th>
                            <td class="github-detail-value"><?= h($cooperativeAssociation->address) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Telephone') ?></th>
                            <td class="github-detail-value"><?= h($cooperativeAssociation->telephone) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Date Permitted') ?></th>
                            <td class="github-detail-value"><?= h($cooperativeAssociation->date_permitted) ?></td>
                        </tr>
                        <tr>
            ...
            <div id="tab-stories" class="view-tab-pane">
                <div id="cooperativeassociationstories-pane">
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= __('Cooperative Association Stories') ?>
                        </h3>
                    </div>
                    <div class="github-details-body">
