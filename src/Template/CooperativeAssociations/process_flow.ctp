<?php
/**
 * Process Flow Documentation - Cooperative Associations
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Cooperative Associations</strong> adalah modul untuk mengelola data terkait Cooperative Associations dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Cooperative Associations</strong> is a module for managing Cooperative Associations data in the TMM system.
        <?php else: ?>
            <strong>Cooperative Associations</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Cooperative Associations ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">cooperativeassociations</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Cooperative Associations
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Cooperative Associations data form
                    <?php else: ?>
                        Cooperative Associations ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Cooperative Associations -->
