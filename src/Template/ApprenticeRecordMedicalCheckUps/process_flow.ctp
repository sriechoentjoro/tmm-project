<?php
/**
 * Process Flow Documentation - Apprentice Record Medical Check Ups
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Apprentice Record Medical Check Ups</strong> adalah modul untuk mengelola data terkait Apprentice Record Medical Check Ups dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Apprentice Record Medical Check Ups</strong> is a module for managing Apprentice Record Medical Check Ups data in the TMM system.
        <?php else: ?>
            <strong>Apprentice Record Medical Check Ups</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Apprentice Record Medical Check Ups ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">apprenticerecordmedicalcheckups</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Apprentice Record Medical Check Ups
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Apprentice Record Medical Check Ups data form
                    <?php else: ?>
                        Apprentice Record Medical Check Ups ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Apprentice Record Medical Check Ups -->
