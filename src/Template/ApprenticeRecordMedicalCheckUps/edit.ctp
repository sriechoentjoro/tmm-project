 ...
 * @var \App\Model\Entity\App\Model\Entity\ApprenticeRecordMedicalCheckUp|null $apprenticeRecordMedicalCheckUp */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Apprentice Record Medical Check Ups'), ['action' => 'index'], ['escape' => false]) ?></li>
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List MasterMedicalCheckUpResults'), ['controller' => 'MasterMedicalCheckUpResults', 'action' => 'index'], ['escape' => false]) ?></li>
        <li><?= $this->Html->link('<i class="fas fa-plus"></i> ' . __('New MasterMedicalCheckUpResult'), ['controller' => 'MasterMedicalCheckUpResults', 'action' => 'add'], ['escape' => false]) ?></li>
    </ul>
</nav>

<!-- Main Content -->
<div class="apprenticeRecordMedicalCheckUps form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Apprentice Record Medical Check Up') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($apprenticeRecordMedicalCheckUp, ['type' => 'file', 'data-confirm' => 'true', 'id' => 'apprenticeRecordMedicalCheckUpForm']) ?>
            <?php if (!empty($apprenticeRecordMedicalCheckUp->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Apprentice Record Medical Check Up Information') ?></legend>
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Date Issued') ?></label>
                        <?= $this->Form->control('date_issued', [
                            'type' => 'text',
                            'class' => 'form-control datepicker',
                            'placeholder' => __('Select Date Issued'),
                            'label' => false,
                            'autocomplete' => 'off'
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Master Medical Check Up Result Id') ?></label>
                        <?= $this->Form->control('master_medical_check_up_result_id', [
                            'options' => $masterMedicalCheckUpResults,
                            'class' => 'form-control',
                            'label' => false,
                            'empty' => __('-- Select Master Medical Check Up Result Id --')
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <?= $this->Form->control('clinic', [
                            'class' => 'form-control',
                            'placeholder' => __('Enter Clinic'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Mcu Files') ?></label>
                        <?= $this->Form->control('mcu_files', [
                            'type' => 'file',
                            'class' => 'form-control',
                            'label' => false,
                        ...
                        <?php if (!empty($apprenticeRecordMedicalCheckUp->mcu_files)): ?>
                            <div class="mt-2">
                                <a href="<?= $this->Url->build('/' . $apprenticeRecordMedicalCheckUp->mcu_files, ['fullBase' => true]) ?>" 
                                   target="_blank" 
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Apprentice Record Medical Check Up'), [
