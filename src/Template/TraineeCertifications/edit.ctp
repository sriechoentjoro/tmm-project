 ...
 * @var \App\Model\Entity\App\Model\Entity\TraineeCertification|null $traineeCertification */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Trainee Certifications'), ['action' => 'index'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="traineeCertifications form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Trainee Certification') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($traineeCertification, ['data-confirm' => 'true', 'id' => 'traineeCertificationForm']) ?>
            <?php if (!empty($traineeCertification->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Trainee Certification Information') ?></legend>
                <div class="row">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Trainee Certification'), [
