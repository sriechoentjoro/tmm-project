<?php
/**
 * Process Flow Documentation - Trainee Certifications
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Trainee Certifications</strong> adalah modul untuk mengelola data terkait Trainee Certifications dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Trainee Certifications</strong> is a module for managing Trainee Certifications data in the TMM system.
        <?php else: ?>
            <strong>Trainee Certifications</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Trainee Certifications ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">traineecertifications</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Trainee Certifications
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Trainee Certifications data form
                    <?php else: ?>
                        Trainee Certifications ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Trainee Certifications -->
