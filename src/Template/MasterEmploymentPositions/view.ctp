            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Master Employment Position') ?>: <?= h($masterEmploymentPosition->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $masterEmploymentPosition->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($masterEmploymentPosition->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Cost Per Hour') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($masterEmploymentPosition->cost_per_hour) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($masterEmploymentPosition->title) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
