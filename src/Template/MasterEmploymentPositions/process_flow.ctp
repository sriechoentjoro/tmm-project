<?php
/**
 * Process Flow Documentation - Master Employment Positions
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Master Employment Positions</strong> adalah modul untuk mengelola data terkait Master Employment Positions dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Master Employment Positions</strong> is a module for managing Master Employment Positions data in the TMM system.
        <?php else: ?>
            <strong>Master Employment Positions</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Master Employment Positions ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">masteremploymentpositions</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Master Employment Positions
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Master Employment Positions data form
                    <?php else: ?>
                        Master Employment Positions ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Master Employment Positions -->
