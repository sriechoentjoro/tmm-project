<?php
/**
 * Process Flow Documentation - Apprentice Record Coe Visas
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Apprentice Record Coe Visas</strong> adalah modul untuk mengelola data terkait Apprentice Record Coe Visas dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Apprentice Record Coe Visas</strong> is a module for managing Apprentice Record Coe Visas data in the TMM system.
        <?php else: ?>
            <strong>Apprentice Record Coe Visas</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Apprentice Record Coe Visas ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">apprenticerecordcoevisas</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Apprentice Record Coe Visas
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Apprentice Record Coe Visas data form
                    <?php else: ?>
                        Apprentice Record Coe Visas ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Apprentice Record Coe Visas -->
