 ...
 * @var \App\Model\Entity\App\Model\Entity\CandidateCourse|null $candidateCourse */
...
<nav class="actions-sidebar" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link('<i class="fas fa-list"></i> ' . __('List Candidate Courses'), ['action' => 'index'], ['escape' => false]) ?></li>
...
<!-- Main Content -->
<div class="candidateCourses form content">
    <div class="card">
        <div class="content-header">
            <h3 class="content-title">
                <i class="fas fa-edit"></i>
                <?= __(Inflector::humanize($this->request->getParam("action")) . ' Candidate Course') ?>
            </h3>
        </div>

        <div class="card-body">
            <?= $this->Form->create($candidateCourse, ['data-confirm' => 'true', 'id' => 'candidateCourseForm']) ?>
            <?php if (!empty($candidateCourse->id)): ?>
                <?= $this->Form->hidden('id') ?>
            <?php endif; ?>
            <fieldset>
                <legend><?= __('Enter Candidate Course Information') ?></legend>
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <?= $this->Form->control('vocational_training_institution_id', [
                            'class' => 'form-control',
                            'placeholder' => __('Enter Vocational Training Institution Id'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= __('Master Course Major Id') ?></label>
                        <?= $this->Form->control('master_course_major_id', [
                            'class' => 'form-control',
                            'placeholder' => __('Enter Master Course Major Id'),
                            'label' => false
                        ]) ?>
                    </div>
                    <div class="col-12 mb-3">
            ...
            <div class="form-actions mt-4">
                <?= $this->Form->button(__('Save Candidate Course'), [
