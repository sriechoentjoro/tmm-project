            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Candidate Course') ?>: <?= h($candidateCourse->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $candidateCourse->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($candidateCourse->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Vocational Training Institution Id') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($candidateCourse->vocational_training_institution_id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Course Major Id') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($candidateCourse->master_course_major_id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Course Year') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($candidateCourse->course_year) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Candidate Id') ?></th>
                            <td class="github-detail-value">
                                <?= $candidateCourse->has('candidate') ? $this->Html->link($candidateCourse->candidate->name, ['controller' => 'Candidates', 'action' => 'view', $candidateCourse->candidate->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($candidateCourse->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Detail') ?></th>
                            <td class="github-detail-value"><?= h($candidateCourse->detail) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
