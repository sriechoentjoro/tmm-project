...
<div class="github-container">
    ...
    <div class="view-tabs-container">
        <ul class="view-tabs-nav" role="tablist">
            ...
            <li class="view-tab-item">
                <a href="#tab-master_candidate_interview_results" class="view-tab-link" data-tab="tab-master_candidate_interview_results">
                    <svg class="tab-icon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                        <path d="M10.5 5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0zm.061 3.073a4 4 0 1 0-5.123 0 6.004 6.004 0 0 0-3.431 5.142.75.75 0 0 0 1.498.07 4.5 4.5 0 0 1 8.99 0 .75.75 0 1 0 1.498-.07 6.005 6.005 0 0 0-3.432-5.142z"></path>
                    </svg>
                    <?= __('MasterCandidateInterviewResults') ?>
                </a>
            </li>
            <li class="view-tab-item">
        ...
        <div class="view-tabs-content">
            ...
            <div id="tab-home" class="view-tab-pane active">
                ...
                <div class="media-preview-section" style="margin-bottom: 24px;">
                    ...
                    <div class="image-preview-container" style="text-align: center; margin-bottom: 20px; background: #f6f8fa; padding: 20px; border-radius: 8px; border: 1px solid #d0d7de;">
                        ...
                        <div style="max-width: 800px; margin: 0 auto;">
                            <img src="<?= $this->Url->build('/' . h($candidate->image_photo)) ?>" 
                                 alt="<?= __('Image Photo') ?>"
                        ...
                        <div style="margin-top: 15px;">
                            <a href="<?= $this->Url->build('/' . h($candidate->image_photo)) ?>" 
                               download 
                               class="btn-export-light"
                ...
                <table class="github-details-table">
                    <tbody>
                        ...
                        <tr>
                            <th class="github-detail-label"><?= __('Apprentice Order Id') ?></th>
                            <td class="github-detail-value">
                                <?= $candidate->has('apprentice_order') ? $this->Html->link($candidate->apprentice_order->title, ['controller' => 'ApprenticeOrders', 'action' => 'view', $candidate->apprentice_order->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="github-detail-value">
                                <?= $candidate->has('vocational_training_institution') ? $this->Html->link($candidate->vocational_training_institution->name, ['controller' => 'VocationalTrainingInstitutions', 'action' => 'view', $candidate->vocational_training_institution->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Acceptance Organization Id') ?></th>
                            <td class="github-detail-value">
                                <?= $candidate->has('acceptance_organization') ? $this->Html->link($candidate->acceptance_organization->title, ['controller' => 'AcceptanceOrganizations', 'action' => 'view', $candidate->acceptance_organization->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="github-detail-value">
                                <?= $candidate->has('master_kecamatan') ? $this->Html->link($candidate->master_kecamatan->title, ['controller' => 'MasterKecamatans', 'action' => 'view', $candidate->master_kecamatan->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Kelurahan Id') ?></th>
                            <td class="github-detail-value">
                                <?= $candidate->has('master_kelurahan') ? $this->Html->link($candidate->master_kelurahan->title, ['controller' => 'MasterKelurahans', 'action' => 'view', $candidate->master_kelurahan->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            ...
                            <?= $this->Html->link(
                                ...
                                ['controller' => 'ApprenticeOrders', 'action' => 'view', $candidate->apprentice_order->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'ApprenticeOrders', 'action' => 'edit', $candidate->apprentice_order->id],
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->apprentice_order->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Reference File') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->apprentice_order->reference_file) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Cooperative Association Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->apprentice_order->cooperative_association_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Acceptance Organization Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->apprentice_order->acceptance_organization_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->apprentice_order->title) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Male Trainee Number') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->apprentice_order->male_trainee_number) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Female Trainee Number') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->apprentice_order->female_trainee_number) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Master Job Category Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->apprentice_order->master_job_category_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Departure Year') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->apprentice_order->departure_year) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Departure Month') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->apprentice_order->departure_month) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="tab-vocational_training_institutions" class="view-tab-pane">
                <?php if ($candidate->has('vocational_training_institution')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'VocationalTrainingInstitutions', 'action' => 'view', $candidate->vocational_training_institution->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'VocationalTrainingInstitutions', 'action' => 'edit', $candidate->vocational_training_institution->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->vocational_training_institution->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Is Special Skill Support Institution') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->vocational_training_institution->is_special_skill_support_institution) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Abbreviation') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->vocational_training_institution->abbreviation) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Name') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->vocational_training_institution->name) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Master Propinsi Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->vocational_training_institution->master_propinsi_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Master Kabupaten Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->vocational_training_institution->master_kabupaten_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Master Kecamatan Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->vocational_training_institution->master_kecamatan_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Master Kelurahan Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->vocational_training_institution->master_kelurahan_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Address') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->vocational_training_institution->address) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Post Code') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->vocational_training_institution->post_code) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="tab-acceptance_organizations" class="view-tab-pane">
                <?php if ($candidate->has('acceptance_organization')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'AcceptanceOrganizations', 'action' => 'view', $candidate->acceptance_organization->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'AcceptanceOrganizations', 'action' => 'edit', $candidate->acceptance_organization->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->acceptance_organization->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->acceptance_organization->title) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Master Japan Prefecture Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->acceptance_organization->master_japan_prefecture_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Post Code') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->acceptance_organization->post_code) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Address') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->acceptance_organization->address) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Director') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->acceptance_organization->director) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Director Hiragana') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->acceptance_organization->director_hiragana) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="tab-master_genders" class="view-tab-pane">
                <?php if ($candidate->has('master_gender')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'MasterGenders', 'action' => 'view', $candidate->master_gender->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'MasterGenders', 'action' => 'edit', $candidate->master_gender->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_gender->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_gender->title) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title Jpg') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_gender->title_jpg) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="tab-master_religions" class="view-tab-pane">
                <?php if ($candidate->has('master_religion')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'MasterReligions', 'action' => 'view', $candidate->master_religion->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'MasterReligions', 'action' => 'edit', $candidate->master_religion->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_religion->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Slug') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_religion->slug) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_religion->title) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title Jpg') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_religion->title_jpg) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="tab-master_marriage_statuses" class="view-tab-pane">
                <?php if ($candidate->has('master_marriage_status')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'MasterMarriageStatuses', 'action' => 'view', $candidate->master_marriage_status->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'MasterMarriageStatuses', 'action' => 'edit', $candidate->master_marriage_status->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_marriage_status->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Slug') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_marriage_status->slug) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_marriage_status->title) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title Jpg') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_marriage_status->title_jpg) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="tab-master_propinsis" class="view-tab-pane">
                <?php if ($candidate->has('master_propinsi')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'MasterPropinsis', 'action' => 'view', $candidate->master_propinsi->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'MasterPropinsis', 'action' => 'edit', $candidate->master_propinsi->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_propinsi->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Propinsi') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_propinsi->kode_propinsi) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_propinsi->title) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="tab-master_kabupatens" class="view-tab-pane">
                <?php if ($candidate->has('master_kabupaten')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'MasterKabupatens', 'action' => 'view', $candidate->master_kabupaten->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'MasterKabupatens', 'action' => 'edit', $candidate->master_kabupaten->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kabupaten->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Propinsi Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kabupaten->propinsi_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Propinsi') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kabupaten->kode_propinsi) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Kabupaten') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kabupaten->kode_kabupaten) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kabupaten->title) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'MasterKecamatans', 'action' => 'edit', $candidate->master_kecamatan->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kecamatan->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Propinsi Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kecamatan->propinsi_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kabupaten Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kecamatan->kabupaten_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Propinsi') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kecamatan->kode_propinsi) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Kabupaten') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kecamatan->kode_kabupaten) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Kecamatan') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kecamatan->kode_kecamatan) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kecamatan->title) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'MasterKelurahans', 'action' => 'edit', $candidate->master_kelurahan->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kelurahan->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Propinsi Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kelurahan->propinsi_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kabupaten Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kelurahan->kabupaten_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kecamatan Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kelurahan->kecamatan_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Propinsi') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kelurahan->kode_propinsi) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Kabupaten') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kelurahan->kode_kabupaten) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Kecamatan') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kelurahan->kode_kecamatan) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Kelurahan') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kelurahan->kode_kelurahan) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Pos') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kelurahan->kode_pos) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_kelurahan->title) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="tab-master_blood_types" class="view-tab-pane">
                <?php if ($candidate->has('master_blood_type')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'MasterBloodTypes', 'action' => 'view', $candidate->master_blood_type->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'MasterBloodTypes', 'action' => 'edit', $candidate->master_blood_type->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_blood_type->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_blood_type->title) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <!-- MasterCandidateInterviewResult Tab (BelongsTo) -->
            <div id="tab-master_candidate_interview_results" class="view-tab-pane">
                <?php if ($candidate->has('master_candidate_interview_result')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= __('MasterCandidateInterviewResult Details') ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'MasterCandidateInterviewResults', 'action' => 'view', $candidate->master_candidate_interview_result->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'MasterCandidateInterviewResults', 'action' => 'edit', $candidate->master_candidate_interview_result->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_candidate_interview_result->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_candidate_interview_result->title) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="github-empty-state">
                    ...
                    <h3 class="empty-title"><?= __('No MasterCandidateInterviewResult Associated') ?></h3>
                    <p class="empty-message"><?= __('This record is not associated with any MasterCandidateInterviewResult.') ?></p>
                </div>
                <?php endif; ?>
            </div>
            <!-- MasterRejectedReason Tab (BelongsTo) -->
            <div id="tab-master_rejected_reasons" class="view-tab-pane">
                <?php if ($candidate->has('master_rejected_reason')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'MasterRejectedReasons', 'action' => 'view', $candidate->master_rejected_reason->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'MasterRejectedReasons', 'action' => 'edit', $candidate->master_rejected_reason->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_rejected_reason->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_rejected_reason->title) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title Jpg') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_rejected_reason->title_jpg) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Details') ?></th>
                                    <td class="github-detail-value"><?= h($candidate->master_rejected_reason->details) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
