        ...
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tr class="filter-row" style="background-color: #f8f9fa;">
                ...
                <td style="padding: 5px;">
                    <select class="filter-input form-control form-control-sm" data-column="apprentice_order_id" data-type="select" style="font-size: 0.85rem; padding: 4px;">
                        <option value="">All Apprentice_orders</option>
                        <?php foreach ($apprentice_orders as $id => $name): ?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 8px; white-space: nowrap;"><?= $candidate->has('apprentice_order') ? $this->Html->link($candidate->apprentice_order->title, ['controller' => 'ApprenticeOrders', 'action' => 'view', $candidate->apprentice_order->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($candidate->candidate_code) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $candidate->has('vocational_training_institution') ? $this->Html->link($candidate->vocational_training_institution->name, ['controller' => 'VocationalTrainingInstitutions', 'action' => 'view', $candidate->vocational_training_institution->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $candidate->has('acceptance_organization') ? $this->Html->link($candidate->acceptance_organization->title, ['controller' => 'AcceptanceOrganizations', 'action' => 'view', $candidate->acceptance_organization->id]) : '' ?></td>
                    ...
                    <td style="padding: 8px; white-space: nowrap;"><?= $candidate->birth_date ? $candidate->birth_date->format('Y-m-d') : '' ?></td>
