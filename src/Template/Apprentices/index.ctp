        ...
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprentice->has('apprentice_order') ? $this->Html->link($apprentice->apprentice_order->title, ['controller' => 'ApprenticeOrders', 'action' => 'view', $apprentice->apprentice_order->id]) : '' ?></td>
                    ...
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprentice->has('vocational_training_institution') ? $this->Html->link($apprentice->vocational_training_institution->name, ['controller' => 'VocationalTrainingInstitutions', 'action' => 'view', $apprentice->vocational_training_institution->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprentice->has('acceptance_organization') ? $this->Html->link($apprentice->acceptance_organization->title, ['controller' => 'AcceptanceOrganizations', 'action' => 'view', $apprentice->acceptance_organization->id]) : '' ?></td>
                    ...
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->element('file_viewer', ['filePath' => $apprentice->image_photo]) ?></td>
                    ...
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprentice->has('master_blood_type') ? $this->Html->link($apprentice->master_blood_type->title, ['controller' => 'MasterBloodTypes', 'action' => 'view', $apprentice->master_blood_type->id]) : '' ?></td>
                    ...
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprentice->master_rejected_reason_id) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
