...
<div class="github-container">
            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <?= $this->Html->link(
                            '<i class="fas fa-list"></i> ' . __('List Apprentices'),
                            ['action' => 'index'],
                            ['class' => 'dropdown-item', 'escape' => false]
                        ) ?>
                        <?= $this->Html->link(
                            '<i class="fas fa-plus"></i> ' . __('New Apprentice'),
                            ['action' => 'add'],
                            ['class' => 'dropdown-item', 'escape' => false]
                        ) ?>
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Apprentice') ?>: <?= h($apprentice->name) ?>
                    </h1>
                </div>
    ...
    <div class="view-tabs-container">
        <ul class="view-tabs-nav" role="tablist">
            ...
            <li class="view-tab-item">
                <a href="#tab-trainees" class="view-tab-link" data-tab="tab-trainees">
                    <svg class="tab-icon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                        <path d="M10.5 5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0zm.061 3.073a4 4 0 1 0-5.123 0 6.004 6.004 0 0 0-3.431 5.142.75.75 0 0 0 1.498.07 4.5 4.5 0 0 1 8.99 0 .75.75 0 1 0 1.498-.07 6.005 6.005 0 0 0-3.432-5.142z"></path>
                    </svg>
                    <?= __('Trainees') ?>
            ...
            <li class="view-tab-item">
                <a href="#tab-apprentice_certifications" class="view-tab-link" data-tab="tab-apprentice_certifications">
                    <svg class="tab-icon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                    ...
                    <?= __('ApprenticeCertifications') ?>
                    <?php if (!empty($apprentice->apprentice_certifications)): ?>
                    <span class="tab-badge"><?= count($apprentice->apprentice_certifications) ?></span>
                    <?php else: ?>
            ...
            <li class="view-tab-item">
                <a href="#tab-apprentice_courses" class="view-tab-link" data-tab="tab-apprentice_courses">
                    <svg class="tab-icon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                        <path d="M1.5 3.25a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0zM3 6.5a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5zm-.75 2.75a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0z"></path>
                    </svg>
                    <?= __('ApprenticeCourses') ?>
                    <?php if (!empty($apprentice->apprentice_courses)): ?>
                    <span class="tab-badge"><?= count($apprentice->apprentice_courses) ?></span>
                    <?php else: ?>
                    <span class="tab-badge">0</span>
                    <?php endif; ?>
                </a>
            ...
            <li class="view-tab-item">
                <a href="#tab-apprentice_educations" class="view-tab-link" data-tab="tab-apprentice_educations">
                    <svg class="tab-icon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                        <path d="M1.5 3.25a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0zM3 6.5a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5zm-.75 2.75a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0z"></path>
                    </svg>
                    <?= __('ApprenticeEducations') ?>
                    <?php if (!empty($apprentice->apprentice_educations)): ?>
                    <span class="tab-badge"><?= count($apprentice->apprentice_educations) ?></span>
                    <?php else: ?>
                    <span class="tab-badge">0</span>
                    <?php endif; ?>
                </a>
            ...
            <li class="view-tab-item">
                <a href="#tab-apprentice_experiences" class="view-tab-link" data-tab="tab-apprentice_experiences">
                    <svg class="tab-icon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                        <path d="M1.5 3.25a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0zM3 6.5a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5zm-.75 2.75a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0z"></path>
                    </svg>
                    <?= __('ApprenticeExperiences') ?>
                    <?php if (!empty($apprentice->apprentice_experiences)): ?>
                    <span class="tab-badge"><?= count($apprentice->apprentice_experiences) ?></span>
                    <?php else: ?>
                    <span class="tab-badge">0</span>
                    <?php endif; ?>
                </a>
            ...
            <li class="view-tab-item">
                <a href="#tab-apprentice_families" class="view-tab-link" data-tab="tab-apprentice_families">
                    <svg class="tab-icon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                        <path d="M1.5 3.25a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0zM3 6.5a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5zm-.75 2.75a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0z"></path>
                    </svg>
                    <?= __('ApprenticeFamilies') ?>
                    <?php if (!empty($apprentice->apprentice_families)): ?>
                    <span class="tab-badge"><?= count($apprentice->apprentice_families) ?></span>
                    <?php else: ?>
                    <span class="tab-badge">0</span>
                    <?php endif; ?>
                </a>
            ...
            <li class="view-tab-item">
                <a href="#tab-apprentice_family_stories" class="view-tab-link" data-tab="tab-apprentice_family_stories">
                    <svg class="tab-icon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                        <path d="M1.5 3.25a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0zM3 6.5a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5zm-.75 2.75a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0z"></path>
                    </svg>
                    <?= __('ApprenticeFamilyStories') ?>
                    <?php if (!empty($apprentice->apprentice_family_stories)): ?>
                    <span class="tab-badge"><?= count($apprentice->apprentice_family_stories) ?></span>
                    <?php else: ?>
                    <span class="tab-badge">0</span>
                    <?php endif; ?>
                </a>
        ...
        <div class="view-tabs-content">
                ...
                <div class="media-preview-section" style="margin-bottom: 24px;">
                    <div class="image-preview-container" style="text-align: center; margin-bottom: 20px; background: #f6f8fa; padding: 20px; border-radius: 8px; border: 1px solid #d0d7de;">
                        ...
                        <?= $this->element('file_viewer', [
                            'filePath' => $apprentice->image_photo,
                            'showPreview' => true,
                            'editUrl' => $this->Url->build(['action' => 'edit', $apprentice->id])
                        ]) ?>
                    </div>
                </div>
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($apprentice->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Training Id') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($apprentice->training_id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Post Code') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($apprentice->post_code) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Last Salary Amount') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($apprentice->last_salary_amount) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Saving Goal Amount') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($apprentice->saving_goal_amount) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Body Weight') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($apprentice->body_weight) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Body Height') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($apprentice->body_height) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Interview Result Id') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($apprentice->master_interview_result_id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Rejected Reason Id') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($apprentice->master_rejected_reason_id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Candidate Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprentice->has('candidate') ? $this->Html->link($apprentice->candidate->name, ['controller' => 'Candidates', 'action' => 'view', $apprentice->candidate->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Trainee Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprentice->has('trainee') ? $this->Html->link($apprentice->trainee->name, ['controller' => 'Trainees', 'action' => 'view', $apprentice->trainee->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Apprenticeship Order Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprentice->has('apprentice_order') ? $this->Html->link($apprentice->apprentice_order->title, ['controller' => 'ApprenticeOrders', 'action' => 'view', $apprentice->apprentice_order->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Applicant Code') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->applicant_code) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Tmm Code') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->tmm_code) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Vocational Training Institution Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprentice->has('vocational_training_institution') ? $this->Html->link($apprentice->vocational_training_institution->name, ['controller' => 'VocationalTrainingInstitutions', 'action' => 'view', $apprentice->vocational_training_institution->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Acceptance Organization Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprentice->has('acceptance_organization') ? $this->Html->link($apprentice->acceptance_organization->title, ['controller' => 'AcceptanceOrganizations', 'action' => 'view', $apprentice->acceptance_organization->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Identity Number') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->identity_number) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Name') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Name Katakana') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->name_katakana) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Gender Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprentice->has('master_gender') ? $this->Html->link($apprentice->master_gender->title, ['controller' => 'MasterGenders', 'action' => 'view', $apprentice->master_gender->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Religion Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprentice->has('master_religion') ? $this->Html->link($apprentice->master_religion->title, ['controller' => 'MasterReligions', 'action' => 'view', $apprentice->master_religion->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Marriage Status Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprentice->has('master_marriage_status') ? $this->Html->link($apprentice->master_marriage_status->title, ['controller' => 'MasterMarriageStatuses', 'action' => 'view', $apprentice->master_marriage_status->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Birth Place') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->birth_place) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Birth Place Katakana') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->birth_place_katakana) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Telephone Mobile') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->telephone_mobile) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Telephone Emergency') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->telephone_emergency) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Email') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->email) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Propinsi Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprentice->has('master_propinsi') ? $this->Html->link($apprentice->master_propinsi->title, ['controller' => 'MasterPropinsis', 'action' => 'view', $apprentice->master_propinsi->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Kabupaten Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprentice->has('master_kabupaten') ? $this->Html->link($apprentice->master_kabupaten->title, ['controller' => 'MasterKabupatens', 'action' => 'view', $apprentice->master_kabupaten->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Kecamatan Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprentice->has('master_kecamatan') ? $this->Html->link($apprentice->master_kecamatan->title, ['controller' => 'MasterKecamatans', 'action' => 'view', $apprentice->master_kecamatan->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Kelurahan Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprentice->has('master_kelurahan') ? $this->Html->link($apprentice->master_kelurahan->title, ['controller' => 'MasterKelurahans', 'action' => 'view', $apprentice->master_kelurahan->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Address') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->address) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Strengths') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->strengths) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Weaknesses') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->weaknesses) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Hobby') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->hobby) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Application Reasons') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->application_reasons) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Expected Work Upon Returning To Japan') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->expected_work_upon_returning_to_japan) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Blood Type Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprentice->has('master_blood_type') ? $this->Html->link($apprentice->master_blood_type->title, ['controller' => 'MasterBloodTypes', 'action' => 'view', $apprentice->master_blood_type->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Explain Eye Condition') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->explain_eye_condition) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Explain Color Blind') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->explain_color_blind) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Link Whatsapp') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->link_whatsapp) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Link Line') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->link_line) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Link Instagram') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->link_instagram) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Link Facebook') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->link_facebook) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Link Tiktok') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->link_tiktok) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Specific Rejected Reason') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->specific_rejected_reason) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Birth Date') ?></th>
                            <td class="github-detail-value"><?= h($apprentice->birth_date) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Is Ever Went To Japan') ?></th>
                            <td class="github-detail-value">
                                <span class="github-badge <?= $apprentice->is_ever_went_to_japan ? 'badge-success' : 'badge-secondary' ?>">
                                    <?= $apprentice->is_ever_went_to_japan ? __('Yes') : __('No'); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="github-detail-value">
                                <span class="github-badge <?= $apprentice->will_go_to_japan_after_finished ? 'badge-success' : 'badge-secondary' ?>">
                                    <?= $apprentice->will_go_to_japan_after_finished ? __('Yes') : __('No'); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="github-detail-value">
                                <span class="github-badge <?= $apprentice->is_holding_passport ? 'badge-success' : 'badge-secondary' ?>">
                                    <?= $apprentice->is_holding_passport ? __('Yes') : __('No'); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="github-detail-value">
                                <span class="github-badge <?= $apprentice->is_wear_eye_glasses ? 'badge-success' : 'badge-secondary' ?>">
                                    <?= $apprentice->is_wear_eye_glasses ? __('Yes') : __('No'); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="github-detail-value">
                                <span class="github-badge <?= $apprentice->is_color_blind ? 'badge-success' : 'badge-secondary' ?>">
                                    <?= $apprentice->is_color_blind ? __('Yes') : __('No'); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="github-detail-value">
                                <span class="github-badge <?= $apprentice->is_right_handed ? 'badge-success' : 'badge-secondary' ?>">
                                    <?= $apprentice->is_right_handed ? __('Yes') : __('No'); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="github-detail-value">
                                <span class="github-badge <?= $apprentice->is_smoking ? 'badge-success' : 'badge-secondary' ?>">
                                    <?= $apprentice->is_smoking ? __('Yes') : __('No'); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="github-detail-value">
                                <span class="github-badge <?= $apprentice->is_drinking_alcohol ? 'badge-success' : 'badge-secondary' ?>">
                                    <?= $apprentice->is_drinking_alcohol ? __('Yes') : __('No'); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="github-detail-value">
                                <span class="github-badge <?= $apprentice->is_tattooed ? 'badge-success' : 'badge-secondary' ?>">
                                    <?= $apprentice->is_tattooed ? __('Yes') : __('No'); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="github-detail-value">
                                <span class="github-badge <?= $apprentice->is_training_pass ? 'badge-success' : 'badge-secondary' ?>">
                                    <?= $apprentice->is_training_pass ? __('Yes') : __('No'); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="github-detail-value">
                                <span class="github-badge <?= $apprentice->is_apprenticeship_pass ? 'badge-success' : 'badge-secondary' ?>">
                                    <?= $apprentice->is_apprenticeship_pass ? __('Yes') : __('No'); ?>
                                </span>
                            </td>
                        </tr>
                    </tbody>
            ...
            <!-- ApprenticeCertifications Tab -->
            <div id="tab-apprentice_certifications" class="view-tab-pane">
                <?php if (!empty($apprentice->apprentice_certifications)): ?>
                <div class="github-related-card">
                    <div class="github-related-header">
                        <h3 class="github-related-title">
                            ...
                            <?= __('Related ApprenticeCertifications') ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-plus"></i> ' . __('New ApprenticeCertification'),
                                ['controller' => 'ApprenticeCertifications', 'action' => 'add'],
                    ...
                    <div class="github-related-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover github-related-table" data-ajax-filter="true">
                                    ...
                                    <tr class="filter-row" style="background-color: #f8f9fa;">
                                        ...
                                        <th style="padding: 4px;">
                                            <div style="display: flex; gap: 3px;">
                                                ...
                                                <input type="text" 
                                                       class="form-control form-control-sm filter-input" 
                                                       placeholder="<?= __('Filter Apprentice Id') ?>" 
                                                       data-column="apprentice_id"
                                                   style="font-size: 12px; height: 28px; border: 1px solid #ddd;">
                                        </th>
                                        <th style="padding: 4px;">
                                ...
                                <tbody>
                                    <?php foreach ($apprentice->apprentice_certifications as $apprenticeCertifications): ?>
                                        ...
                                        <td class="actions actions-column" style="padding: 5px; vertical-align: middle; white-space: nowrap; background: inherit; border: none; position: sticky; left: 0; z-index: 5; min-width: 90px;">
                                            <div class="action-buttons-hover">
                                                <?= $this->Html->link(
                                                    ...
                                                    ['controller' => 'ApprenticeCertifications', 'action' => 'edit', $apprenticeCertifications->id],
                                                    ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => __('Edit')]
                                                ) ?>
                                                <?= $this->Html->link(
                                                    '<i class="fas fa-eye"></i>',
                                                    ['controller' => 'ApprenticeCertifications', 'action' => 'view', $apprenticeCertifications->id],
                                                    ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => __('View')]
                                                ) ?>
                                            </div>
                                        </td>
                                        <td><?= h($apprenticeCertifications->id) ?></td>
                                        <td>
                                            <?php if ($apprenticeCertifications->has('apprentice')): ?>
                                                <?php
                                            ...
                                            <?php else: ?>
                                                <?= h($apprenticeCertifications->apprentice_id) ?>
                                            <?php endif; ?>
                                        </td>
                                        <td><?= h($apprenticeCertifications->title) ?></td>
                                        <td><?= h($apprenticeCertifications->institution_name) ?></td>
                                        <td><?= h($apprenticeCertifications->certification_date) ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                ...
                <div class="github-empty-state">
                    ...
                    <h3><?= __('No Related ApprenticeCertifications') ?></h3>
                    <p><?= __('There are no related ApprenticeCertifications for this Apprentice.') ?></p>
                    <?= $this->Html->link(
                        __('Add First ApprenticeCertification'),
                        ['controller' => 'ApprenticeCertifications', 'action' => 'add'],
                        ['class' => 'btn-export-light']
                    ) ?>
                </div>
            ...
            <!-- ApprenticeCourses Tab -->
            <div id="tab-apprentice_courses" class="view-tab-pane">
                <?php if (!empty($apprentice->apprentice_courses)): ?>
                <div class="github-related-card">
                    <div class="github-related-header">
                        <h3 class="github-related-title">
                            ...
                            <?= __('Related ApprenticeCourses') ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-plus"></i> ' . __('New ApprenticeCourse'),
                                ['controller' => 'ApprenticeCourses', 'action' => 'add'],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-related-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover github-related-table" data-ajax-filter="true">
                                ...
                                <tbody>
                                    <?php foreach ($apprentice->apprentice_courses as $apprenticeCourses): ?>
                                    <tr class="table-row-with-actions">
                                        <td class="actions actions-column" style="padding: 5px; vertical-align: middle; white-space: nowrap; background: inherit; border: none; position: sticky; left: 0; z-index: 5; min-width: 90px;">
                                            <div class="action-buttons-hover">
                                                <?= $this->Html->link(
                                                    '<i class="fas fa-edit"></i>',
                                                    ['controller' => 'ApprenticeCourses', 'action' => 'edit', $apprenticeCourses->id],
                                                    ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => __('Edit')]
                                                ) ?>
                                                <?= $this->Html->link(
                                                    '<i class="fas fa-eye"></i>',
                                                    ['controller' => 'ApprenticeCourses', 'action' => 'view', $apprenticeCourses->id],
                                                    ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => __('View')]
                                                ) ?>
                                            </div>
                                        </td>
                                        <td><?= h($apprenticeCourses->id) ?></td>
                                        <td>
                                            <?php if ($apprenticeCourses->has('apprentice')): ?>
                                                <?php
                                            ...
                                            <?php else: ?>
                                                <?= h($apprenticeCourses->apprentice_id) ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= h($apprenticeCourses->vocational_training_institution_id) ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= h($apprenticeCourses->course_major_id) ?>
                                            <?php endif; ?>
                                        </td>
                                        <td><?= h($apprenticeCourses->course_year) ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                ...
                <div class="github-empty-state">
                    ...
                    <h3><?= __('No Related ApprenticeCourses') ?></h3>
                    <p><?= __('There are no related ApprenticeCourses for this Apprentice.') ?></p>
                    <?= $this->Html->link(
                        __('Add First ApprenticeCourse'),
                        ['controller' => 'ApprenticeCourses', 'action' => 'add'],
                        ['class' => 'btn-export-light']
                    ) ?>
                </div>
            ...
            <!-- ApprenticeEducations Tab -->
            <div id="tab-apprentice_educations" class="view-tab-pane">
                <?php if (!empty($apprentice->apprentice_educations)): ?>
                <div class="github-related-card">
                    <div class="github-related-header">
                        <h3 class="github-related-title">
                            ...
                            <?= __('Related ApprenticeEducations') ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-plus"></i> ' . __('New ApprenticeEducation'),
                                ['controller' => 'ApprenticeEducations', 'action' => 'add'],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-related-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover github-related-table" data-ajax-filter="true">
                                ...
                                <tbody>
                                    <?php foreach ($apprentice->apprentice_educations as $apprenticeEducations): ?>
                                    <tr class="table-row-with-actions">
                                        <td class="actions actions-column" style="padding: 5px; vertical-align: middle; white-space: nowrap; background: inherit; border: none; position: sticky; left: 0; z-index: 5; min-width: 90px;">
                                            <div class="action-buttons-hover">
                                                <?= $this->Html->link(
                                                    '<i class="fas fa-edit"></i>',
                                                    ['controller' => 'ApprenticeEducations', 'action' => 'edit', $apprenticeEducations->id],
                                                    ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => __('Edit')]
                                                ) ?>
                                                <?= $this->Html->link(
                                                    '<i class="fas fa-eye"></i>',
                                                    ['controller' => 'ApprenticeEducations', 'action' => 'view', $apprenticeEducations->id],
                                                    ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => __('View')]
                                                ) ?>
                                            </div>
                                        </td>
                                        <td><?= h($apprenticeEducations->id) ?></td>
                                        <td>
                                            <?php if ($apprenticeEducations->has('apprentice')): ?>
                                                <?php
                                            ...
                                            <?php else: ?>
                                                <?= h($apprenticeEducations->apprentice_id) ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= h($apprenticeEducations->master_strata_id) ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= h($apprenticeEducations->master_propinsi_id) ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= h($apprenticeEducations->master_kabupaten_id) ?>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                ...
                <div class="github-empty-state">
                    ...
                    <h3><?= __('No Related ApprenticeEducations') ?></h3>
                    <p><?= __('There are no related ApprenticeEducations for this Apprentice.') ?></p>
                    <?= $this->Html->link(
                        __('Add First ApprenticeEducation'),
                        ['controller' => 'ApprenticeEducations', 'action' => 'add'],
                        ['class' => 'btn-export-light']
                    ) ?>
                </div>
            ...
            <!-- ApprenticeExperiences Tab -->
            <div id="tab-apprentice_experiences" class="view-tab-pane">
                <?php if (!empty($apprentice->apprentice_experiences)): ?>
                <div class="github-related-card">
                    <div class="github-related-header">
                        <h3 class="github-related-title">
                            ...
                            <?= __('Related ApprenticeExperiences') ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-plus"></i> ' . __('New ApprenticeExperience'),
                                ['controller' => 'ApprenticeExperiences', 'action' => 'add'],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-related-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover github-related-table" data-ajax-filter="true">
                                ...
                                <tbody>
                                    <?php foreach ($apprentice->apprentice_experiences as $apprenticeExperiences): ?>
                                    <tr class="table-row-with-actions">
                                        <td class="actions actions-column" style="padding: 5px; vertical-align: middle; white-space: nowrap; background: inherit; border: none; position: sticky; left: 0; z-index: 5; min-width: 90px;">
                                            <div class="action-buttons-hover">
                                                <?= $this->Html->link(
                                                    '<i class="fas fa-edit"></i>',
                                                    ['controller' => 'ApprenticeExperiences', 'action' => 'edit', $apprenticeExperiences->id],
                                                    ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => __('Edit')]
                                                ) ?>
                                                <?= $this->Html->link(
                                                    '<i class="fas fa-eye"></i>',
                                                    ['controller' => 'ApprenticeExperiences', 'action' => 'view', $apprenticeExperiences->id],
                                                    ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => __('View')]
                                                ) ?>
                                            </div>
                                        </td>
                                        <td><?= h($apprenticeExperiences->id) ?></td>
                                        <td>
                                            <?php if ($apprenticeExperiences->has('apprentice')): ?>
                                                <?php
                                            ...
                                            <?php else: ?>
                                                <?= h($apprenticeExperiences->apprentice_id) ?>
                                            <?php endif; ?>
                                        </td>
                                        <td><?= h($apprenticeExperiences->employment_start_year) ?></td>
                                        <td><?= h($apprenticeExperiences->employment_end_year) ?></td>
                                        <td><?= h($apprenticeExperiences->company_name) ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                ...
                <div class="github-empty-state">
                    ...
                    <h3><?= __('No Related ApprenticeExperiences') ?></h3>
                    <p><?= __('There are no related ApprenticeExperiences for this Apprentice.') ?></p>
                    <?= $this->Html->link(
                        __('Add First ApprenticeExperience'),
                        ['controller' => 'ApprenticeExperiences', 'action' => 'add'],
                        ['class' => 'btn-export-light']
                    ) ?>
                </div>
            ...
            <!-- ApprenticeFamilies Tab -->
            <div id="tab-apprentice_families" class="view-tab-pane">
                <?php if (!empty($apprentice->apprentice_families)): ?>
                <div class="github-related-card">
                    <div class="github-related-header">
                        <h3 class="github-related-title">
                            ...
                            <?= __('Related ApprenticeFamilies') ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-plus"></i> ' . __('New ApprenticeFamily'),
                                ['controller' => 'ApprenticeFamilies', 'action' => 'add'],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-related-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover github-related-table" data-ajax-filter="true">
                                ...
                                <tbody>
                                    <?php foreach ($apprentice->apprentice_families as $apprenticeFamilies): ?>
                                    <tr class="table-row-with-actions">
                                        <td class="actions actions-column" style="padding: 5px; vertical-align: middle; white-space: nowrap; background: inherit; border: none; position: sticky; left: 0; z-index: 5; min-width: 90px;">
                                            <div class="action-buttons-hover">
                                                <?= $this->Html->link(
                                                    '<i class="fas fa-edit"></i>',
                                                    ['controller' => 'ApprenticeFamilies', 'action' => 'edit', $apprenticeFamilies->id],
                                                    ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => __('Edit')]
                                                ) ?>
                                                <?= $this->Html->link(
                                                    '<i class="fas fa-eye"></i>',
                                                    ['controller' => 'ApprenticeFamilies', 'action' => 'view', $apprenticeFamilies->id],
                                                    ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => __('View')]
                                                ) ?>
                                            </div>
                                        </td>
                                        <td><?= h($apprenticeFamilies->id) ?></td>
                                        <td>
                                            <?php if ($apprenticeFamilies->has('apprentice')): ?>
                                                <?php
                                            ...
                                            <?php else: ?>
                                                <?= h($apprenticeFamilies->apprentice_id) ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= h($apprenticeFamilies->master_family_connection_id) ?>
                                            <?php endif; ?>
                                        </td>
                                        <td><?= h($apprenticeFamilies->name) ?></td>
                                        <td><?= h($apprenticeFamilies->age) ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                ...
                <div class="github-empty-state">
                    ...
                    <h3><?= __('No Related ApprenticeFamilies') ?></h3>
                    <p><?= __('There are no related ApprenticeFamilies for this Apprentice.') ?></p>
                    <?= $this->Html->link(
                        __('Add First ApprenticeFamily'),
                        ['controller' => 'ApprenticeFamilies', 'action' => 'add'],
                        ['class' => 'btn-export-light']
                    ) ?>
                </div>
            ...
            <!-- ApprenticeFamilyStories Tab -->
            <div id="tab-apprentice_family_stories" class="view-tab-pane">
                <?php if (!empty($apprentice->apprentice_family_stories)): ?>
                <div class="github-related-card">
                    <div class="github-related-header">
                        <h3 class="github-related-title">
                            ...
                            <?= __('Related ApprenticeFamilyStories') ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-plus"></i> ' . __('New ApprenticeFamilyStory'),
                                ['controller' => 'ApprenticeFamilyStories', 'action' => 'add'],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-related-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover github-related-table" data-ajax-filter="true">
                                ...
                                <tbody>
                                    <?php foreach ($apprentice->apprentice_family_stories as $apprenticeFamilyStories): ?>
                                    <tr class="table-row-with-actions">
                                        <td class="actions actions-column" style="padding: 5px; vertical-align: middle; white-space: nowrap; background: inherit; border: none; position: sticky; left: 0; z-index: 5; min-width: 90px;">
                                            <div class="action-buttons-hover">
                                                <?= $this->Html->link(
                                                    '<i class="fas fa-edit"></i>',
                                                    ['controller' => 'ApprenticeFamilyStories', 'action' => 'edit', $apprenticeFamilyStories->id],
                                                    ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => __('Edit')]
                                                ) ?>
                                                <?= $this->Html->link(
                                                    '<i class="fas fa-eye"></i>',
                                                    ['controller' => 'ApprenticeFamilyStories', 'action' => 'view', $apprenticeFamilyStories->id],
                                                    ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => __('View')]
                                                ) ?>
                                            </div>
                                        </td>
                                        <td><?= h($apprenticeFamilyStories->id) ?></td>
                                        <td>
                                            <?php if ($apprenticeFamilyStories->has('apprentice')): ?>
                                                <?php
                                            ...
                                            <?php else: ?>
                                                <?= h($apprenticeFamilyStories->apprentice_id) ?>
                                            <?php endif; ?>
                                        </td>
                                        <td><?= h($apprenticeFamilyStories->title) ?></td>
                                        <td><?= h($apprenticeFamilyStories->date_occurrence) ?></td>
                                        <td><?= h($apprenticeFamilyStories->problem_contents) ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                ...
                <div class="github-empty-state">
                    ...
                    <h3><?= __('No Related ApprenticeFamilyStories') ?></h3>
                    <p><?= __('There are no related ApprenticeFamilyStories for this Apprentice.') ?></p>
                    <?= $this->Html->link(
                        __('Add First ApprenticeFamilyStory'),
                        ['controller' => 'ApprenticeFamilyStories', 'action' => 'add'],
                        ['class' => 'btn-export-light']
                    ) ?>
                </div>
            ...
            <div id="tab-candidates" class="view-tab-pane">
                <?php if ($apprentice->has('candidate')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                ...
                                ['controller' => 'Candidates', 'action' => 'view', $apprentice->candidate->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'Candidates', 'action' => 'edit', $apprentice->candidate->id],
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->candidate->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Apprenticeship Order Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->candidate->apprentice_order_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Candidate Code') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->candidate->candidate_code) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Vocational Training Institution Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->candidate->vocational_training_institution_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Acceptance Organization Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->candidate->acceptance_organization_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Identity Number') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->candidate->identity_number) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Name') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->candidate->name) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Name Katakana') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->candidate->name_katakana) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Master Gender Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->candidate->master_gender_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Master Religion Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->candidate->master_religion_id) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <!-- Trainee Tab (BelongsTo) -->
            <div id="tab-trainees" class="view-tab-pane">
                <?php if ($apprentice->has('trainee')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'Trainees', 'action' => 'view', $apprentice->trainee->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'Trainees', 'action' => 'edit', $apprentice->trainee->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->trainee->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Candidate Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->trainee->candidate_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Apprenticeship Order Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->trainee->apprentice_order_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Training Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->trainee->training_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Applicant Code') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->trainee->applicant_code) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Tmm Code') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->trainee->tmm_code) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Vocational Training Institution Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->trainee->vocational_training_institution_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Acceptance Organization Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->trainee->acceptance_organization_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Identity Number') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->trainee->identity_number) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Name') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->trainee->name) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="github-empty-state">
                    ...
                    <h3 class="empty-title"><?= __('No Trainee Associated') ?></h3>
                    <p class="empty-message"><?= __('This record is not associated with any Trainee.') ?></p>
                </div>
                <?php endif; ?>
            </div>
            <!-- ApprenticeOrder Tab (BelongsTo) -->
            <div id="tab-apprentice_orders" class="view-tab-pane">
                <?php if ($apprentice->has('apprentice_order')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'ApprenticeOrders', 'action' => 'view', $apprentice->apprentice_order->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'ApprenticeOrders', 'action' => 'edit', $apprentice->apprentice_order->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->apprentice_order->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Reference File') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->apprentice_order->reference_file) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Cooperative Association Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->apprentice_order->cooperative_association_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Acceptance Organization Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->apprentice_order->acceptance_organization_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->apprentice_order->title) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Male Trainee Number') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->apprentice_order->male_trainee_number) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Female Trainee Number') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->apprentice_order->female_trainee_number) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Master Job Category Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->apprentice_order->master_job_category_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Departure Year') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->apprentice_order->departure_year) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Departure Month') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->apprentice_order->departure_month) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="tab-vocational_training_institutions" class="view-tab-pane">
                <?php if ($apprentice->has('vocational_training_institution')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'VocationalTrainingInstitutions', 'action' => 'view', $apprentice->vocational_training_institution->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'VocationalTrainingInstitutions', 'action' => 'edit', $apprentice->vocational_training_institution->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->vocational_training_institution->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Is Special Skill Support Institution') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->vocational_training_institution->is_special_skill_support_institution) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Abbreviation') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->vocational_training_institution->abbreviation) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Name') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->vocational_training_institution->name) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Master Propinsi Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->vocational_training_institution->master_propinsi_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Master Kabupaten Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->vocational_training_institution->master_kabupaten_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Master Kecamatan Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->vocational_training_institution->master_kecamatan_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Master Kelurahan Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->vocational_training_institution->master_kelurahan_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Address') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->vocational_training_institution->address) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Post Code') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->vocational_training_institution->post_code) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="tab-acceptance_organizations" class="view-tab-pane">
                <?php if ($apprentice->has('acceptance_organization')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'AcceptanceOrganizations', 'action' => 'view', $apprentice->acceptance_organization->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'AcceptanceOrganizations', 'action' => 'edit', $apprentice->acceptance_organization->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->acceptance_organization->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->acceptance_organization->title) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Master Japan Prefecture Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->acceptance_organization->master_japan_prefecture_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Post Code') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->acceptance_organization->post_code) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Address') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->acceptance_organization->address) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Director') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->acceptance_organization->director) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Director Hiragana') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->acceptance_organization->director_hiragana) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="tab-master_genders" class="view-tab-pane">
                <?php if ($apprentice->has('master_gender')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'MasterGenders', 'action' => 'view', $apprentice->master_gender->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'MasterGenders', 'action' => 'edit', $apprentice->master_gender->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_gender->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_gender->title) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title Jpg') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_gender->title_jpg) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="tab-master_religions" class="view-tab-pane">
                <?php if ($apprentice->has('master_religion')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'MasterReligions', 'action' => 'view', $apprentice->master_religion->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'MasterReligions', 'action' => 'edit', $apprentice->master_religion->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_religion->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Slug') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_religion->slug) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_religion->title) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title Jpg') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_religion->title_jpg) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="tab-master_marriage_statuses" class="view-tab-pane">
                <?php if ($apprentice->has('master_marriage_status')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'MasterMarriageStatuses', 'action' => 'view', $apprentice->master_marriage_status->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'MasterMarriageStatuses', 'action' => 'edit', $apprentice->master_marriage_status->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_marriage_status->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Slug') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_marriage_status->slug) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_marriage_status->title) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title Jpg') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_marriage_status->title_jpg) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="tab-master_propinsis" class="view-tab-pane">
                <?php if ($apprentice->has('master_propinsi')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'MasterPropinsis', 'action' => 'view', $apprentice->master_propinsi->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'MasterPropinsis', 'action' => 'edit', $apprentice->master_propinsi->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_propinsi->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Propinsi') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_propinsi->kode_propinsi) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_propinsi->title) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="tab-master_kabupatens" class="view-tab-pane">
                <?php if ($apprentice->has('master_kabupaten')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'MasterKabupatens', 'action' => 'view', $apprentice->master_kabupaten->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'MasterKabupatens', 'action' => 'edit', $apprentice->master_kabupaten->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kabupaten->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Propinsi Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kabupaten->propinsi_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Propinsi') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kabupaten->kode_propinsi) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Kabupaten') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kabupaten->kode_kabupaten) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kabupaten->title) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="tab-master_kecamatans" class="view-tab-pane">
                <?php if ($apprentice->has('master_kecamatan')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'MasterKecamatans', 'action' => 'view', $apprentice->master_kecamatan->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'MasterKecamatans', 'action' => 'edit', $apprentice->master_kecamatan->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kecamatan->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Propinsi Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kecamatan->propinsi_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kabupaten Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kecamatan->kabupaten_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Propinsi') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kecamatan->kode_propinsi) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Kabupaten') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kecamatan->kode_kabupaten) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Kecamatan') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kecamatan->kode_kecamatan) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kecamatan->title) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="tab-master_kelurahans" class="view-tab-pane">
                <?php if ($apprentice->has('master_kelurahan')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'MasterKelurahans', 'action' => 'view', $apprentice->master_kelurahan->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'MasterKelurahans', 'action' => 'edit', $apprentice->master_kelurahan->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kelurahan->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Propinsi Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kelurahan->propinsi_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kabupaten Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kelurahan->kabupaten_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kecamatan Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kelurahan->kecamatan_id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Propinsi') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kelurahan->kode_propinsi) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Kabupaten') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kelurahan->kode_kabupaten) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Kecamatan') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kelurahan->kode_kecamatan) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Kelurahan') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kelurahan->kode_kelurahan) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Kode Pos') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kelurahan->kode_pos) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_kelurahan->title) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="tab-master_blood_types" class="view-tab-pane">
                <?php if ($apprentice->has('master_blood_type')): ?>
                <div class="github-details-card">
                    <div class="github-details-header">
                        <h3 class="github-details-title">
                            <svg class="octicon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <?= $this->Html->link(
                                '<i class="fas fa-external-link-alt"></i> ' . __('View Full Record'),
                                ['controller' => 'MasterBloodTypes', 'action' => 'view', $apprentice->master_blood_type->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right; margin-left: 10px;']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i> ' . __('Edit'),
                                ['controller' => 'MasterBloodTypes', 'action' => 'edit', $apprentice->master_blood_type->id],
                                ['class' => 'btn-export-light', 'escape' => false, 'style' => 'float: right;']
                            ) ?>
                        </h3>
                    </div>
                    ...
                    <div class="github-details-body">
                        <table class="github-details-table">
                            <tbody>
                                <tr>
                                    <th class="github-detail-label"><?= __('Id') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_blood_type->id) ?></td>
                                </tr>
                                <tr>
                                    <th class="github-detail-label"><?= __('Title') ?></th>
                                    <td class="github-detail-value"><?= h($apprentice->master_blood_type->title) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    window.initializeTabSwitching = function(container) {
        ...
        freshTabLinks.forEach(link => {
            link.addEventListener('click', function(e) {
                ...
                console.log('ÃƒÂ°Ã…Â¸Ã¢â‚¬â€œÃ‚Â±ÃƒÂ¯Ã‚Â¸Ã‚Â  Tab clicked:', this.getAttribute('data-tab'));
                
                // Get target tab
                const targetTab = this.getAttribute('data-tab');
                
                if (!targetTab) {
                    console.error('ÃƒÂ¢Ã‚ÂÃ…â€™ No data-tab attribute found on clicked element');
                    return;
                ...
                if (targetPane) {
                    ...
                    console.error('ÃƒÂ¢Ã‚ÂÃ…â€™ Target pane not found:', targetTab);
    ...
    <div class="related-section mt-4">
        ...
        <ul class="nav nav-tabs" id="relatedTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="apprenticecertifications-tab" data-bs-toggle="tab" 
                        data-bs-target="#apprenticecertifications-pane" type="button" role="tab" 
                        aria-controls="apprenticecertifications-pane" aria-selected="true">
                    <?= __('ApprenticeCertifications') ?>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link " id="apprenticecourses-tab" data-bs-toggle="tab" 
                        data-bs-target="#apprenticecourses-pane" type="button" role="tab" 
                        aria-controls="apprenticecourses-pane" aria-selected="false">
                    <?= __('ApprenticeCourses') ?>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link " id="apprenticeeducations-tab" data-bs-toggle="tab" 
                        data-bs-target="#apprenticeeducations-pane" type="button" role="tab" 
                        aria-controls="apprenticeeducations-pane" aria-selected="false">
                    <?= __('ApprenticeEducations') ?>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link " id="apprenticeexperiences-tab" data-bs-toggle="tab" 
                        data-bs-target="#apprenticeexperiences-pane" type="button" role="tab" 
                        aria-controls="apprenticeexperiences-pane" aria-selected="false">
                    <?= __('ApprenticeExperiences') ?>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link " id="apprenticefamilies-tab" data-bs-toggle="tab" 
                        data-bs-target="#apprenticefamilies-pane" type="button" role="tab" 
                        aria-controls="apprenticefamilies-pane" aria-selected="false">
                    <?= __('ApprenticeFamilies') ?>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link " id="apprenticefamilystories-tab" data-bs-toggle="tab" 
                        data-bs-target="#apprenticefamilystories-pane" type="button" role="tab" 
                        aria-controls="apprenticefamilystories-pane" aria-selected="false">
                    <?= __('ApprenticeFamilyStories') ?>
                </button>
            </li>
        </ul>
