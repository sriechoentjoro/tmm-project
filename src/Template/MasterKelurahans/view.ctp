            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Master Kelurahan') ?>: <?= h($masterKelurahan->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $masterKelurahan->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($masterKelurahan->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Propinsi Id') ?></th>
                            <td class="github-detail-value">
                                <?= $masterKelurahan->has('master_propinsi') ? $this->Html->link($masterKelurahan->master_propinsi->title, ['controller' => 'MasterPropinsis', 'action' => 'view', $masterKelurahan->master_propinsi->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Kabupaten Id') ?></th>
                            <td class="github-detail-value">
                                <?= $masterKelurahan->has('master_kabupaten') ? $this->Html->link($masterKelurahan->master_kabupaten->title, ['controller' => 'MasterKabupatens', 'action' => 'view', $masterKelurahan->master_kabupaten->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Kecamatan Id') ?></th>
                            <td class="github-detail-value">
                                <?= $masterKelurahan->has('master_kecamatan') ? $this->Html->link($masterKelurahan->master_kecamatan->title, ['controller' => 'MasterKecamatans', 'action' => 'view', $masterKelurahan->master_kecamatan->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Kode Propinsi') ?></th>
                            <td class="github-detail-value"><?= h($masterKelurahan->kode_propinsi) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Kode Kabupaten') ?></th>
                            <td class="github-detail-value"><?= h($masterKelurahan->kode_kabupaten) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Kode Kecamatan') ?></th>
                            <td class="github-detail-value"><?= h($masterKelurahan->kode_kecamatan) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Kode Kelurahan') ?></th>
                            <td class="github-detail-value"><?= h($masterKelurahan->kode_kelurahan) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Kode Pos') ?></th>
                            <td class="github-detail-value"><?= h($masterKelurahan->kode_pos) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($masterKelurahan->title) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
