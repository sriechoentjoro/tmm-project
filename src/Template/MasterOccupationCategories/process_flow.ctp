<?php
/**
 * Process Flow Documentation - Master Occupation Categories
...
<div class="flow-section">
    ...
    <div class="alert-info-custom">
        ...
        <?php if ($currentLang === 'ind'): ?>
            <strong>Master Occupation Categories</strong> adalah modul untuk mengelola data terkait Master Occupation Categories dalam sistem TMM.
        <?php elseif ($currentLang === 'eng'): ?>
            <strong>Master Occupation Categories</strong> is a module for managing Master Occupation Categories data in the TMM system.
        <?php else: ?>
            <strong>Master Occupation Categories</strong>ã¯ã€TMMã‚·ã‚¹ãƒ†ãƒ ã§Master Occupation Categories ãƒ‡ãƒ¼ã‚¿ã‚’ç®¡ç†ã™ã‚‹ãƒ¢ã‚¸ãƒ¥ãƒ¼ãƒ«ã§ã™ã€‚
        <?php endif; ?>
    </div>
        ...
        <div class="workflow-step">
            ...
            <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px);">
                <div class="step-title">
                    ...
                    <?php endif; ?>
                    <span class="database-indicator">masteroccupationcategories</span>
                </div>
                <div class="step-description">
                    ...
                    <?php if ($currentLang === 'ind'): ?>
                        Mengisi formulir data Master Occupation Categories
                    <?php elseif ($currentLang === 'eng'): ?>
                        Fill out Master Occupation Categories data form
                    <?php else: ?>
                        Master Occupation Categories ãƒ‡ãƒ¼ã‚¿ãƒ•ã‚©ãƒ¼ãƒ ã«è¨˜å…¥ã™ã‚‹
                    <?php endif; ?>
                    <br>
...
<!-- TODO: Customize this template with specific process flow for Master Occupation Categories -->
