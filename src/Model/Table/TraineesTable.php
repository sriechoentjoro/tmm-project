 ...
 * @property \App\Model\Table\MasterInterviewResultsTable&\Cake\ORM\Association\BelongsTo $MasterInterviewResults
 * @property \App\Model\Table\MasterRejectedReasonsTable&\Cake\ORM\Association\BelongsTo $MasterRejectedReasons
 * @property \App\Model\Table\TraineeCertificationsTable&\Cake\ORM\Association\HasMany $TraineeCertifications
 * @property \App\Model\Table\TraineeCoursesTable&\Cake\ORM\Association\HasMany $TraineeCourses
 * @property \App\Model\Table\TraineeEducationsTable&\Cake\ORM\Association\HasMany $TraineeEducations
 * @property \App\Model\Table\TraineeExperiencesTable&\Cake\ORM\Association\HasMany $TraineeExperiences
 * @property \App\Model\Table\TraineeFamiliesTable&\Cake\ORM\Association\HasMany $TraineeFamilies
 * @property \App\Model\Table\TraineeFamilyStoriesTable&\Cake\ORM\Association\HasMany $TraineeFamilyStories
 *
 * @method \App\Model\Entity\Trainee get($primaryKey, $options = [])
 * @method \App\Model\Entity\Trainee newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\Trainee[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Trainee|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Trainee saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Trainee patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\Trainee[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\Trainee findOrCreate($search, callable $callback = null, $options = [])
 */
class TraineesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        //     'strategy' => 'select',
        // ]);
        // COMMENTED OUT - Table 'master_rejected_reasons' doesn't exist
        // $this->belongsTo('MasterRejectedReasons', [
        //     'foreignKey' => 'master_rejected_reason_id',
        //     'strategy' => 'select',
        // ]);
        $this->hasMany('TraineeCertifications', [
            'foreignKey' => 'trainee_id',
        ]);
        $this->hasMany('TraineeCourses', [
            'foreignKey' => 'trainee_id',
        ]);
        $this->hasMany('TraineeEducations', [
            'foreignKey' => 'trainee_id',
        ]);
        $this->hasMany('TraineeExperiences', [
            'foreignKey' => 'trainee_id',
        ]);
        $this->hasMany('TraineeFamilies', [
            'foreignKey' => 'trainee_id',
        ]);
        $this->hasMany('TraineeFamilyStories', [
            'foreignKey' => 'trainee_id',
        ]);
    }
