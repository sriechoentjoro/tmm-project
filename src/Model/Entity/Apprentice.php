 ...
 * @property \App\Model\Entity\ApprenticeCertification[] $apprentice_certifications
 * @property \App\Model\Entity\ApprenticeCourse[] $apprentice_courses
 * @property \App\Model\Entity\ApprenticeEducation[] $apprentice_educations
 * @property \App\Model\Entity\ApprenticeExperience[] $apprentice_experiences
 * @property \App\Model\Entity\ApprenticeFamily[] $apprentice_families
 * @property \App\Model\Entity\ApprenticeFamilyStory[] $apprentice_family_stories
 */
class Apprentice extends Entity
{
    ...
    protected $_accessible = [
        ...
        'apprentice_certifications' => true,
        'apprentice_courses' => true,
        'apprentice_educations' => true,
        'apprentice_experiences' => true,
        'apprentice_families' => true,
        'apprentice_family_stories' => true,
    ];
}
