                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row-with-actions">
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= h($candidateRecordInterviews->applicant_id) ?>
                                            <?php endif; ?>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= h($candidateRecordInterviews->master_candidate_interview_type_id) ?>
                                            <?php endif; ?>
                                        </td>
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row-with-actions">
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= h($candidates->apprenticeship_order_id) ?>
                                            <?php endif; ?>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= h($candidates->vocational_training_institution_id) ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= h($candidates->acceptance_organization_id) ?>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
