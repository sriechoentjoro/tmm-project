 ...
 * @var \App\Model\Entity\MasterCandidateInterviewResult[]|\Cake\Collection\CollectionInterface $masterCandidateInterviewResults
 */
?>
...
<div class="index-header" style="margin-bottom: 20px;">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Master Candidate Interview Results') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="masterCandidateInterviewResults index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                <?php foreach ($masterCandidateInterviewResults as $masterCandidateInterviewResult): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'view', $masterCandidateInterviewResult->id],
                            ...
                            <?= $this->Form->postLink(
                                ...
                                ['confirm' => __('Are you sure you want to delete # {0}?', $masterCandidateInterviewResult->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($masterCandidateInterviewResult->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterCandidateInterviewResult->title) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
