 ...
 * @var \App\Model\Entity\CandidateDocumentManagementDashboardDetail[]|\Cake\Collection\CollectionInterface $candidateDocumentManagementDashboardDetails
 */
?>
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <?= $this->Html->link(
                    '<i class="fas fa-list"></i> ' . __('List Candidate Document Management Dashboard Details'),
                    ['action' => 'index'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <?= $this->Html->link(
                    '<i class="fas fa-plus"></i> ' . __('New Candidate Document Management Dashboard Detail'),
                    ['action' => 'add'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
            </div>
            
            <h2 style="margin: 0; display: inline-block;"><?= __('Candidate Document Management Dashboard Details') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="candidateDocumentManagementDashboardDetails index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <thead style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.15) 0%, rgba(118, 75, 162, 0.15) 100%); position: sticky; top: 0; z-index: 10;">
                <tr>
                    ...
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('dashboard_id') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('document_type') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('status') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('updated_at') ?></th>
                </tr>
            ...
            <tr class="filter-row" style="background-color: #f8f9fa;">
                ...
                <td style="padding: 5px;">
                    <select class="filter-input form-control form-control-sm" data-column="dashboard_id" data-type="select" style="font-size: 0.85rem; padding: 4px;">
                ...
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="document_type" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                    ...
                    <input type="text" class="filter-input form-control form-control-sm" placeholder="Filter..." data-column="document_type" style="font-size: 0.85rem; padding: 4px;">
                </td>
                <td style="padding: 5px;">
                ...
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="updated_at" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="=">=</option>
                        <option value="!=">!=</option>
                        <option value="<">&lt;</option>
                        <option value=">">&gt;</option>
                    ...
                    <input type="date" class="filter-input form-control form-control-sm" data-column="updated_at" style="font-size: 0.85rem; padding: 4px;">
                    <input type="date" class="filter-input-range form-control form-control-sm" data-column="updated_at" style="display:none; margin-top: 2px; font-size: 0.85rem;">
                </td>
            </tr>
            </thead>
            
            <tbody>
                <?php foreach ($candidateDocumentManagementDashboardDetails as $candidateDocumentManagementDashboardDetail): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'view', $candidateDocumentManagementDashboardDetail->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i>',
                                ['action' => 'edit', $candidateDocumentManagementDashboardDetail->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $candidateDocumentManagementDashboardDetail->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $candidateDocumentManagementDashboardDetail->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($candidateDocumentManagementDashboardDetail->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($candidateDocumentManagementDashboardDetail->dashboard_id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($candidateDocumentManagementDashboardDetail->document_type) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($candidateDocumentManagementDashboardDetail->status) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($candidateDocumentManagementDashboardDetail->updated_at) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
