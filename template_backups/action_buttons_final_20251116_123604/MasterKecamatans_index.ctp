 ...
 * @var \App\Model\Entity\MasterKecamatan[]|\Cake\Collection\CollectionInterface $masterKecamatans
 */
?>
...
<div class="index-header" style="margin-bottom: 20px;">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Master Kecamatans') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="masterKecamatans index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                <?php foreach ($masterKecamatans as $masterKecamatan): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'view', $masterKecamatan->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i>',
                                ['action' => 'edit', $masterKecamatan->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $masterKecamatan->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $masterKecamatan->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($masterKecamatan->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $masterKecamatan->has('master_propinsi') ? $this->Html->link($masterKecamatan->master_propinsi->title, ['controller' => 'MasterPropinsis', 'action' => 'view', $masterKecamatan->master_propinsi->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $masterKecamatan->has('master_kabupaten') ? $this->Html->link($masterKecamatan->master_kabupaten->title, ['controller' => 'MasterKabupatens', 'action' => 'view', $masterKecamatan->master_kabupaten->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterKecamatan->kode_propinsi) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterKecamatan->kode_kabupaten) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterKecamatan->kode_kecamatan) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterKecamatan->title) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
