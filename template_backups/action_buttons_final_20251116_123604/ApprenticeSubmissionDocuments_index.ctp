 ...
 * @var \App\Model\Entity\ApprenticeSubmissionDocument[]|\Cake\Collection\CollectionInterface $apprenticeSubmissionDocuments
 */
?>
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <?= $this->Html->link(
                    '<i class="fas fa-list"></i> ' . __('List Apprentice Submission Documents'),
                    ['action' => 'index'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <?= $this->Html->link(
                    '<i class="fas fa-plus"></i> ' . __('New Apprentice Submission Document'),
                    ['action' => 'add'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                ...
                <?= $this->Html->link(
                    ...
                    ['controller' => 'Apprentices', 'action' => 'add'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <div class="dropdown-divider"></div>
                <?= $this->Html->link(
                    '<i class="fas fa-list"></i> ' . __('List Master Document Submission Statuses'),
                    ['controller' => 'MasterDocumentSubmissionStatuses', 'action' => 'index'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <?= $this->Html->link(
                    '<i class="fas fa-plus"></i> ' . __('New Master Document Submission Status'),
                    ['controller' => 'MasterDocumentSubmissionStatuses', 'action' => 'add'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
            </div>
            
            <h2 style="margin: 0; display: inline-block;"><?= __('Apprentice Submission Documents') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="apprenticeSubmissionDocuments index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <thead style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.15) 0%, rgba(118, 75, 162, 0.15) 100%); position: sticky; top: 0; z-index: 10;">
                <tr>
                    ...
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('apprenticeship_submission_document_id') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('file_path') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('master_document_submission_status_id') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('uploaded_by') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('uploaded_at') ?></th>
            ...
            <tr class="filter-row" style="background-color: #f8f9fa;">
                ...
                <td style="padding: 5px;">
                    <select class="filter-input form-control form-control-sm" data-column="apprentice_id" data-type="select" style="font-size: 0.85rem; padding: 4px;">
                        <option value="">All Apprentices</option>
                        <?php foreach ($apprentices as $id => $name): ?>
                            <option value="<?= $id ?>"><?= h($name) ?></option>
                        <?php endforeach; ?>
                    </select>
                </td>
                <td style="padding: 5px;">
                    <select class="filter-input form-control form-control-sm" data-column="apprenticeship_submission_document_id" data-type="select" style="font-size: 0.85rem; padding: 4px;">
                        <option value="">All Apprenticeship_submission_documents</option>
                        <?php foreach ($apprenticeship_submission_documents as $id => $name): ?>
                            <option value="<?= $id ?>"><?= h($name) ?></option>
                        <?php endforeach; ?>
                    </select>
                </td>
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="file_path" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                    ...
                    <input type="text" class="filter-input form-control form-control-sm" placeholder="Filter..." data-column="file_path" style="font-size: 0.85rem; padding: 4px;">
                </td>
                <td style="padding: 5px;">
                    <select class="filter-input form-control form-control-sm" data-column="master_document_submission_status_id" data-type="select" style="font-size: 0.85rem; padding: 4px;">
                        <option value="">All Master_document_submission_statuss</option>
                        <?php foreach ($master_document_submission_statuss as $id => $name): ?>
                            <option value="<?= $id ?>"><?= h($name) ?></option>
                        <?php endforeach; ?>
                    </select>
                </td>
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="uploaded_by" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="=">=</option>
                        <option value="!=">!=</option>
                        <option value="<">&lt;</option>
                        <option value=">">&gt;</option>
                    ...
                    <input type="number" class="filter-input form-control form-control-sm" placeholder="Filter..." data-column="uploaded_by" style="font-size: 0.85rem; padding: 4px;">
                    <input type="number" class="filter-input-range form-control form-control-sm" placeholder="To..." data-column="uploaded_by" style="display:none; margin-top: 2px; font-size: 0.85rem;">
                </td>
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="uploaded_at" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="=">=</option>
                        <option value="!=">!=</option>
                        <option value="<">&lt;</option>
                        <option value=">">&gt;</option>
                    ...
                    <input type="date" class="filter-input form-control form-control-sm" data-column="uploaded_at" style="font-size: 0.85rem; padding: 4px;">
                    <input type="date" class="filter-input-range form-control form-control-sm" data-column="uploaded_at" style="display:none; margin-top: 2px; font-size: 0.85rem;">
                </td>
                <td style="padding: 5px;">
                ...
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="modified" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="=">=</option>
                        <option value="!=">!=</option>
                        <option value="<">&lt;</option>
                        <option value=">">&gt;</option>
                    ...
                    <input type="date" class="filter-input form-control form-control-sm" data-column="modified" style="font-size: 0.85rem; padding: 4px;">
                    <input type="date" class="filter-input-range form-control form-control-sm" data-column="modified" style="display:none; margin-top: 2px; font-size: 0.85rem;">
                </td>
            </tr>
            </thead>
            
            <tbody>
                <?php foreach ($apprenticeSubmissionDocuments as $apprenticeSubmissionDocument): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'view', $apprenticeSubmissionDocument->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i>',
                                ['action' => 'edit', $apprenticeSubmissionDocument->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $apprenticeSubmissionDocument->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $apprenticeSubmissionDocument->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprenticeSubmissionDocument->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprenticeSubmissionDocument->has('apprentice') ? $this->Html->link($apprenticeSubmissionDocument->apprentice->name, ['controller' => 'Apprentices', 'action' => 'view', $apprenticeSubmissionDocument->apprentice->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprenticeSubmissionDocument->apprenticeship_submission_document_id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeSubmissionDocument->file_path) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprenticeSubmissionDocument->has('master_document_submission_status') ? $this->Html->link($apprenticeSubmissionDocument->master_document_submission_status->name, ['controller' => 'MasterDocumentSubmissionStatuses', 'action' => 'view', $apprenticeSubmissionDocument->master_document_submission_status->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprenticeSubmissionDocument->uploaded_by) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeSubmissionDocument->uploaded_at) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeSubmissionDocument->created) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeSubmissionDocument->modified) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
