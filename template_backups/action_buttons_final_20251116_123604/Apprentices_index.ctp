 ...
 * @var \App\Model\Entity\Apprentice[]|\Cake\Collection\CollectionInterface $apprentices
 */
?>
...
<div class="index-header" style="margin-bottom: 20px;">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Apprentices') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="apprentices index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tr class="filter-row" style="background-color: #f8f9fa;">
                ...
                <td style="padding: 5px;">
                    <select class="filter-input form-control form-control-sm" data-column="trainee_id" data-type="select" style="font-size: 0.85rem; padding: 4px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            ...
                            <?= $this->Form->postLink(
                                ...
                                ['confirm' => __('Are you sure you want to delete # {0}?', $apprentice->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <!-- Photo Column -->
                    <td style="padding: 8px; text-align: center;">
                        <?php if (!empty($apprentice->image_photo) && file_exists(WWW_ROOT . 'img' . DS . 'uploads' . DS . $apprentice->image_photo)): ?>
                            <img src="<?= $this->Url->build('/img/uploads/' . h($apprentice->image_photo)) ?>" 
                                 alt="Photo" 
                    ...
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprentice->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprentice->has('candidate') ? $this->Html->link($apprentice->candidate->name, ['controller' => 'Candidates', 'action' => 'view', $apprentice->candidate->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprentice->has('trainee') ? $this->Html->link($apprentice->trainee->name, ['controller' => 'Trainees', 'action' => 'view', $apprentice->trainee->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprentice->apprenticeship_order_id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprentice->training_id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->applicant_code) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->tmm_code) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprentice->vocational_training_institution_id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprentice->acceptance_organization_id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->identity_number) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->name) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->name_katakana) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprentice->has('master_gender') ? $this->Html->link($apprentice->master_gender->title, ['controller' => 'MasterGenders', 'action' => 'view', $apprentice->master_gender->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprentice->has('master_religion') ? $this->Html->link($apprentice->master_religion->title, ['controller' => 'MasterReligions', 'action' => 'view', $apprentice->master_religion->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprentice->has('master_marriage_status') ? $this->Html->link($apprentice->master_marriage_status->title, ['controller' => 'MasterMarriageStatuses', 'action' => 'view', $apprentice->master_marriage_status->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->birth_place) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->birth_place_katakana) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->birth_date) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->telephone_mobile) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->telephone_emergency) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->email) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprentice->has('master_propinsi') ? $this->Html->link($apprentice->master_propinsi->title, ['controller' => 'MasterPropinsis', 'action' => 'view', $apprentice->master_propinsi->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprentice->has('master_kabupaten') ? $this->Html->link($apprentice->master_kabupaten->title, ['controller' => 'MasterKabupatens', 'action' => 'view', $apprentice->master_kabupaten->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprentice->has('master_kecamatan') ? $this->Html->link($apprentice->master_kecamatan->title, ['controller' => 'MasterKecamatans', 'action' => 'view', $apprentice->master_kecamatan->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprentice->has('master_kelurahan') ? $this->Html->link($apprentice->master_kelurahan->title, ['controller' => 'MasterKelurahans', 'action' => 'view', $apprentice->master_kelurahan->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprentice->post_code) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->address) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->image_photo) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->strengths) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->weaknesses) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->hobby) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprentice->last_salary_amount) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->application_reasons) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->is_ever_went_to_japan) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->will_go_to_japan_after_finished) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->expected_work_upon_returning_to_japan) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->is_holding_passport) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprentice->saving_goal_amount) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprentice->blood_type_id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprentice->body_weight) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprentice->body_height) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->is_wear_eye_glasses) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->explain_eye_condition) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->is_color_blind) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->explain_color_blind) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->is_right_handed) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->is_smoking) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->is_drinking_alcohol) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->is_tattooed) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->link_whatsapp) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->link_line) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->link_instagram) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->link_facebook) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->link_tiktok) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprentice->master_interview_result_id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->is_training_pass) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprentice->is_apprenticeship_pass) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprentice->has('master_rejected_reason') ? $this->Html->link($apprentice->master_rejected_reason->title, ['controller' => 'MasterRejectedReasons', 'action' => 'view', $apprentice->master_rejected_reason->id]) : '' ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
