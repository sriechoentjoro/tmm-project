        ...
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            ...
                            <?= $this->Form->postLink(
                                ...
                                ['action' => 'delete', $candidateCourse->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $candidateCourse->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    ...
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($candidateCourse->vocational_training_institution_id) ?></td>
