 ...
 * @var \App\Model\Entity\VocationalTrainingInstitutionStory[]|\Cake\Collection\CollectionInterface $vocationalTrainingInstitutionStories
 */
?>
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <?= $this->Html->link(
                    '<i class="fas fa-list"></i> ' . __('List Vocational Training Institution Stories'),
                    ['action' => 'index'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <?= $this->Html->link(
                    '<i class="fas fa-plus"></i> ' . __('New Vocational Training Institution Story'),
                    ['action' => 'add'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Vocational Training Institution Stories') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="vocationalTrainingInstitutionStories index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                <?php foreach ($vocationalTrainingInstitutionStories as $vocationalTrainingInstitutionStory): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'view', $vocationalTrainingInstitutionStory->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i>',
                                ['action' => 'edit', $vocationalTrainingInstitutionStory->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $vocationalTrainingInstitutionStory->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $vocationalTrainingInstitutionStory->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($vocationalTrainingInstitutionStory->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $vocationalTrainingInstitutionStory->has('vocational_training_institution') ? $this->Html->link($vocationalTrainingInstitutionStory->vocational_training_institution->name, ['controller' => 'VocationalTrainingInstitutions', 'action' => 'view', $vocationalTrainingInstitutionStory->vocational_training_institution->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($vocationalTrainingInstitutionStory->date_occurrence) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($vocationalTrainingInstitutionStory->problem_classification) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($vocationalTrainingInstitutionStory->problem_solution) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($vocationalTrainingInstitutionStory->problem_inference) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($vocationalTrainingInstitutionStory->image_path) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
