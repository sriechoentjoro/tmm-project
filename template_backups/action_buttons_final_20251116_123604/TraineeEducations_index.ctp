 ...
 * @var \App\Model\Entity\TraineeEducation[]|\Cake\Collection\CollectionInterface $traineeEducations
 */
?>
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <?= $this->Html->link(
                    '<i class="fas fa-list"></i> ' . __('List Trainee Educations'),
                    ['action' => 'index'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <?= $this->Html->link(
                    '<i class="fas fa-plus"></i> ' . __('New Trainee Education'),
                    ['action' => 'add'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Trainee Educations') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="traineeEducations index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                <?php foreach ($traineeEducations as $traineeEducation): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'view', $traineeEducation->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i>',
                                ['action' => 'edit', $traineeEducation->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $traineeEducation->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $traineeEducation->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($traineeEducation->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $traineeEducation->has('trainee') ? $this->Html->link($traineeEducation->trainee->name, ['controller' => 'Trainees', 'action' => 'view', $traineeEducation->trainee->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $traineeEducation->has('master_strata') ? $this->Html->link($traineeEducation->master_strata->title, ['controller' => 'MasterStratas', 'action' => 'view', $traineeEducation->master_strata->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $traineeEducation->has('master_propinsi') ? $this->Html->link($traineeEducation->master_propinsi->title, ['controller' => 'MasterPropinsis', 'action' => 'view', $traineeEducation->master_propinsi->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $traineeEducation->has('master_kabupaten') ? $this->Html->link($traineeEducation->master_kabupaten->title, ['controller' => 'MasterKabupatens', 'action' => 'view', $traineeEducation->master_kabupaten->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($traineeEducation->college_entry_date) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($traineeEducation->college_graduate_date) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($traineeEducation->college_name) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($traineeEducation->college_major) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
