 ...
 * @var \App\Model\Entity\TraineeFamily[]|\Cake\Collection\CollectionInterface $traineeFamilies
 */
?>
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <?= $this->Html->link(
                    '<i class="fas fa-list"></i> ' . __('List Trainee Families'),
                    ['action' => 'index'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <?= $this->Html->link(
                    '<i class="fas fa-plus"></i> ' . __('New Trainee Family'),
                    ['action' => 'add'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Trainee Families') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="traineeFamilies index content">
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'view', $traineeFamily->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i>',
                                ['action' => 'edit', $traineeFamily->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $traineeFamily->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $traineeFamily->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($traineeFamily->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $traineeFamily->has('trainee') ? $this->Html->link($traineeFamily->trainee->name, ['controller' => 'Trainees', 'action' => 'view', $traineeFamily->trainee->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $traineeFamily->has('master_family_connection') ? $this->Html->link($traineeFamily->master_family_connection->title, ['controller' => 'MasterFamilyConnections', 'action' => 'view', $traineeFamily->master_family_connection->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($traineeFamily->name) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($traineeFamily->age) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $traineeFamily->has('master_occupation') ? $this->Html->link($traineeFamily->master_occupation->title, ['controller' => 'MasterOccupations', 'action' => 'view', $traineeFamily->master_occupation->id]) : '' ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
