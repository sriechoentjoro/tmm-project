        ...
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tr class="filter-row" style="background-color: #f8f9fa;">
                ...
                <td style="padding: 5px;">
                    <select class="filter-input form-control form-control-sm" data-column="acceptance_organization_id" data-type="select" style="font-size: 0.85rem; padding: 4px;">
                        <option value="">All Acceptance Organizations</option>
                        <?php foreach ($acceptanceOrganizations as $id => $name): ?>
                            <option value="<?= $id ?>"><?= h($name) ?></option>
                        <?php endforeach; ?>
                    </select>
                </td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprenticeOrder->cooperative_association_id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprenticeOrder->acceptance_organization_id) ?></td>
                    ...
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprenticeOrder->job_category_id) ?></td>
