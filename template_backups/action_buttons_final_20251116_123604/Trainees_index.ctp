        ...
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            ...
                            <?= $this->Form->postLink(
                                ...
                                ['confirm' => __('Are you sure you want to delete # {0}?', $trainee->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <!-- Photo Thumbnail -->
                    <td style="padding: 8px; text-align: center;">
                        <?php if (!empty($trainee->image_photo) && file_exists(WWW_ROOT . 'img' . DS . 'uploads' . DS . $trainee->image_photo)): ?>
                            <?= $this->Html->image('uploads/' . $trainee->image_photo, [
                                'alt' => h($trainee->name),
                    ...
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($trainee->apprenticeship_order_id) ?></td>
                    ...
                    <td style="padding: 8px; white-space: nowrap;"><?= h($trainee->image_photo) ?></td>
                    ...
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($trainee->blood_type_id) ?></td>
