            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Apprentice Course') ?>: <?= h($apprenticeCourse->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $apprenticeCourse->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($apprenticeCourse->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Vocational Training Institution Id') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($apprenticeCourse->vocational_training_institution_id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Course Major Id') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($apprenticeCourse->course_major_id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Course Year') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($apprenticeCourse->course_year) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Apprentice Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprenticeCourse->has('apprentice') ? $this->Html->link($apprenticeCourse->apprentice->name, ['controller' => 'Apprentices', 'action' => 'view', $apprenticeCourse->apprentice->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeCourse->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Detail') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeCourse->detail) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
