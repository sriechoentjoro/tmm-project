            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Acceptance Organization Story') ?>: <?= h($acceptanceOrganizationStory->id) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $acceptanceOrganizationStory->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
        ...
        <div class="view-tabs-content">
            ...
            <div id="tab-home" class="view-tab-pane active">
                ...
                <div class="media-preview-section" style="margin-bottom: 24px;">
                    <?php if (!empty($acceptanceOrganizationStory->image_path)): ?>
                    <div class="image-preview-container" style="text-align: center; margin-bottom: 20px; background: #f6f8fa; padding: 20px; border-radius: 8px; border: 1px solid #d0d7de;">
                        ...
                        <div style="max-width: 800px; margin: 0 auto;">
                            <img src="<?= $this->Url->build('/' . h($acceptanceOrganizationStory->image_path)) ?>" 
                                 alt="<?= __('Image Path') ?>"
                        ...
                        <div style="margin-top: 15px;">
                            <a href="<?= $this->Url->build('/' . h($acceptanceOrganizationStory->image_path)) ?>" 
                               download 
                               class="btn-export-light"
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($acceptanceOrganizationStory->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Acceptance Organization Id') ?></th>
                            <td class="github-detail-value">
                                <?= $acceptanceOrganizationStory->has('acceptance_organization') ? $this->Html->link($acceptanceOrganizationStory->acceptance_organization->title, ['controller' => 'AcceptanceOrganizations', 'action' => 'view', $acceptanceOrganizationStory->acceptance_organization->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Problem Contents') ?></th>
                            <td class="github-detail-value"><?= h($acceptanceOrganizationStory->problem_contents) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Problem Classification') ?></th>
                            <td class="github-detail-value"><?= h($acceptanceOrganizationStory->problem_classification) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Problem Solution') ?></th>
                            <td class="github-detail-value"><?= h($acceptanceOrganizationStory->problem_solution) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Problem Inference') ?></th>
                            <td class="github-detail-value"><?= h($acceptanceOrganizationStory->problem_inference) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Image Path') ?></th>
                            <td class="github-detail-value"><?= h($acceptanceOrganizationStory->image_path) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Date Occurrence') ?></th>
                            <td class="github-detail-value"><?= h($acceptanceOrganizationStory->date_occurrence) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
