                ...
                <div class="media-preview-section" style="margin-bottom: 24px;">
                    ...
                    <div class="image-preview-container" style="text-align: center; margin-bottom: 20px; background: #f6f8fa; padding: 20px; border-radius: 8px; border: 1px solid #d0d7de;">
                        ...
                        <div style="max-width: 800px; margin: 0 auto;">
                            <img src="<?= $this->Url->build('/' . h($apprentice->image_photo)) ?>" 
                                 alt="<?= __('Image Photo') ?>"
                        ...
                        <div style="margin-top: 15px;">
                            <a href="<?= $this->Url->build('/' . h($apprentice->image_photo)) ?>" 
                               download 
                               class="btn-export-light"
                ...
                <table class="github-details-table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($apprentice->apprenticeship_order_id) ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($apprentice->vocational_training_institution_id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Acceptance Organization Id') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($apprentice->acceptance_organization_id) ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($apprentice->blood_type_id) ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="github-detail-value"><?= h($apprentice->image_photo) ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="github-detail-value">
                                <?= $apprentice->has('master_rejected_reason') ? $this->Html->link($apprentice->master_rejected_reason->title, ['controller' => 'MasterRejectedReasons', 'action' => 'view', $apprentice->master_rejected_reason->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
