            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Master Document Preparedness Status') ?>: <?= h($masterDocumentPreparednessStatus->name) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $masterDocumentPreparednessStatus->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($masterDocumentPreparednessStatus->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Name') ?></th>
                            <td class="github-detail-value"><?= h($masterDocumentPreparednessStatus->name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Description') ?></th>
                            <td class="github-detail-value"><?= h($masterDocumentPreparednessStatus->description) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
