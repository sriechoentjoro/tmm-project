            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Apprentice Record Coe Visa') ?>: <?= h($apprenticeRecordCoeVisa->id) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $apprenticeRecordCoeVisa->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($apprenticeRecordCoeVisa->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Coe Type Id') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($apprenticeRecordCoeVisa->master_coe_type_id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Apprentice Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprenticeRecordCoeVisa->has('apprentice') ? $this->Html->link($apprenticeRecordCoeVisa->apprentice->name, ['controller' => 'Apprentices', 'action' => 'view', $apprenticeRecordCoeVisa->apprentice->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Place Visa Issued') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeRecordCoeVisa->place_visa_issued) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Date Coe Received') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeRecordCoeVisa->date_coe_received) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Date Visa Application') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeRecordCoeVisa->date_visa_application) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Date Visa Received') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeRecordCoeVisa->date_visa_received) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
