            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Master Occupation') ?>: <?= h($masterOccupation->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $masterOccupation->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($masterOccupation->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Occupation Category Id') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($masterOccupation->occupation_category_id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($masterOccupation->title) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
