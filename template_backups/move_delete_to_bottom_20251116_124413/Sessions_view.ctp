                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= h($session->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Expires') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($session->expires) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
