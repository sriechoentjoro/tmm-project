            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <div class="dropdown-divider"></div>
                        <?= $this->Html->link(
                            '<i class="fas fa-list"></i> ' . __('List MasterAuthorizationRoles'),
                            ['controller' => 'MasterAuthorizationRoles', 'action' => 'index'],
                            ['class' => 'dropdown-item', 'escape' => false]
                        ) ?>
                        <?= $this->Html->link(
                            '<i class="fas fa-plus"></i> ' . __('New MasterAuthorizationRole'),
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Authorization') ?>: <?= h($authorization->id) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $authorization->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($authorization->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('User Id') ?></th>
                            <td class="github-detail-value">
                                <?= $authorization->has('user') ? $this->Html->link($authorization->user->name, ['controller' => 'Users', 'action' => 'view', $authorization->user->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Authorization Role Id') ?></th>
                            <td class="github-detail-value">
                                <?= $authorization->has('master_authorization_role') ? $this->Html->link($authorization->master_authorization_role->title, ['controller' => 'MasterAuthorizationRoles', 'action' => 'view', $authorization->master_authorization_role->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('User Name') ?></th>
                            <td class="github-detail-value"><?= h($authorization->user_name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Password') ?></th>
                            <td class="github-detail-value"><?= h($authorization->password) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Last Login') ?></th>
                            <td class="github-detail-value"><?= h($authorization->last_login) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
