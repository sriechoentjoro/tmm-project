            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Apprentice Certification') ?>: <?= h($apprenticeCertification->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $apprenticeCertification->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($apprenticeCertification->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Apprentice Id') ?></th>
                            <td class="github-detail-value">
                                <?= $apprenticeCertification->has('apprentice') ? $this->Html->link($apprenticeCertification->apprentice->name, ['controller' => 'Apprentices', 'action' => 'view', $apprenticeCertification->apprentice->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeCertification->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Institution Name') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeCertification->institution_name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Detail') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeCertification->detail) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Certification Date') ?></th>
                            <td class="github-detail-value"><?= h($apprenticeCertification->certification_date) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
