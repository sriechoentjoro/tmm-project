 ...
 * @var \App\Model\Entity\ApprenticeFamilyStory[]|\Cake\Collection\CollectionInterface $apprenticeFamilyStories
 */
?>
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <?= $this->Html->link(
                    '<i class="fas fa-list"></i> ' . __('List Apprentice Family Stories'),
                    ['action' => 'index'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <?= $this->Html->link(
                    '<i class="fas fa-plus"></i> ' . __('New Apprentice Family Story'),
                    ['action' => 'add'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Apprentice Family Stories') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="apprenticeFamilyStories index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                <?php foreach ($apprenticeFamilyStories as $apprenticeFamilyStory): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'view', $apprenticeFamilyStory->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i>',
                                ['action' => 'edit', $apprenticeFamilyStory->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $apprenticeFamilyStory->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $apprenticeFamilyStory->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprenticeFamilyStory->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprenticeFamilyStory->has('apprentice') ? $this->Html->link($apprenticeFamilyStory->apprentice->name, ['controller' => 'Apprentices', 'action' => 'view', $apprenticeFamilyStory->apprentice->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeFamilyStory->title) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeFamilyStory->date_occurrence) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeFamilyStory->problem_classification) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeFamilyStory->problem_solution) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeFamilyStory->problem_inference) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeFamilyStory->image_path) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
