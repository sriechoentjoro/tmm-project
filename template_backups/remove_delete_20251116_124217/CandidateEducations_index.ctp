 ...
 * @var \App\Model\Entity\CandidateEducation[]|\Cake\Collection\CollectionInterface $candidateEducations
 */
?>
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <?= $this->Html->link(
                    '<i class="fas fa-list"></i> ' . __('List Candidate Educations'),
                    ['action' => 'index'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <?= $this->Html->link(
                    '<i class="fas fa-plus"></i> ' . __('New Candidate Education'),
                    ['action' => 'add'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Candidate Educations') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="candidateEducations index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                <?php foreach ($candidateEducations as $candidateEducation): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'view', $candidateEducation->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i>',
                                ['action' => 'edit', $candidateEducation->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $candidateEducation->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $candidateEducation->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($candidateEducation->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $candidateEducation->has('candidate') ? $this->Html->link($candidateEducation->candidate->name, ['controller' => 'Candidates', 'action' => 'view', $candidateEducation->candidate->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $candidateEducation->has('master_strata') ? $this->Html->link($candidateEducation->master_strata->title, ['controller' => 'MasterStratas', 'action' => 'view', $candidateEducation->master_strata->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $candidateEducation->has('master_propinsi') ? $this->Html->link($candidateEducation->master_propinsi->title, ['controller' => 'MasterPropinsis', 'action' => 'view', $candidateEducation->master_propinsi->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $candidateEducation->has('master_kabupaten') ? $this->Html->link($candidateEducation->master_kabupaten->title, ['controller' => 'MasterKabupatens', 'action' => 'view', $candidateEducation->master_kabupaten->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($candidateEducation->college_entry_date) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($candidateEducation->college_graduate_date) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($candidateEducation->college_name) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($candidateEducation->college_major) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
