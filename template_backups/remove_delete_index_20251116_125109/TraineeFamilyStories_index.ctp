 ...
 * @var \App\Model\Entity\TraineeFamilyStory[]|\Cake\Collection\CollectionInterface $traineeFamilyStories
 */
?>
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <?= $this->Html->link(
                    '<i class="fas fa-list"></i> ' . __('List Trainee Family Stories'),
                    ['action' => 'index'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <?= $this->Html->link(
                    '<i class="fas fa-plus"></i> ' . __('New Trainee Family Story'),
                    ['action' => 'add'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Trainee Family Stories') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="traineeFamilyStories index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                <?php foreach ($traineeFamilyStories as $traineeFamilyStory): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'edit', $traineeFamilyStory->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-eye"></i>',
                                ['action' => 'view', $traineeFamilyStory->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $traineeFamilyStory->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $traineeFamilyStory->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($traineeFamilyStory->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $traineeFamilyStory->has('trainee') ? $this->Html->link($traineeFamilyStory->trainee->name, ['controller' => 'Trainees', 'action' => 'view', $traineeFamilyStory->trainee->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($traineeFamilyStory->title) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($traineeFamilyStory->date_occurrence) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($traineeFamilyStory->problem_classification) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($traineeFamilyStory->problem_solution) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($traineeFamilyStory->problem_inference) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($traineeFamilyStory->image_path) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
