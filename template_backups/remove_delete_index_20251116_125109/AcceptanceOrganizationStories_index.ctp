 ...
 * @var \App\Model\Entity\AcceptanceOrganizationStory[]|\Cake\Collection\CollectionInterface $acceptanceOrganizationStories
 */
?>
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <?= $this->Html->link(
                    '<i class="fas fa-list"></i> ' . __('List Acceptance Organization Stories'),
                    ['action' => 'index'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <?= $this->Html->link(
                    '<i class="fas fa-plus"></i> ' . __('New Acceptance Organization Story'),
                    ['action' => 'add'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Acceptance Organization Stories') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="acceptanceOrganizationStories index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                <?php foreach ($acceptanceOrganizationStories as $acceptanceOrganizationStory): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'edit', $acceptanceOrganizationStory->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-eye"></i>',
                                ['action' => 'view', $acceptanceOrganizationStory->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $acceptanceOrganizationStory->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $acceptanceOrganizationStory->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($acceptanceOrganizationStory->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $acceptanceOrganizationStory->has('acceptance_organization') ? $this->Html->link($acceptanceOrganizationStory->acceptance_organization->title, ['controller' => 'AcceptanceOrganizations', 'action' => 'view', $acceptanceOrganizationStory->acceptance_organization->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($acceptanceOrganizationStory->date_occurrence) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($acceptanceOrganizationStory->problem_classification) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($acceptanceOrganizationStory->problem_solution) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($acceptanceOrganizationStory->problem_inference) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($acceptanceOrganizationStory->image_path) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
