 ...
 * @var \App\Model\Entity\MasterStrata[]|\Cake\Collection\CollectionInterface $masterStratas
 */
?>
...
<div class="index-header" style="margin-bottom: 20px;">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Master Stratas') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="masterStratas index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <thead style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.15) 0%, rgba(118, 75, 162, 0.15) 100%); position: sticky; top: 0; z-index: 10;">
                <tr>
                    ...
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('title_hiragana') ?></th>
            ...
            <tr class="filter-row" style="background-color: #f8f9fa;">
                ...
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="title_hiragana" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="like">LIKE</option>
                        <option value="not_like">NOT LIKE</option>
                        <option value="=">=</option>
                        <option value="!=">!=</option>
                    ...
                    <input type="text" class="filter-input form-control form-control-sm" placeholder="Filter..." data-column="title_hiragana" style="font-size: 0.85rem; padding: 4px;">
                </td>
                <td style="padding: 5px;">
            ...
            <tbody>
                <?php foreach ($masterStratas as $masterStrata): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'edit', $masterStrata->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-eye"></i>',
                                ['action' => 'view', $masterStrata->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $masterStrata->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $masterStrata->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($masterStrata->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterStrata->slug) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterStrata->title) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterStrata->title_hiragana) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterStrata->updated) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterStrata->created) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
