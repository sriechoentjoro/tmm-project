 ...
 * @var \App\Model\Entity\ApprenticeEducation[]|\Cake\Collection\CollectionInterface $apprenticeEducations
 */
?>
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <?= $this->Html->link(
                    '<i class="fas fa-list"></i> ' . __('List Apprentice Educations'),
                    ['action' => 'index'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <?= $this->Html->link(
                    '<i class="fas fa-plus"></i> ' . __('New Apprentice Education'),
                    ['action' => 'add'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                ...
                <div class="dropdown-divider"></div>
                <?= $this->Html->link(
                    '<i class="fas fa-list"></i> ' . __('List Master Stratas'),
                    ['controller' => 'MasterStratas', 'action' => 'index'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <?= $this->Html->link(
                    '<i class="fas fa-plus"></i> ' . __('New Master Strata'),
                    ['controller' => 'MasterStratas', 'action' => 'add'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <div class="dropdown-divider"></div>
                <?= $this->Html->link(
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Apprentice Educations') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="apprenticeEducations index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <thead style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.15) 0%, rgba(118, 75, 162, 0.15) 100%); position: sticky; top: 0; z-index: 10;">
                <tr>
                    ...
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('master_strata_id') ?></th>
                    ...
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('college_entry_date') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('college_graduate_date') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('college_name') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('college_major') ?></th>
                </tr>
            ...
            <tr class="filter-row" style="background-color: #f8f9fa;">
                ...
                <td style="padding: 5px;">
                    <select class="filter-input form-control form-control-sm" data-column="master_strata_id" data-type="select" style="font-size: 0.85rem; padding: 4px;">
                        <option value="">All Master_stratas</option>
                        <?php foreach ($master_stratas as $id => $name): ?>
                            <option value="<?= $id ?>"><?= h($name) ?></option>
                        <?php endforeach; ?>
                    </select>
                </td>
                ...
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="college_entry_date" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="=">=</option>
                        <option value="!=">!=</option>
                        <option value="<">&lt;</option>
                        <option value=">">&gt;</option>
                    ...
                    <input type="date" class="filter-input form-control form-control-sm" data-column="college_entry_date" style="font-size: 0.85rem; padding: 4px;">
                    <input type="date" class="filter-input-range form-control form-control-sm" data-column="college_entry_date" style="display:none; margin-top: 2px; font-size: 0.85rem;">
                </td>
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="college_graduate_date" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="=">=</option>
                        <option value="!=">!=</option>
                        <option value="<">&lt;</option>
                        <option value=">">&gt;</option>
                    ...
                    <input type="date" class="filter-input form-control form-control-sm" data-column="college_graduate_date" style="font-size: 0.85rem; padding: 4px;">
                    <input type="date" class="filter-input-range form-control form-control-sm" data-column="college_graduate_date" style="display:none; margin-top: 2px; font-size: 0.85rem;">
                </td>
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="college_name" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                    ...
                    <input type="text" class="filter-input form-control form-control-sm" placeholder="Filter..." data-column="college_name" style="font-size: 0.85rem; padding: 4px;">
                </td>
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="college_major" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="like">LIKE</option>
                        <option value="not_like">NOT LIKE</option>
                        <option value="=">=</option>
                        <option value="!=">!=</option>
                    ...
                    <input type="text" class="filter-input form-control form-control-sm" placeholder="Filter..." data-column="college_major" style="font-size: 0.85rem; padding: 4px;">
                </td>
            </tr>
            </thead>
            
            <tbody>
                <?php foreach ($apprenticeEducations as $apprenticeEducation): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'edit', $apprenticeEducation->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-eye"></i>',
                                ['action' => 'view', $apprenticeEducation->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $apprenticeEducation->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $apprenticeEducation->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($apprenticeEducation->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprenticeEducation->has('apprentice') ? $this->Html->link($apprenticeEducation->apprentice->name, ['controller' => 'Apprentices', 'action' => 'view', $apprenticeEducation->apprentice->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprenticeEducation->has('master_strata') ? $this->Html->link($apprenticeEducation->master_strata->title, ['controller' => 'MasterStratas', 'action' => 'view', $apprenticeEducation->master_strata->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprenticeEducation->has('master_propinsi') ? $this->Html->link($apprenticeEducation->master_propinsi->title, ['controller' => 'MasterPropinsis', 'action' => 'view', $apprenticeEducation->master_propinsi->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $apprenticeEducation->has('master_kabupaten') ? $this->Html->link($apprenticeEducation->master_kabupaten->title, ['controller' => 'MasterKabupatens', 'action' => 'view', $apprenticeEducation->master_kabupaten->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeEducation->college_entry_date) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeEducation->college_graduate_date) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeEducation->college_name) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($apprenticeEducation->college_major) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
