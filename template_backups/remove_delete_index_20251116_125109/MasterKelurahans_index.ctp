 ...
 * @var \App\Model\Entity\MasterKelurahan[]|\Cake\Collection\CollectionInterface $masterKelurahans
 */
?>
...
<div class="index-header" style="margin-bottom: 20px;">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Master Kelurahans') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="masterKelurahans index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <thead style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.15) 0%, rgba(118, 75, 162, 0.15) 100%); position: sticky; top: 0; z-index: 10;">
                <tr>
                    ...
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('propinsi_id') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('kabupaten_id') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('kecamatan_id') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('kode_propinsi') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('kode_kabupaten') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('kode_kecamatan') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('kode_kelurahan') ?></th>
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('kode_pos') ?></th>
            ...
            <tr class="filter-row" style="background-color: #f8f9fa;">
                ...
                <td style="padding: 5px;">
                    <select class="filter-input form-control form-control-sm" data-column="propinsi_id" data-type="select" style="font-size: 0.85rem; padding: 4px;">
                        <option value="">All Propinsis</option>
                        <?php foreach ($propinsis as $id => $name): ?>
                            <option value="<?= $id ?>"><?= h($name) ?></option>
                        <?php endforeach; ?>
                    </select>
                </td>
                <td style="padding: 5px;">
                    <select class="filter-input form-control form-control-sm" data-column="kabupaten_id" data-type="select" style="font-size: 0.85rem; padding: 4px;">
                        <option value="">All Kabupatens</option>
                        <?php foreach ($kabupatens as $id => $name): ?>
                            <option value="<?= $id ?>"><?= h($name) ?></option>
                        <?php endforeach; ?>
                    </select>
                </td>
                <td style="padding: 5px;">
                    <select class="filter-input form-control form-control-sm" data-column="kecamatan_id" data-type="select" style="font-size: 0.85rem; padding: 4px;">
                        <option value="">All Kecamatans</option>
                        <?php foreach ($kecamatans as $id => $name): ?>
                            <option value="<?= $id ?>"><?= h($name) ?></option>
                        <?php endforeach; ?>
                    </select>
                </td>
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="kode_propinsi" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                    ...
                    <input type="text" class="filter-input form-control form-control-sm" placeholder="Filter..." data-column="kode_propinsi" style="font-size: 0.85rem; padding: 4px;">
                </td>
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="kode_kabupaten" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="like">LIKE</option>
                        <option value="not_like">NOT LIKE</option>
                        <option value="=">=</option>
                        <option value="!=">!=</option>
                    ...
                    <input type="text" class="filter-input form-control form-control-sm" placeholder="Filter..." data-column="kode_kabupaten" style="font-size: 0.85rem; padding: 4px;">
                </td>
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="kode_kecamatan" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="like">LIKE</option>
                        <option value="not_like">NOT LIKE</option>
                        <option value="=">=</option>
                        <option value="!=">!=</option>
                    ...
                    <input type="text" class="filter-input form-control form-control-sm" placeholder="Filter..." data-column="kode_kecamatan" style="font-size: 0.85rem; padding: 4px;">
                </td>
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="kode_kelurahan" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="like">LIKE</option>
                        <option value="not_like">NOT LIKE</option>
                        <option value="=">=</option>
                        <option value="!=">!=</option>
                    ...
                    <input type="text" class="filter-input form-control form-control-sm" placeholder="Filter..." data-column="kode_kelurahan" style="font-size: 0.85rem; padding: 4px;">
                </td>
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="kode_pos" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="like">LIKE</option>
                        <option value="not_like">NOT LIKE</option>
                        <option value="=">=</option>
                        <option value="!=">!=</option>
                    ...
                    <input type="text" class="filter-input form-control form-control-sm" placeholder="Filter..." data-column="kode_pos" style="font-size: 0.85rem; padding: 4px;">
                </td>
                <td style="padding: 5px;">
            ...
            <tbody>
                <?php foreach ($masterKelurahans as $masterKelurahan): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'edit', $masterKelurahan->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-eye"></i>',
                                ['action' => 'view', $masterKelurahan->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $masterKelurahan->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $masterKelurahan->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($masterKelurahan->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $masterKelurahan->has('master_propinsi') ? $this->Html->link($masterKelurahan->master_propinsi->title, ['controller' => 'MasterPropinsis', 'action' => 'view', $masterKelurahan->master_propinsi->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $masterKelurahan->has('master_kabupaten') ? $this->Html->link($masterKelurahan->master_kabupaten->title, ['controller' => 'MasterKabupatens', 'action' => 'view', $masterKelurahan->master_kabupaten->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $masterKelurahan->has('master_kecamatan') ? $this->Html->link($masterKelurahan->master_kecamatan->title, ['controller' => 'MasterKecamatans', 'action' => 'view', $masterKelurahan->master_kecamatan->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterKelurahan->kode_propinsi) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterKelurahan->kode_kabupaten) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterKelurahan->kode_kecamatan) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterKelurahan->kode_kelurahan) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterKelurahan->kode_pos) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterKelurahan->title) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
