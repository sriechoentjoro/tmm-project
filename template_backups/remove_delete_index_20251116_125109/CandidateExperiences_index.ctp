 ...
 * @var \App\Model\Entity\CandidateExperience[]|\Cake\Collection\CollectionInterface $candidateExperiences
 */
?>
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <?= $this->Html->link(
                    '<i class="fas fa-list"></i> ' . __('List Candidate Experiences'),
                    ['action' => 'index'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <?= $this->Html->link(
                    '<i class="fas fa-plus"></i> ' . __('New Candidate Experience'),
                    ['action' => 'add'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Candidate Experiences') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="candidateExperiences index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                <?php foreach ($candidateExperiences as $candidateExperience): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'edit', $candidateExperience->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-eye"></i>',
                                ['action' => 'view', $candidateExperience->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $candidateExperience->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $candidateExperience->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($candidateExperience->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $candidateExperience->has('candidate') ? $this->Html->link($candidateExperience->candidate->name, ['controller' => 'Candidates', 'action' => 'view', $candidateExperience->candidate->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($candidateExperience->employment_start_year) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($candidateExperience->employment_end_year) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($candidateExperience->company_name) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($candidateExperience->title) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $candidateExperience->has('master_employee_status') ? $this->Html->link($candidateExperience->master_employee_status->title, ['controller' => 'MasterEmployeeStatuses', 'action' => 'view', $candidateExperience->master_employee_status->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($candidateExperience->last_salary_amount) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
