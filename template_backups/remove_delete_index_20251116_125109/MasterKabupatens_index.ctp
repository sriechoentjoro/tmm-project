 ...
 * @var \App\Model\Entity\MasterKabupaten[]|\Cake\Collection\CollectionInterface $masterKabupatens
 */
?>
...
<div class="index-header" style="margin-bottom: 20px;">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Master Kabupatens') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="masterKabupatens index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                <?php foreach ($masterKabupatens as $masterKabupaten): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'edit', $masterKabupaten->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-eye"></i>',
                                ['action' => 'view', $masterKabupaten->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $masterKabupaten->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $masterKabupaten->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($masterKabupaten->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $masterKabupaten->has('master_propinsi') ? $this->Html->link($masterKabupaten->master_propinsi->title, ['controller' => 'MasterPropinsis', 'action' => 'view', $masterKabupaten->master_propinsi->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterKabupaten->kode_propinsi) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterKabupaten->kode_kabupaten) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterKabupaten->title) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
