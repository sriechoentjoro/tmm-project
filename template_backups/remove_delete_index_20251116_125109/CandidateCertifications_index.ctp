 ...
 * @var \App\Model\Entity\CandidateCertification[]|\Cake\Collection\CollectionInterface $candidateCertifications
 */
?>
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <?= $this->Html->link(
                    '<i class="fas fa-list"></i> ' . __('List Candidate Certifications'),
                    ['action' => 'index'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <?= $this->Html->link(
                    '<i class="fas fa-plus"></i> ' . __('New Candidate Certification'),
                    ['action' => 'add'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Candidate Certifications') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="candidateCertifications index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                <?php foreach ($candidateCertifications as $candidateCertification): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'edit', $candidateCertification->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-eye"></i>',
                                ['action' => 'view', $candidateCertification->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $candidateCertification->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $candidateCertification->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($candidateCertification->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $candidateCertification->has('candidate') ? $this->Html->link($candidateCertification->candidate->name, ['controller' => 'Candidates', 'action' => 'view', $candidateCertification->candidate->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($candidateCertification->title) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($candidateCertification->institution_name) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($candidateCertification->certification_date) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
