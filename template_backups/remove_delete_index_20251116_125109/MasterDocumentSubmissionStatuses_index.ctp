 ...
 * @var \App\Model\Entity\MasterDocumentSubmissionStatus[]|\Cake\Collection\CollectionInterface $masterDocumentSubmissionStatuses
 */
?>
...
<div class="index-header" style="margin-bottom: 20px;">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Master Document Submission Statuses') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="masterDocumentSubmissionStatuses index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                <?php foreach ($masterDocumentSubmissionStatuses as $masterDocumentSubmissionStatus): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'edit', $masterDocumentSubmissionStatus->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-eye"></i>',
                                ['action' => 'view', $masterDocumentSubmissionStatus->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $masterDocumentSubmissionStatus->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $masterDocumentSubmissionStatus->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($masterDocumentSubmissionStatus->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterDocumentSubmissionStatus->name) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterDocumentSubmissionStatus->created) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterDocumentSubmissionStatus->modified) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
