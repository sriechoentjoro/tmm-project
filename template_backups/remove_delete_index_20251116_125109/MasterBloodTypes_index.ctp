 ...
 * @var \App\Model\Entity\MasterBloodType[]|\Cake\Collection\CollectionInterface $masterBloodTypes
 */
?>
...
<div class="index-header" style="margin-bottom: 20px;">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Master Blood Types') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="masterBloodTypes index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                <?php foreach ($masterBloodTypes as $masterBloodType): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'edit', $masterBloodType->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-eye"></i>',
                                ['action' => 'view', $masterBloodType->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $masterBloodType->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $masterBloodType->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($masterBloodType->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterBloodType->title) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterBloodType->updated) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterBloodType->created) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
