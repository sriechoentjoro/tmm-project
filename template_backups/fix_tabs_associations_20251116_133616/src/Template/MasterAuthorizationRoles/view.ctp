            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Master Authorization Role') ?>: <?= h($masterAuthorizationRole->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Html->link(
                        ...
                        ['action' => 'edit', $masterAuthorizationRole->id],
                        ['class' => 'btn-export-light', 'escape' => false]
                    ) ?>
                    <?= $this->Form->postLink(
                        '<i class="fas fa-trash"></i> ' . __('Delete'),
                        ['action' => 'delete', $masterAuthorizationRole->id],
                        [
                            'class' => 'btn-export-light',
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $masterAuthorizationRole->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
        ...
        <ul class="view-tabs-nav" role="tablist">
            ...
            <li class="view-tab-item">
                <a href="#tab-authorizations" class="view-tab-link" data-tab="tab-authorizations">
                    ...
                    <?= __('Authorizations') ?>
                    <?php if (!empty($masterAuthorizationRole->authorizations)): ?>
                    <span class="tab-badge"><?= count($masterAuthorizationRole->authorizations) ?></span>
                    <?php endif; ?>
                </a>
            </li>
        </ul>
        ...
        <div class="view-tabs-content">
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($masterAuthorizationRole->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($masterAuthorizationRole->title) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div id="tab-authorizations" class="view-tab-pane">
                    ...
                    <div class="github-related-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover github-related-table" data-ajax-filter="true">
                                ...
                                <tbody>
                                    <?php foreach ($masterAuthorizationRole->authorizations as $authorizations): ?>
                ...
                <div class="github-empty-state">
                    ...
                    <p><?= __('There are no related Authorizations for this Master Authorization Role.') ?></p>
                    <?= $this->Html->link(
