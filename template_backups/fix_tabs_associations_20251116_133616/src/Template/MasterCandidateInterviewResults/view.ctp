...
<div class="github-container">
            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Master Candidate Interview Result') ?>: <?= h($masterCandidateInterviewResult->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Html->link(
                        ...
                        ['action' => 'edit', $masterCandidateInterviewResult->id],
                        ['class' => 'btn-export-light', 'escape' => false]
                    ) ?>
                    <?= $this->Form->postLink(
                        '<i class="fas fa-trash"></i> ' . __('Delete'),
                        ['action' => 'delete', $masterCandidateInterviewResult->id],
                        [
                            'class' => 'btn-export-light',
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $masterCandidateInterviewResult->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
    ...
    <div class="view-tabs-container">
        <ul class="view-tabs-nav" role="tablist">
            ...
            <li class="view-tab-item">
                <a href="#tab-candidate_record_interviews" class="view-tab-link" data-tab="tab-candidate_record_interviews">
                    <svg class="tab-icon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                    ...
                    <?= __('CandidateRecordInterviews') ?>
                    <?php if (!empty($masterCandidateInterviewResult->candidate_record_interviews)): ?>
                    <span class="tab-badge"><?= count($masterCandidateInterviewResult->candidate_record_interviews) ?></span>
                    <?php endif; ?>
                </a>
            </li>
            <li class="view-tab-item">
                <a href="#tab-candidates" class="view-tab-link" data-tab="tab-candidates">
                    ...
                    <?= __('Candidates') ?>
                    <?php if (!empty($masterCandidateInterviewResult->candidates)): ?>
                    <span class="tab-badge"><?= count($masterCandidateInterviewResult->candidates) ?></span>
                    <?php endif; ?>
                </a>
            </li>
        </ul>
        ...
        <div class="view-tabs-content">
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($masterCandidateInterviewResult->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($masterCandidateInterviewResult->title) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <!-- CandidateRecordInterviews Tab -->
            <div id="tab-candidate_record_interviews" class="view-tab-pane">
                <?php if (!empty($masterCandidateInterviewResult->candidate_record_interviews)): ?>
                <div class="github-related-card">
                    <div class="github-related-header">
                        <h3 class="github-related-title">
                            ...
                            <?= __('Related CandidateRecordInterviews') ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-plus"></i> ' . __('New CandidateRecordInterview'),
                                ['controller' => 'CandidateRecordInterviews', 'action' => 'add'],
                            ...
                            <table class="table table-striped table-hover github-related-table" data-ajax-filter="true">
                                <thead style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.15) 0%, rgba(118, 75, 162, 0.15) 100%);">
                                    <tr>
                                        ...
                                        <th><?= __('Title') ?></th>
                                        <th><?= __('Master Candidate Interview Type Id') ?></th>
                                    ...
                                    <tr class="filter-row" style="background-color: #f8f9fa;">
                                        ...
                                        <th style="padding: 4px;">
                                            <div style="display: flex; gap: 3px;">
                                                ...
                                                <input type="text" 
                                                       class="form-control form-control-sm filter-input" 
                                                       placeholder="<?= __('Filter Applicant Id') ?>" 
                                                       data-column="applicant_id"
                                                   style="font-size: 12px; height: 28px; border: 1px solid #ddd;">
                                        </th>
                                        <th style="padding: 4px;">
                                        ...
                                        <th style="padding: 4px;">
                                            <div style="display: flex; gap: 3px;">
                                                <select class="form-control form-control-sm filter-operator" 
                                                        data-column="master_candidate_interview_type_id" 
                                                        style="width: 70px; padding: 2px 4px; font-size: 11px;">
                                                    <option value="contains"><?= __('Contains') ?></option>
                                                    <option value="equals"><?= __('Equals') ?></option>
                                                    <option value="starts"><?= __('Starts') ?></option>
                                                ...
                                                <input type="text" 
                                                       class="form-control form-control-sm filter-input" 
                                                       placeholder="<?= __('Filter Master Candidate Interview Type Id') ?>" 
                                                       data-column="master_candidate_interview_type_id"
                                                   style="font-size: 12px; height: 28px; border: 1px solid #ddd;">
                                        </th>
                                        <th style="padding: 4px;">
                                            <div style="display: flex; gap: 3px;">
                                                ...
                                                <input type="text" 
                                                       class="form-control form-control-sm filter-input" 
                                                       placeholder="<?= __('Filter Date Interview') ?>" 
                                                       data-column="date_interview"
                                                   style="font-size: 12px; height: 28px; border: 1px solid #ddd;">
                                        </th>
                                    </tr>
                                ...
                                <tbody>
                                    <?php foreach ($masterCandidateInterviewResult->candidate_record_interviews as $candidateRecordInterviews): ?>
                                    <tr class="table-row-with-actions">
                                        <td class="actions actions-column" style="padding: 5px; vertical-align: middle; white-space: nowrap; background: inherit; border: none; position: sticky; left: 0; z-index: 5; min-width: 90px;">
                                            <div class="action-buttons-hover">
                                                <?= $this->Html->link(
                                                    ...
                                                    ['controller' => 'CandidateRecordInterviews', 'action' => 'edit', $candidateRecordInterviews->id],
                                                    ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => __('Edit')]
                                                ) ?>
                                                <?= $this->Html->link(
                                                    '<i class="fas fa-eye"></i>',
                                                    ['controller' => 'CandidateRecordInterviews', 'action' => 'view', $candidateRecordInterviews->id],
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $candidateRecordInterviews->has('master_candidate_interview_type') ? $this->Html->link($candidateRecordInterviews->master_candidate_interview_type->title, ['controller' => 'MasterCandidateInterviewTypes', 'action' => 'view', $candidateRecordInterviews->master_candidate_interview_type->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                        <td><?= h($candidateRecordInterviews->date_interview) ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                ...
                <div class="github-empty-state">
                    ...
                    <h3><?= __('No Related CandidateRecordInterviews') ?></h3>
                    <p><?= __('There are no related CandidateRecordInterviews for this Master Candidate Interview Result.') ?></p>
                    <?= $this->Html->link(
                        __('Add First CandidateRecordInterview'),
                        ['controller' => 'CandidateRecordInterviews', 'action' => 'add'],
                        ['class' => 'btn-export-light']
                    ) ?>
                </div>
            ...
            <div id="tab-candidates" class="view-tab-pane">
                            ...
                            <table class="table table-striped table-hover github-related-table" data-ajax-filter="true">
                                <thead style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.15) 0%, rgba(118, 75, 162, 0.15) 100%);">
                                    <tr>
                                        <th class="actions-column-header" style="width: 15px; background: transparent; border: none; position: sticky; left: 0; z-index: 10;"></th>
                                        <th><?= __('Id') ?></th>
                                        <th><?= __('Apprenticeship Order Id') ?></th>
                                        <th><?= __('Candidate Code') ?></th>
                                        <th><?= __('Vocational Training Institution Id') ?></th>
                                        <th><?= __('Acceptance Organization Id') ?></th>
                                    </tr>
                                    <!-- Filter Row -->
                                    <tr class="filter-row" style="background-color: #f8f9fa;">
                                        <th class="actions-column-header" style="width: 15px; padding: 4px; background: transparent; border: none; position: sticky; left: 0; z-index: 10;"></th>
                                        ...
                                        <th style="padding: 4px;">
                                            <div style="display: flex; gap: 3px;">
                                                <select class="form-control form-control-sm filter-operator" 
                                                        data-column="apprenticeship_order_id" 
                                                        style="width: 70px; padding: 2px 4px; font-size: 11px;">
                                                    <option value="contains"><?= __('Contains') ?></option>
                                                    <option value="equals"><?= __('Equals') ?></option>
                                                    <option value="starts"><?= __('Starts') ?></option>
                                                ...
                                                <input type="text" 
                                                       class="form-control form-control-sm filter-input" 
                                                       placeholder="<?= __('Filter Apprenticeship Order Id') ?>" 
                                                       data-column="apprenticeship_order_id"
                                                   style="font-size: 12px; height: 28px; border: 1px solid #ddd;">
                                        </th>
                                        <th style="padding: 4px;">
                                            <div style="display: flex; gap: 3px;">
                                                ...
                                                <input type="text" 
                                                       class="form-control form-control-sm filter-input" 
                                                       placeholder="<?= __('Filter Candidate Code') ?>" 
                                                       data-column="candidate_code"
                                                   style="font-size: 12px; height: 28px; border: 1px solid #ddd;">
                                        </th>
                                        <th style="padding: 4px;">
                                        ...
                                        <th style="padding: 4px;">
                                            <div style="display: flex; gap: 3px;">
                                                <select class="form-control form-control-sm filter-operator" 
                                                        data-column="acceptance_organization_id" 
                                                        style="width: 70px; padding: 2px 4px; font-size: 11px;">
                                                    <option value="contains"><?= __('Contains') ?></option>
                                                    <option value="equals"><?= __('Equals') ?></option>
                                                    <option value="starts"><?= __('Starts') ?></option>
                                                ...
                                                <input type="text" 
                                                       class="form-control form-control-sm filter-input" 
                                                       placeholder="<?= __('Filter Acceptance Organization Id') ?>" 
                                                       data-column="acceptance_organization_id"
                                                   style="font-size: 12px; height: 28px; border: 1px solid #ddd;">
                                        </th>
                                    </tr>
                                ...
                                <tbody>
                                    <?php foreach ($masterCandidateInterviewResult->candidates as $candidates): ?>
                                    <tr class="table-row-with-actions">
                                        <td class="actions actions-column" style="padding: 5px; vertical-align: middle; white-space: nowrap; background: inherit; border: none; position: sticky; left: 0; z-index: 5; min-width: 90px;">
                                            <div class="action-buttons-hover">
                                                <?= $this->Html->link(
                                                    '<i class="fas fa-edit"></i>',
                                                    ['controller' => 'Candidates', 'action' => 'edit', $candidates->id],
                                                    ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => __('Edit')]
                                                ) ?>
                                                <?= $this->Html->link(
                                                    '<i class="fas fa-eye"></i>',
                                                    ['controller' => 'Candidates', 'action' => 'view', $candidates->id],
                                                    ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => __('View')]
                                                ) ?>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <?php if ($candidates->has('apprenticeshipOrder')): ?>
                                                <?php
                                                    $displayValue = $candidates->apprenticeshipOrder->title;
                                                    if (empty($displayValue)) {
                                                        $displayValue = $candidates->apprenticeshipOrder->name;
                                                    }
                                                    if (empty($displayValue)) {
                                                        $displayValue = $candidates->apprenticeship_order_id;
                                                    }
                                                ?>
                                                <?= $this->Html->link(h($displayValue), ['controller' => 'ApprenticeshipOrders', 'action' => 'view', $candidates->apprenticeship_order_id]) ?>
                                            <?php else: ?>
                                                <?= $candidates->has('apprentice_order') ? $this->Html->link($candidates->apprentice_order->title, ['controller' => 'ApprenticeOrders', 'action' => 'view', $candidates->apprentice_order->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                        ...
                                        <td>
                                            <?php if ($candidates->has('vocationalTrainingInstitution')): ?>
                                                <?php
                                                    $displayValue = $candidates->vocationalTrainingInstitution->title;
                                                    if (empty($displayValue)) {
                                                        $displayValue = $candidates->vocationalTrainingInstitution->name;
                                                    }
                                                    if (empty($displayValue)) {
                                                        $displayValue = $candidates->vocational_training_institution_id;
                                                    }
                                                ?>
                                            ...
                                            <?php else: ?>
                                                <?= $candidates->has('vocational_training_institution') ? $this->Html->link($candidates->vocational_training_institution->name, ['controller' => 'VocationalTrainingInstitutions', 'action' => 'view', $candidates->vocational_training_institution->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if ($candidates->has('acceptanceOrganization')): ?>
                                                <?php
                                                    $displayValue = $candidates->acceptanceOrganization->title;
                                                    if (empty($displayValue)) {
                                                        $displayValue = $candidates->acceptanceOrganization->name;
                                                    }
                                                    if (empty($displayValue)) {
                                                        $displayValue = $candidates->acceptance_organization_id;
                                                    }
                                                ?>
                                                <?= $this->Html->link(h($displayValue), ['controller' => 'AcceptanceOrganizations', 'action' => 'view', $candidates->acceptance_organization_id]) ?>
                                            <?php else: ?>
                                                <?= $candidates->has('acceptance_organization') ? $this->Html->link($candidates->acceptance_organization->name, ['controller' => 'AcceptanceOrganizations', 'action' => 'view', $candidates->acceptance_organization->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                ...
                <div class="github-empty-state">
                    ...
                    <h3><?= __('No Related Candidates') ?></h3>
                    <p><?= __('There are no related Candidates for this Master Candidate Interview Result.') ?></p>
                    <?= $this->Html->link(
