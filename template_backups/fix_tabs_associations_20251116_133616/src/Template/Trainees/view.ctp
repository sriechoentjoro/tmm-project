                ...
                <div class="media-preview-section" style="margin-bottom: 24px;">
                    ...
                    <div class="image-preview-container" style="text-align: center; margin-bottom: 20px; background: #f6f8fa; padding: 20px; border-radius: 8px; border: 1px solid #d0d7de;">
                        ...
                        <div style="max-width: 800px; margin: 0 auto;">
                            <img src="<?= $this->Url->build('/' . h($trainee->image_photo)) ?>" 
                                 alt="<?= __('Image Photo') ?>"
                        ...
                        <div style="margin-top: 15px;">
                            <a href="<?= $this->Url->build('/' . h($trainee->image_photo)) ?>" 
                               download 
                               class="btn-export-light"
                ...
                <table class="github-details-table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($trainee->apprenticeship_order_id) ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($trainee->blood_type_id) ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="github-detail-value"><?= h($trainee->image_photo) ?></td>
                        </tr>
                        <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row-with-actions">
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $traineeCertifications->has('trainee') ? $this->Html->link($traineeCertifications->trainee->fullname, ['controller' => 'Trainees', 'action' => 'view', $traineeCertifications->trainee->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row-with-actions">
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $traineeCourses->has('trainee') ? $this->Html->link($traineeCourses->trainee->fullname, ['controller' => 'Trainees', 'action' => 'view', $traineeCourses->trainee->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $traineeCourses->has('vocational_training_institution') ? $this->Html->link($traineeCourses->vocational_training_institution->name, ['controller' => 'VocationalTrainingInstitutions', 'action' => 'view', $traineeCourses->vocational_training_institution->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row-with-actions">
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $traineeEducations->has('trainee') ? $this->Html->link($traineeEducations->trainee->fullname, ['controller' => 'Trainees', 'action' => 'view', $traineeEducations->trainee->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $traineeEducations->has('master_strata') ? $this->Html->link($traineeEducations->master_strata->title, ['controller' => 'MasterStratas', 'action' => 'view', $traineeEducations->master_strata->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $traineeEducations->has('master_propinsi') ? $this->Html->link($traineeEducations->master_propinsi->title, ['controller' => 'MasterPropinsis', 'action' => 'view', $traineeEducations->master_propinsi->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $traineeEducations->has('master_kabupaten') ? $this->Html->link($traineeEducations->master_kabupaten->title, ['controller' => 'MasterKabupatens', 'action' => 'view', $traineeEducations->master_kabupaten->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row-with-actions">
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $traineeExperiences->has('trainee') ? $this->Html->link($traineeExperiences->trainee->fullname, ['controller' => 'Trainees', 'action' => 'view', $traineeExperiences->trainee->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row-with-actions">
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $traineeFamilies->has('trainee') ? $this->Html->link($traineeFamilies->trainee->fullname, ['controller' => 'Trainees', 'action' => 'view', $traineeFamilies->trainee->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $traineeFamilies->has('master_family_connection') ? $this->Html->link($traineeFamilies->master_family_connection->title, ['controller' => 'MasterFamilyConnections', 'action' => 'view', $traineeFamilies->master_family_connection->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row-with-actions">
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $traineeFamilyStories->has('trainee') ? $this->Html->link($traineeFamilyStories->trainee->fullname, ['controller' => 'Trainees', 'action' => 'view', $traineeFamilyStories->trainee->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
