...
<div class="github-container">
            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <div class="dropdown-divider"></div>
                        <?= $this->Html->link(
                            '<i class="fas fa-list"></i> ' . __('List MasterDepartments'),
                            ['controller' => 'MasterDepartments', 'action' => 'index'],
                            ['class' => 'dropdown-item', 'escape' => false]
                        ) ?>
                        <?= $this->Html->link(
                            '<i class="fas fa-plus"></i> ' . __('New MasterDepartment'),
                            ['controller' => 'MasterDepartments', 'action' => 'add'],
                            ['class' => 'dropdown-item', 'escape' => false]
                        ) ?>
                    </div>
    ...
    <div class="view-tabs-container">
        <ul class="view-tabs-nav" role="tablist">
            ...
            <li class="view-tab-item">
                <a href="#tab-authorizations" class="view-tab-link" data-tab="tab-authorizations">
                    <svg class="tab-icon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                    ...
                    <?= __('Authorizations') ?>
                    <?php if (!empty($user->authorizations)): ?>
                    <span class="tab-badge"><?= count($user->authorizations) ?></span>
                    <?php endif; ?>
                </a>
            </li>
        </ul>
        ...
        <div class="view-tabs-content">
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($user->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Position Id') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($user->master_position_id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Code') ?></th>
                            <td class="github-detail-value"><?= h($user->code) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Name') ?></th>
                            <td class="github-detail-value"><?= h($user->name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Gender Id') ?></th>
                            <td class="github-detail-value">
                                <?= $user->has('master_gender') ? $this->Html->link($user->master_gender->title, ['controller' => 'MasterGenders', 'action' => 'view', $user->master_gender->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Email') ?></th>
                            <td class="github-detail-value"><?= h($user->email) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Department Id') ?></th>
                            <td class="github-detail-value">
                                <?= $user->has('master_department') ? $this->Html->link($user->master_department->title, ['controller' => 'MasterDepartments', 'action' => 'view', $user->master_department->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <!-- Authorizations Tab -->
            <div id="tab-authorizations" class="view-tab-pane">
                <?php if (!empty($user->authorizations)): ?>
                <div class="github-related-card">
                    <div class="github-related-header">
                        <h3 class="github-related-title">
                            ...
                            <?= __('Related Authorizations') ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-plus"></i> ' . __('New Authorization'),
                                ['controller' => 'Authorizations', 'action' => 'add'],
                            ...
                            <table class="table table-striped table-hover github-related-table" data-ajax-filter="true">
                                <thead style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.15) 0%, rgba(118, 75, 162, 0.15) 100%);">
                                    <tr>
                                        ...
                                        <th><?= __('Id') ?></th>
                                        <th><?= __('User Id') ?></th>
                                        <th><?= __('Master Authorization Role Id') ?></th>
                                        <th><?= __('User Name') ?></th>
                                        <th><?= __('Password') ?></th>
                                    </tr>
                                    <!-- Filter Row -->
                                    <tr class="filter-row" style="background-color: #f8f9fa;">
                                        ...
                                        <th style="padding: 4px;">
                                            <div style="display: flex; gap: 3px;">
                                                <select class="form-control form-control-sm filter-operator" 
                                                        data-column="master_authorization_role_id" 
                                                        style="width: 70px; padding: 2px 4px; font-size: 11px;">
                                                    <option value="contains"><?= __('Contains') ?></option>
                                                    <option value="equals"><?= __('Equals') ?></option>
                                                    <option value="starts"><?= __('Starts') ?></option>
                                                ...
                                                <input type="text" 
                                                       class="form-control form-control-sm filter-input" 
                                                       placeholder="<?= __('Filter Master Authorization Role Id') ?>" 
                                                       data-column="master_authorization_role_id"
                                                   style="font-size: 12px; height: 28px; border: 1px solid #ddd;">
                                        </th>
                                        <th style="padding: 4px;">
                                            <div style="display: flex; gap: 3px;">
                                                ...
                                                <input type="text" 
                                                       class="form-control form-control-sm filter-input" 
                                                       placeholder="<?= __('Filter User Name') ?>" 
                                                       data-column="user_name"
                                                   style="font-size: 12px; height: 28px; border: 1px solid #ddd;">
                                        </th>
                                        <th style="padding: 4px;">
                                            <div style="display: flex; gap: 3px;">
                                                ...
                                                <input type="text" 
                                                       class="form-control form-control-sm filter-input" 
                                                       placeholder="<?= __('Filter Password') ?>" 
                                                       data-column="password"
                                                   style="font-size: 12px; height: 28px; border: 1px solid #ddd;">
                                        </th>
                                    </tr>
                                ...
                                <tbody>
                                    <?php foreach ($user->authorizations as $authorizations): ?>
                                    <tr class="table-row-with-actions">
                                        <td class="actions actions-column" style="padding: 5px; vertical-align: middle; white-space: nowrap; background: inherit; border: none; position: sticky; left: 0; z-index: 5; min-width: 90px;">
                                            <div class="action-buttons-hover">
                                                <?= $this->Html->link(
                                                    ...
                                                    ['controller' => 'Authorizations', 'action' => 'edit', $authorizations->id],
                                                    ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => __('Edit')]
                                                ) ?>
                                                <?= $this->Html->link(
                                                    '<i class="fas fa-eye"></i>',
                                                    ['controller' => 'Authorizations', 'action' => 'view', $authorizations->id],
                                        ...
                                        <td>
                                            <?php if ($authorizations->has('user')): ?>
                                                <?php
                                                    $displayValue = $authorizations->user->title;
                                                    if (empty($displayValue)) {
                                                        $displayValue = $authorizations->user->name;
                                                    }
                                                    if (empty($displayValue)) {
                                                        $displayValue = $authorizations->user_id;
                                                    }
                                                ?>
                                                <?= $this->Html->link(h($displayValue), ['controller' => 'Users', 'action' => 'view', $authorizations->user_id]) ?>
                                            <?php else: ?>
                                                <?= $authorizations->has('user') ? $this->Html->link($authorizations->user->fullname, ['controller' => 'Users', 'action' => 'view', $authorizations->user->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if ($authorizations->has('masterAuthorizationRole')): ?>
                                                <?php
                                                    $displayValue = $authorizations->masterAuthorizationRole->title;
                                                    if (empty($displayValue)) {
                                                        $displayValue = $authorizations->masterAuthorizationRole->name;
                                                    }
                                                    if (empty($displayValue)) {
                                                        $displayValue = $authorizations->master_authorization_role_id;
                                                    }
                                                ?>
                                                <?= $this->Html->link(h($displayValue), ['controller' => 'MasterAuthorizationRoles', 'action' => 'view', $authorizations->master_authorization_role_id]) ?>
                                            <?php else: ?>
                                                <?= $authorizations->has('master_authorization_role') ? $this->Html->link($authorizations->master_authorization_role->title, ['controller' => 'MasterAuthorizationRoles', 'action' => 'view', $authorizations->master_authorization_role->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                        <td><?= h($authorizations->user_name) ?></td>
                                        <td><?= h($authorizations->password) ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                ...
                <div class="github-empty-state">
                    ...
                    <h3><?= __('No Related Authorizations') ?></h3>
                    <p><?= __('There are no related Authorizations for this User.') ?></p>
                    <?= $this->Html->link(
                        __('Add First Authorization'),
                        ['controller' => 'Authorizations', 'action' => 'add'],
                        ['class' => 'btn-export-light']
                    ) ?>
                </div>
