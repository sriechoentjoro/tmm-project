                        ...
                        <tr>
                            ...
                            <td class="github-detail-value">
                                <?php if ($candidate->has('master_kecamatan')): ?>
                                    ...
                                    <small class="text-muted">(ID: <?= $candidate->has('master_kecamatan') ? $this->Html->link($candidate->master_kecamatan->title, ['controller' => 'MasterKecamatans', 'action' => 'view', $candidate->master_kecamatan->id]) : '' ?>)</small>
                                <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td class="github-detail-value">
                                <?php if ($candidate->has('master_kelurahan')): ?>
                                    ...
                                    <small class="text-muted">(ID: <?= $candidate->has('master_kelurahan') ? $this->Html->link($candidate->master_kelurahan->title, ['controller' => 'MasterKelurahans', 'action' => 'view', $candidate->master_kelurahan->id]) : '' ?>)</small>
                                <?php else: ?>
                                    <span class="text-muted">-</span>
                                <?php endif; ?>
                            </td>
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row-with-actions">
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $candidateCertifications->has('candidate') ? $this->Html->link($candidateCertifications->candidate->fullname, ['controller' => 'Candidates', 'action' => 'view', $candidateCertifications->candidate->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row-with-actions">
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $candidateCourses->has('candidate') ? $this->Html->link($candidateCourses->candidate->fullname, ['controller' => 'Candidates', 'action' => 'view', $candidateCourses->candidate->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $candidateCourses->has('vocational_training_institution') ? $this->Html->link($candidateCourses->vocational_training_institution->name, ['controller' => 'VocationalTrainingInstitutions', 'action' => 'view', $candidateCourses->vocational_training_institution->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $candidateCourses->has('master_course_major') ? $this->Html->link($candidateCourses->master_course_major->title, ['controller' => 'MasterCourseMajors', 'action' => 'view', $candidateCourses->master_course_major->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row-with-actions">
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $candidateDocuments->has('candidate') ? $this->Html->link($candidateDocuments->candidate->fullname, ['controller' => 'Candidates', 'action' => 'view', $candidateDocuments->candidate->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row-with-actions">
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $candidateEducations->has('candidate') ? $this->Html->link($candidateEducations->candidate->fullname, ['controller' => 'Candidates', 'action' => 'view', $candidateEducations->candidate->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $candidateEducations->has('master_strata') ? $this->Html->link($candidateEducations->master_strata->title, ['controller' => 'MasterStratas', 'action' => 'view', $candidateEducations->master_strata->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $candidateEducations->has('master_propinsi') ? $this->Html->link($candidateEducations->master_propinsi->title, ['controller' => 'MasterPropinsis', 'action' => 'view', $candidateEducations->master_propinsi->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $candidateEducations->has('master_kabupaten') ? $this->Html->link($candidateEducations->master_kabupaten->title, ['controller' => 'MasterKabupatens', 'action' => 'view', $candidateEducations->master_kabupaten->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row-with-actions">
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $candidateExperiences->has('candidate') ? $this->Html->link($candidateExperiences->candidate->fullname, ['controller' => 'Candidates', 'action' => 'view', $candidateExperiences->candidate->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row-with-actions">
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $candidateFamilies->has('candidate') ? $this->Html->link($candidateFamilies->candidate->fullname, ['controller' => 'Candidates', 'action' => 'view', $candidateFamilies->candidate->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?= $candidateFamilies->has('master_family_connection') ? $this->Html->link($candidateFamilies->master_family_connection->title, ['controller' => 'MasterFamilyConnections', 'action' => 'view', $candidateFamilies->master_family_connection->id]) : '' ?>
                                            <?php endif; ?>
                                        </td>
