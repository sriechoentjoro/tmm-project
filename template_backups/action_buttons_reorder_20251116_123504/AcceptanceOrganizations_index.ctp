 ...
 * @var \App\Model\Entity\AcceptanceOrganization[]|\Cake\Collection\CollectionInterface $acceptanceOrganizations
 */
?>
...
<div class="index-header" style="margin-bottom: 20px;">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Acceptance Organizations') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="acceptanceOrganizations index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <thead style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.15) 0%, rgba(118, 75, 162, 0.15) 100%); position: sticky; top: 0; z-index: 10;">
                <tr>
                    ...
                    <th style="padding: 12px; border-bottom: 2px solid #667eea; white-space: nowrap;" scope="col"><?= $this->Paginator->sort('master_japan_prefecture_id') ?></th>
            ...
            <tr class="filter-row" style="background-color: #f8f9fa;">
                ...
                <td style="padding: 5px;">
                    <select class="filter-input form-control form-control-sm" data-column="master_japan_prefecture_id" data-type="select" style="font-size: 0.85rem; padding: 4px;">
                        <option value="">All Master_japan_prefectures</option>
                        <?php foreach ($master_japan_prefectures as $id => $name): ?>
                ...
                <td style="padding: 5px;">
                    <select class="filter-operator form-control form-control-sm" data-column="director_hiragana" style="font-size: 0.75rem; padding: 2px 4px; margin-bottom: 2px;">
                        <option value="like">LIKE</option>
                        <option value="not_like">NOT LIKE</option>
                        <option value="=">=</option>
                        <option value="!=">!=</option>
            ...
            <tbody>
                <?php foreach ($acceptanceOrganizations as $acceptanceOrganization): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'view', $acceptanceOrganization->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i>',
                                ['action' => 'edit', $acceptanceOrganization->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $acceptanceOrganization->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $acceptanceOrganization->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($acceptanceOrganization->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($acceptanceOrganization->title) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($acceptanceOrganization->master_japan_prefecture_id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($acceptanceOrganization->post_code) ?></td>
