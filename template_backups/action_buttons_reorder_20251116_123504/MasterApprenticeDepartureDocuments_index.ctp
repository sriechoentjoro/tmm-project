 ...
 * @var \App\Model\Entity\MasterApprenticeDepartureDocument[]|\Cake\Collection\CollectionInterface $masterApprenticeDepartureDocuments
 */
?>
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <?= $this->Html->link(
                    '<i class="fas fa-list"></i> ' . __('List Master Apprentice Departure Documents'),
                    ['action' => 'index'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <?= $this->Html->link(
                    '<i class="fas fa-plus"></i> ' . __('New Master Apprentice Departure Document'),
                    ['action' => 'add'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
            </div>
            
            <h2 style="margin: 0; display: inline-block;"><?= __('Master Apprentice Departure Documents') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="masterApprenticeDepartureDocuments index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                <?php foreach ($masterApprenticeDepartureDocuments as $masterApprenticeDepartureDocument): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'view', $masterApprenticeDepartureDocument->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i>',
                                ['action' => 'edit', $masterApprenticeDepartureDocument->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $masterApprenticeDepartureDocument->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $masterApprenticeDepartureDocument->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($masterApprenticeDepartureDocument->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterApprenticeDepartureDocument->title) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterApprenticeDepartureDocument->format) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterApprenticeDepartureDocument->is_required) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterApprenticeDepartureDocument->created) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterApprenticeDepartureDocument->modified) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
