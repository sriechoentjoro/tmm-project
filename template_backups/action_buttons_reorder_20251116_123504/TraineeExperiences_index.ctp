 ...
 * @var \App\Model\Entity\TraineeExperience[]|\Cake\Collection\CollectionInterface $traineeExperiences
 */
?>
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <?= $this->Html->link(
                    '<i class="fas fa-list"></i> ' . __('List Trainee Experiences'),
                    ['action' => 'index'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
                <?= $this->Html->link(
                    '<i class="fas fa-plus"></i> ' . __('New Trainee Experience'),
                    ['action' => 'add'],
                    ['class' => 'dropdown-item', 'escape' => false]
                ) ?>
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Trainee Experiences') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="traineeExperiences index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                <?php foreach ($traineeExperiences as $traineeExperience): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'view', $traineeExperience->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i>',
                                ['action' => 'edit', $traineeExperience->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $traineeExperience->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $traineeExperience->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($traineeExperience->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $traineeExperience->has('trainee') ? $this->Html->link($traineeExperience->trainee->name, ['controller' => 'Trainees', 'action' => 'view', $traineeExperience->trainee->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($traineeExperience->employment_start_year) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($traineeExperience->employment_end_year) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($traineeExperience->company_name) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($traineeExperience->title) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $traineeExperience->has('master_employee_status') ? $this->Html->link($traineeExperience->master_employee_status->title, ['controller' => 'MasterEmployeeStatuses', 'action' => 'view', $traineeExperience->master_employee_status->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($traineeExperience->last_salary_amount) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
