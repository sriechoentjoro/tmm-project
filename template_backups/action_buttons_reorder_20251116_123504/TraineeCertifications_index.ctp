 ...
 * @var \App\Model\Entity\TraineeCertification[]|\Cake\Collection\CollectionInterface $traineeCertifications
 */
?>
...
<div class="index-header" style="margin-bottom: 20px;">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Trainee Certifications') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="traineeCertifications index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                <?php foreach ($traineeCertifications as $traineeCertification): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'view', $traineeCertification->id],
                            ...
                            <?= $this->Form->postLink(
                                ...
                                ['confirm' => __('Are you sure you want to delete # {0}?', $traineeCertification->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($traineeCertification->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $traineeCertification->has('trainee') ? $this->Html->link($traineeCertification->trainee->name, ['controller' => 'Trainees', 'action' => 'view', $traineeCertification->trainee->id]) : '' ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($traineeCertification->title) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($traineeCertification->institution_name) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($traineeCertification->certification_date) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
