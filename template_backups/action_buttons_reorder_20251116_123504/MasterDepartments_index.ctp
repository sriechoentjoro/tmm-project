 ...
 * @var \App\Model\Entity\MasterDepartment[]|\Cake\Collection\CollectionInterface $masterDepartments
 */
?>
...
<div class="index-header" style="margin-bottom: 20px;">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <h2 style="margin: 0; display: inline-block;"><?= __('Master Departments') ?></h2>
        </div>
...
<div class="table-scroll-wrapper" style="overflow-x: auto; cursor: grab; -webkit-overflow-scrolling: touch; user-select: none;">
    <div class="masterDepartments index content">
        <table class="table" style="border-collapse: collapse; width: 100%; min-width: 800px;">
            ...
            <tbody>
                <?php foreach ($masterDepartments as $masterDepartment): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap; padding: 8px;">
                        <div class="action-buttons-hover">
                            <?= $this->Html->link(
                                ...
                                ['action' => 'view', $masterDepartment->id],
                                ['class' => 'btn-action-icon btn-view-icon', 'escape' => false, 'title' => 'View']
                            ) ?>
                            <?= $this->Html->link(
                                '<i class="fas fa-edit"></i>',
                                ['action' => 'edit', $masterDepartment->id],
                                ['class' => 'btn-action-icon btn-edit-icon', 'escape' => false, 'title' => 'Edit']
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fas fa-trash"></i>',
                                ['action' => 'delete', $masterDepartment->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $masterDepartment->id), 'class' => 'btn-action-icon btn-delete-icon', 'escape' => false, 'title' => 'Delete']
                            ) ?>
                        </div>
                    </td>
                    <td style="padding: 8px; white-space: nowrap;"><?= $this->Number->format($masterDepartment->id) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterDepartment->code) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterDepartment->title) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterDepartment->updated) ?></td>
                    <td style="padding: 8px; white-space: nowrap;"><?= h($masterDepartment->created) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
