            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Vocational Training Institution Story') ?>: <?= h($vocationalTrainingInstitutionStory->id) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $vocationalTrainingInstitutionStory->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
        ...
        <div class="view-tabs-content">
            ...
            <div id="tab-home" class="view-tab-pane active">
                ...
                <div class="media-preview-section" style="margin-bottom: 24px;">
                    <?php if (!empty($vocationalTrainingInstitutionStory->image_path)): ?>
                    <div class="image-preview-container" style="text-align: center; margin-bottom: 20px; background: #f6f8fa; padding: 20px; border-radius: 8px; border: 1px solid #d0d7de;">
                        <h4 style="margin: 0 0 15px 0; font-size: 14px; font-weight: 600; color: #24292f;">
                            <i class="fas fa-image"></i> <?= __('Image Path') ?>
                        </h4>
                        <div style="max-width: 800px; margin: 0 auto;">
                            <img src="<?= $this->Url->build('/' . h($vocationalTrainingInstitutionStory->image_path)) ?>" 
                                 alt="<?= __('Image Path') ?>"
                        ...
                        <div style="margin-top: 15px;">
                            <a href="<?= $this->Url->build('/' . h($vocationalTrainingInstitutionStory->image_path)) ?>" 
                               download 
                               class="btn-export-light"
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($vocationalTrainingInstitutionStory->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Vocational Training Institution Id') ?></th>
                            <td class="github-detail-value">
                                <?= $vocationalTrainingInstitutionStory->has('vocational_training_institution') ? $this->Html->link($vocationalTrainingInstitutionStory->vocational_training_institution->name, ['controller' => 'VocationalTrainingInstitutions', 'action' => 'view', $vocationalTrainingInstitutionStory->vocational_training_institution->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Problem Contents') ?></th>
                            <td class="github-detail-value"><?= h($vocationalTrainingInstitutionStory->problem_contents) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Problem Classification') ?></th>
                            <td class="github-detail-value"><?= h($vocationalTrainingInstitutionStory->problem_classification) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Problem Solution') ?></th>
                            <td class="github-detail-value"><?= h($vocationalTrainingInstitutionStory->problem_solution) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Problem Inference') ?></th>
                            <td class="github-detail-value"><?= h($vocationalTrainingInstitutionStory->problem_inference) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Image Path') ?></th>
                            <td class="github-detail-value"><?= h($vocationalTrainingInstitutionStory->image_path) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Date Occurrence') ?></th>
                            <td class="github-detail-value"><?= h($vocationalTrainingInstitutionStory->date_occurrence) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
