            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Candidate Family') ?>: <?= h($candidateFamily->name) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $candidateFamily->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($candidateFamily->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Age') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($candidateFamily->age) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Candidate Id') ?></th>
                            <td class="github-detail-value">
                                <?= $candidateFamily->has('candidate') ? $this->Html->link($candidateFamily->candidate->name, ['controller' => 'Candidates', 'action' => 'view', $candidateFamily->candidate->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Family Connection Id') ?></th>
                            <td class="github-detail-value">
                                <?= $candidateFamily->has('master_family_connection') ? $this->Html->link($candidateFamily->master_family_connection->title, ['controller' => 'MasterFamilyConnections', 'action' => 'view', $candidateFamily->master_family_connection->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Name') ?></th>
                            <td class="github-detail-value"><?= h($candidateFamily->name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Occupation Id') ?></th>
                            <td class="github-detail-value">
                                <?= $candidateFamily->has('master_occupation') ? $this->Html->link($candidateFamily->master_occupation->title, ['controller' => 'MasterOccupations', 'action' => 'view', $candidateFamily->master_occupation->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Detail') ?></th>
                            <td class="github-detail-value"><?= h($candidateFamily->detail) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
