            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Master Translation') ?>: <?= h($masterTranslation->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $masterTranslation->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($masterTranslation->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($masterTranslation->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Jpn') ?></th>
                            <td class="github-detail-value"><?= h($masterTranslation->jpn) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Ind') ?></th>
                            <td class="github-detail-value"><?= h($masterTranslation->ind) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Eng') ?></th>
                            <td class="github-detail-value"><?= h($masterTranslation->eng) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
