            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Cooperative Association Story') ?>: <?= h($cooperativeAssociationStory->id) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $cooperativeAssociationStory->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
        ...
        <div class="view-tabs-content">
            ...
            <div id="tab-home" class="view-tab-pane active">
                ...
                <div class="media-preview-section" style="margin-bottom: 24px;">
                    <?php if (!empty($cooperativeAssociationStory->image_path)): ?>
                    <div class="image-preview-container" style="text-align: center; margin-bottom: 20px; background: #f6f8fa; padding: 20px; border-radius: 8px; border: 1px solid #d0d7de;">
                        ...
                        <div style="max-width: 800px; margin: 0 auto;">
                            <img src="<?= $this->Url->build('/' . h($cooperativeAssociationStory->image_path)) ?>" 
                                 alt="<?= __('Image Path') ?>"
                        ...
                        <div style="margin-top: 15px;">
                            <a href="<?= $this->Url->build('/' . h($cooperativeAssociationStory->image_path)) ?>" 
                               download 
                               class="btn-export-light"
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($cooperativeAssociationStory->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Cooperative Association Id') ?></th>
                            <td class="github-detail-value">
                                <?= $cooperativeAssociationStory->has('cooperative_association') ? $this->Html->link($cooperativeAssociationStory->cooperative_association->name, ['controller' => 'CooperativeAssociations', 'action' => 'view', $cooperativeAssociationStory->cooperative_association->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Problem Contents') ?></th>
                            <td class="github-detail-value"><?= h($cooperativeAssociationStory->problem_contents) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Problem Classification') ?></th>
                            <td class="github-detail-value"><?= h($cooperativeAssociationStory->problem_classification) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Problem Solution') ?></th>
                            <td class="github-detail-value"><?= h($cooperativeAssociationStory->problem_solution) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Problem Inference') ?></th>
                            <td class="github-detail-value"><?= h($cooperativeAssociationStory->problem_inference) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Image Path') ?></th>
                            <td class="github-detail-value"><?= h($cooperativeAssociationStory->image_path) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Date Occurrence') ?></th>
                            <td class="github-detail-value"><?= h($cooperativeAssociationStory->date_occurrence) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
