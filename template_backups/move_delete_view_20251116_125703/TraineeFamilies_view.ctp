            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Trainee Family') ?>: <?= h($traineeFamily->name) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $traineeFamily->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($traineeFamily->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Age') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($traineeFamily->age) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Trainee Id') ?></th>
                            <td class="github-detail-value">
                                <?= $traineeFamily->has('trainee') ? $this->Html->link($traineeFamily->trainee->name, ['controller' => 'Trainees', 'action' => 'view', $traineeFamily->trainee->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Family Connection Id') ?></th>
                            <td class="github-detail-value">
                                <?= $traineeFamily->has('master_family_connection') ? $this->Html->link($traineeFamily->master_family_connection->title, ['controller' => 'MasterFamilyConnections', 'action' => 'view', $traineeFamily->master_family_connection->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Name') ?></th>
                            <td class="github-detail-value"><?= h($traineeFamily->name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Occupation Id') ?></th>
                            <td class="github-detail-value">
                                <?= $traineeFamily->has('master_occupation') ? $this->Html->link($traineeFamily->master_occupation->title, ['controller' => 'MasterOccupations', 'action' => 'view', $traineeFamily->master_occupation->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Detail') ?></th>
                            <td class="github-detail-value"><?= h($traineeFamily->detail) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
