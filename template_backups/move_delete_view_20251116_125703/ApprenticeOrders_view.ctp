            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Apprentice Order') ?>: <?= h($apprenticeOrder->id) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <!-- Delete button moved to bottom of tab container (to avoid accidental deletion from header) -->
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($apprenticeOrder->cooperative_association_id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Acceptance Organization Id') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($apprenticeOrder->acceptance_organization_id) ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($apprenticeOrder->job_category_id) ?></td>
                        </tr>
                        <tr>
...
.github-title-row > div:first-child {
    ...
    <!-- Delete action placed at bottom of tab container -->
    <div class="view-actions-bottom" style="margin-top: 18px; text-align: center;">
        <?= $this->Form->postLink(
