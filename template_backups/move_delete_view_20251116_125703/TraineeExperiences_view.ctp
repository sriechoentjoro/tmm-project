            ...
            <div class="github-title-row">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h1 class="github-page-title" style="margin: 0;">
                        <?= __('Trainee Experience') ?>: <?= h($traineeExperience->title) ?>
                    </h1>
                </div>
                ...
                <div class="github-header-actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            ...
                            'escape' => false,
                            'confirm' => __('Are you sure you want to delete # {0}?', $traineeExperience->id)
                        ]
                    ) ?>
                    <?= $this->Html->link(
                ...
                <table class="github-details-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="github-detail-value"><?= $this->Number->format($traineeExperience->id) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Last Salary Amount') ?></th>
                            <td class="github-detail-value"><?= $this->Number->format($traineeExperience->last_salary_amount) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Trainee Id') ?></th>
                            <td class="github-detail-value">
                                <?= $traineeExperience->has('trainee') ? $this->Html->link($traineeExperience->trainee->name, ['controller' => 'Trainees', 'action' => 'view', $traineeExperience->trainee->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Employment Start Year') ?></th>
                            <td class="github-detail-value"><?= h($traineeExperience->employment_start_year) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Employment End Year') ?></th>
                            <td class="github-detail-value"><?= h($traineeExperience->employment_end_year) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Company Name') ?></th>
                            <td class="github-detail-value"><?= h($traineeExperience->company_name) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Title') ?></th>
                            <td class="github-detail-value"><?= h($traineeExperience->title) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Master Employee Status Id') ?></th>
                            <td class="github-detail-value">
                                <?= $traineeExperience->has('master_employee_status') ? $this->Html->link($traineeExperience->master_employee_status->title, ['controller' => 'MasterEmployeeStatuses', 'action' => 'view', $traineeExperience->master_employee_status->id], ['class' => 'github-link']) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Employment Awards') ?></th>
                            <td class="github-detail-value"><?= h($traineeExperience->employment_awards) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Job Detail') ?></th>
                            <td class="github-detail-value"><?= h($traineeExperience->job_detail) ?></td>
                        </tr>
                        <tr>
                            <th class="github-detail-label"><?= __('Termination Reasons') ?></th>
                            <td class="github-detail-value"><?= h($traineeExperience->termination_reasons) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
