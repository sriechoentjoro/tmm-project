...
/**
 * MasterStratasFixture
 */
class MasterStratasFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'title_hiragana' => ['type' => 'string', 'length' => 256, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'title_hiragana' => 'Lorem ipsum dolor sit amet',
                'updated' => 1763187706,
                'created' => '2025-11-15 13:21:46',
            ],
        ];
        parent::init();
    }
