...
/**
 * MasterMarriageStatusesFixture
 */
class MasterMarriageStatusesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'title_jpg' => ['type' => 'string', 'length' => 256, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'title_jpg' => 'Lorem ipsum dolor sit amet',
                'updated' => 1763187700,
                'created' => '2025-11-15 13:21:40',
            ],
        ];
        parent::init();
    }
