...
class AuthorizationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'master_authorization_role_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'user_name' => ['type' => 'string', 'length' => 256, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'user_id' => 1,
                'master_authorization_role_id' => 1,
                'user_name' => 'Lorem ipsum dolor sit amet',
                'password' => 'Lorem ipsum dolor sit amet',
                'last_login' => 1763187724,
                'updated' => 1763187724,
                'created' => '2025-11-15 13:22:04',
            ],
        ];
        parent::init();
    }
